(function(sdk, api) {
  ...
  var root_8 = /* @__PURE__ */ from_html(`<beam-card><beam-card-subtitle>Ports</beam-card-subtitle> <beam-simple-table><table class="svelte-1vjxqu"><thead><tr><th class="svelte-1vjxqu">Name</th><th class="svelte-1vjxqu">Internal</th><th class="svelte-1vjxqu">External</th><th class="svelte-1vjxqu">Protocol</th><th class="svelte-1vjxqu">Link</th></tr></thead><tbody></tbody></table></beam-simple-table></beam-card>`, 2);
  var root_12 = /* @__PURE__ */ from_html(`<beam-card><beam-card-subtitle>Location</beam-card-subtitle> <div class="section-content svelte-1vjxqu"><div class="location-info svelte-1vjxqu"><span> </span> <span class="detail-muted svelte-1vjxqu"> </span></div></div></beam-card>`, 2);
  ...
  function EdgegapServers($$anchor, $$props) {
    ...
    var node = sibling(beam_card_title, 2);
    {
      var consequent = ($$anchor2) => {
        var beam_progress_linear = root_1();
    ...
    var node_2 = sibling(node_1, 2);
    {
      var consequent_10 = ($$anchor2) => {
        var fragment = root_3();
        var beam_simple_table = first_child(fragment);
        ...
        var node_3 = sibling(beam_simple_table, 2);
        {
          var consequent_9 = ($$anchor3) => {
            ...
            var beam_chip = sibling(child(div), 2);
            set_custom_element_data(beam_chip, "small", true);
            set_custom_element_data(beam_chip, "outlined", true);
            var text_5 = child(beam_chip);
            var node_4 = sibling(div, 2);
            {
              var consequent_8 = ($$anchor4) => {
                ...
                set_class(beam_card_2, 1, "section-card svelte-1vjxqu");
                var beam_card_subtitle = child(beam_card_2);
                var div_2 = sibling(beam_card_subtitle, 2);
                ...
                set_custom_element_data(beam_card_3, "outlined", true);
                set_class(beam_card_3, 1, "section-card svelte-1vjxqu");
                var beam_card_subtitle_1 = child(beam_card_3);
                var div_7 = sibling(beam_card_subtitle_1, 2);
                ...
                var beam_card_4 = sibling(beam_card_3, 2);
                set_custom_element_data(beam_card_4, "outlined", true);
                set_class(beam_card_4, 1, "section-card svelte-1vjxqu");
                var beam_card_subtitle_2 = child(beam_card_4);
                var div_12 = sibling(beam_card_subtitle_2, 2);
                var div_13 = child(div_12);
                var span_7 = sibling(child(div_13), 2);
                var text_14 = child(span_7);
                var div_14 = sibling(div_13, 2);
                var span_8 = sibling(child(div_14), 2);
                var text_15 = child(span_8);
                var div_15 = sibling(div_14, 2);
                var span_9 = sibling(child(div_15), 2);
                var text_16 = child(span_9);
                var div_16 = sibling(div_15, 2);
                var span_10 = sibling(child(div_16), 2);
                var text_17 = child(span_10);
                var beam_card_5 = sibling(beam_card_4, 2);
                set_custom_element_data(beam_card_5, "outlined", true);
                set_class(beam_card_5, 1, "section-card svelte-1vjxqu");
                var beam_card_subtitle_3 = child(beam_card_5);
                var div_17 = sibling(beam_card_subtitle_3, 2);
                ...
                var node_6 = sibling(div_1, 2);
                {
                  var consequent_4 = ($$anchor5) => {
                    var beam_card_6 = root_8();
                    set_custom_element_data(beam_card_6, "outlined", true);
                    set_class(beam_card_6, 1, "detail-section-full svelte-1vjxqu");
                    var beam_card_subtitle_4 = child(beam_card_6);
                    var beam_simple_table_1 = sibling(beam_card_subtitle_4, 2);
                ...
                var node_8 = sibling(node_6, 2);
                {
                  var consequent_5 = ($$anchor5) => {
                    var beam_card_7 = root_12();
                    set_custom_element_data(beam_card_7, "outlined", true);
                    set_class(beam_card_7, 1, "detail-section-full svelte-1vjxqu");
                    var beam_card_subtitle_5 = child(beam_card_7);
                    var div_19 = sibling(beam_card_subtitle_5, 2);
                    var div_20 = child(div_19);
                    var span_12 = child(div_20);
                    var text_25 = child(span_12);
                    var span_13 = sibling(span_12, 2);
                    var text_26 = child(span_13);
                    template_effect(
                      ($0, $1) => {
                        set_text(text_25, $0);
                        set_text(text_26, $1);
                ...
                var node_9 = sibling(node_8, 2);
                {
                  var consequent_6 = ($$anchor5) => {
                    var beam_card_8 = root_13();
                    set_custom_element_data(beam_card_8, "outlined", true);
                    set_class(beam_card_8, 1, "detail-section-full svelte-1vjxqu");
                    var beam_card_subtitle_6 = child(beam_card_8);
                    var text_27 = child(beam_card_subtitle_6);
                    var beam_data_table = sibling(beam_card_subtitle_6, 2);
                ...
                var node_10 = sibling(node_9, 2);
                {
                  var consequent_7 = ($$anchor5) => {
                    var beam_card_9 = root_14();
                    set_custom_element_data(beam_card_9, "outlined", true);
                    set_class(beam_card_9, 1, "detail-section-full svelte-1vjxqu");
                    ...
                    each(div_22, 5, () => (deep_read_state(get(d)), untrack(() => get(d).tags)), index, ($$anchor6, tag) => {
                      ...
                      template_effect(() => set_text(text_28, get(tag)));
                      append($$anchor6, beam_chip_3);
                    });
              ...
              var alternate_1 = ($$anchor4) => {
                var beam_alert_1 = root_16();
                set_custom_element_data(beam_alert_1, "type", "info");
                set_custom_element_data(beam_alert_1, "dense", true);
                set_custom_element_data(beam_alert_1, "outlined", true);
      ...
      var consequent_11 = ($$anchor2) => {
        var beam_alert_2 = root_17();
        set_custom_element_data(beam_alert_2, "type", "info");
        set_custom_element_data(beam_alert_2, "dense", true);
        set_custom_element_data(beam_alert_2, "outlined", true);
