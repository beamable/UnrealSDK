...
#include "K2BeamNode_ApiRequest_MSPlaygroundMsAdd.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_MSPlaygroundMsAdd"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /Add  of the MSPlaygroundMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALBLUEPRINTNODES_API UK2BeamNode_ApiRequest_MSPlaygroundMsAdd : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
