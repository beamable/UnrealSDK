...
#include "K2BeamNode_ApiRequest_StandaloneMicroserviceMsAlwaysTrue.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StandaloneMicroserviceMsAlwaysTrue"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /AlwaysTrue  of the StandaloneMicroserviceMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALBLUEPRINTNODES_API UK2BeamNode_ApiRequest_StandaloneMicroserviceMsAlwaysTrue : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
