...
#include "K2BeamNode_ApiRequest_MSPlaygroundTestNotification.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_MSPlaygroundTestNotification"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /TestNotification  of the MSPlayground Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_MSPlaygroundTestNotification : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
