...
#include "K2BeamNode_ApiRequest_MSPlaygroundTestArr.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_MSPlaygroundTestArr"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /TestArr  of the MSPlayground Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_MSPlaygroundTestArr : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
