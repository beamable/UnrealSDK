...
#include "K2BeamNode_ApiRequest_DiscordSampleMsUpdateFromDiscord.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DiscordSampleMsUpdateFromDiscord"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /UpdateFromDiscord  of the DiscordSampleMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_DiscordSampleMsUpdateFromDiscord : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
