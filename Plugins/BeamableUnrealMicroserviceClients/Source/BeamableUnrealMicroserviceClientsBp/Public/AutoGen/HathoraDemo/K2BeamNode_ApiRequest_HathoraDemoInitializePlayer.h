...
#include "K2BeamNode_ApiRequest_HathoraDemoInitializePlayer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_HathoraDemoInitializePlayer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /InitializePlayer  of the HathoraDemo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_HathoraDemoInitializePlayer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
