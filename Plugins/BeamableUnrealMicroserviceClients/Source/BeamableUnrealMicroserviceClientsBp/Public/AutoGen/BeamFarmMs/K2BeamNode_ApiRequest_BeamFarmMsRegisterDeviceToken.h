...
#include "K2BeamNode_ApiRequest_BeamFarmMsRegisterDeviceToken.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsRegisterDeviceToken"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /RegisterDeviceToken  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsRegisterDeviceToken : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
