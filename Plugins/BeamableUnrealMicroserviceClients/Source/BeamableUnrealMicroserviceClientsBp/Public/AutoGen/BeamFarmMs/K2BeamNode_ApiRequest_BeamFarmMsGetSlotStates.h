...
#include "K2BeamNode_ApiRequest_BeamFarmMsGetSlotStates.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsGetSlotStates"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetSlotStates  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsGetSlotStates : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
