...
#include "K2BeamNode_ApiRequest_BeamFarmMsListMyDevices.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsListMyDevices"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ListMyDevices  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsListMyDevices : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
