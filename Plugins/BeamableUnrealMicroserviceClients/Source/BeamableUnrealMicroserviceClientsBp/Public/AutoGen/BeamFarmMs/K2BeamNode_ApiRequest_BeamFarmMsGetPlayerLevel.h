...
#include "K2BeamNode_ApiRequest_BeamFarmMsGetPlayerLevel.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsGetPlayerLevel"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetPlayerLevel  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsGetPlayerLevel : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
