...
#include "K2BeamNode_ApiRequest_BeamFarmMsPlantSeed.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsPlantSeed"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /PlantSeed  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsPlantSeed : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
