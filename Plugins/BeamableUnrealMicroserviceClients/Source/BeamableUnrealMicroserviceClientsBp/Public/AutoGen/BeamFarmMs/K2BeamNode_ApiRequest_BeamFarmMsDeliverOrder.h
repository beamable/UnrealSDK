...
#include "K2BeamNode_ApiRequest_BeamFarmMsDeliverOrder.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsDeliverOrder"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /DeliverOrder  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsDeliverOrder : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
