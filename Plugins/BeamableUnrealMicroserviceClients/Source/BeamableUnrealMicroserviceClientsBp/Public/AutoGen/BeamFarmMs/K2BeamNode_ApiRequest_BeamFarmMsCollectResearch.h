...
#include "K2BeamNode_ApiRequest_BeamFarmMsCollectResearch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsCollectResearch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /CollectResearch  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsCollectResearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
