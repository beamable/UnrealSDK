...
#include "K2BeamNode_ApiRequest_BeamFarmMsGetDeliveryOrders.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsGetDeliveryOrders"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetDeliveryOrders  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsGetDeliveryOrders : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
