...
#include "K2BeamNode_ApiRequest_BeamFarmMsListRegisteredPlayers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsListRegisteredPlayers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ListRegisteredPlayers  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsListRegisteredPlayers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
