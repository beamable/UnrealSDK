...
#include "K2BeamNode_ApiRequest_BeamFarmMsUnregisterDeviceToken.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsUnregisterDeviceToken"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /UnregisterDeviceToken  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsUnregisterDeviceToken : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
