...
#include "K2BeamNode_ApiRequest_BeamFarmMsCollectHarvest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsCollectHarvest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /CollectHarvest  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsCollectHarvest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
