...
#include "K2BeamNode_ApiRequest_BeamFarmMsRegisterGroundItem.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsRegisterGroundItem"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /RegisterGroundItem  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsRegisterGroundItem : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
