...
#include "K2BeamNode_ApiRequest_BeamFarmMsStartResearch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsStartResearch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /StartResearch  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsStartResearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
