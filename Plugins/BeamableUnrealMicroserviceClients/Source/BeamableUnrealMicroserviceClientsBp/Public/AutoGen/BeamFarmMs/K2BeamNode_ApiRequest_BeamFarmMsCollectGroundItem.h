...
#include "K2BeamNode_ApiRequest_BeamFarmMsCollectGroundItem.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsCollectGroundItem"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /CollectGroundItem  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsCollectGroundItem : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
