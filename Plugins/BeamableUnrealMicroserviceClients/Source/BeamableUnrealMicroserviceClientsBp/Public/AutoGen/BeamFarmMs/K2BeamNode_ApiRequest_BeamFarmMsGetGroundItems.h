...
#include "K2BeamNode_ApiRequest_BeamFarmMsGetGroundItems.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsGetGroundItems"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetGroundItems  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsGetGroundItems : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
