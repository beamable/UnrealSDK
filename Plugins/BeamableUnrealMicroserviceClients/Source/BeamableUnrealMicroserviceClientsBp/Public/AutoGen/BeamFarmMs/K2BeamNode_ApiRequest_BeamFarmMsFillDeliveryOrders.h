...
#include "K2BeamNode_ApiRequest_BeamFarmMsFillDeliveryOrders.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsFillDeliveryOrders"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /FillDeliveryOrders  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsFillDeliveryOrders : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
