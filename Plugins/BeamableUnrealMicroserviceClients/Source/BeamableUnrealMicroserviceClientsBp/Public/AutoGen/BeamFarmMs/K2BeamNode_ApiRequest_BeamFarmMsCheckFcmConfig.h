...
#include "K2BeamNode_ApiRequest_BeamFarmMsCheckFcmConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamFarmMsCheckFcmConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /CheckFcmConfig  of the BeamFarmMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamFarmMsCheckFcmConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
