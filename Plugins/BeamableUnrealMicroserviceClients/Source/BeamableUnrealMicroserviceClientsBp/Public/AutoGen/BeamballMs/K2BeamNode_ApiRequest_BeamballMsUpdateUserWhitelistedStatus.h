...
#include "K2BeamNode_ApiRequest_BeamballMsUpdateUserWhitelistedStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamballMsUpdateUserWhitelistedStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /UpdateUserWhitelistedStatus  of the BeamballMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamballMsUpdateUserWhitelistedStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
