...
#include "K2BeamNode_ApiRequest_BeamballMsUpdateFromDiscord.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamballMsUpdateFromDiscord"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /UpdateFromDiscord  of the BeamballMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamballMsUpdateFromDiscord : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
