...
#include "K2BeamNode_ApiRequest_BeamballMsCreateMatchResult.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamballMsCreateMatchResult"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /CreateMatchResult  of the BeamballMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamballMsCreateMatchResult : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
