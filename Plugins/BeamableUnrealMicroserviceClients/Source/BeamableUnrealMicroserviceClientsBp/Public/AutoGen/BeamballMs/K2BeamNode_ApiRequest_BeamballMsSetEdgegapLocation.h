...
#include "K2BeamNode_ApiRequest_BeamballMsSetEdgegapLocation.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamballMsSetEdgegapLocation"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /SetEdgegapLocation  of the BeamballMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamballMsSetEdgegapLocation : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
