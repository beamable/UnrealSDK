...
#include "K2BeamNode_ApiRequest_BeamballMsProcessMatchResult.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BeamballMsProcessMatchResult"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /ProcessMatchResult  of the BeamballMs Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_BeamballMsProcessMatchResult : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
