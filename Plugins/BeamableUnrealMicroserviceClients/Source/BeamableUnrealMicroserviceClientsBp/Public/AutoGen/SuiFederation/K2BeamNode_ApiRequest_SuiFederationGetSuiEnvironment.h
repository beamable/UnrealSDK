...
#include "K2BeamNode_ApiRequest_SuiFederationGetSuiEnvironment.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_SuiFederationGetSuiEnvironment"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetSuiEnvironment  of the SuiFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLEUNREALMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_SuiFederationGetSuiEnvironment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
