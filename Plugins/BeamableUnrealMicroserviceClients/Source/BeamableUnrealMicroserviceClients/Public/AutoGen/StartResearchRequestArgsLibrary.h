...
public:
	...
	static UStartResearchRequestArgs* Make(int64 ItemInstanceId, FString ItemContentId, FString ProjectContentId, UObject* Outer);
	...
	static void Break(const UStartResearchRequestArgs* Serializable, int64& ItemInstanceId, FString& ItemContentId, FString& ProjectContentId);
};