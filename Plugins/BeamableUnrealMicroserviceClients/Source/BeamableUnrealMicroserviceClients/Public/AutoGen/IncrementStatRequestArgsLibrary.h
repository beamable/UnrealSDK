...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Make IncrementStatRequestArgs", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UIncrementStatRequestArgs* Make(int64 UserID, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Break IncrementStatRequestArgs", meta=(NativeBreakFunc))
