...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|BeamballMs|Utils|Json", DisplayName="DiscordWhitelistedInfo To JSON String")
	static FString DiscordWhitelistedInfoToJsonString(const UDiscordWhitelistedInfo* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|BeamballMs|Utils|Make/Break", DisplayName="Make DiscordWhitelistedInfo", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UDiscordWhitelistedInfo* Make(bool bMatchmakingDiscordWhitelisted, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|BeamballMs|Utils|Make/Break", DisplayName="Break DiscordWhitelistedInfo", meta=(NativeBreakFunc))
