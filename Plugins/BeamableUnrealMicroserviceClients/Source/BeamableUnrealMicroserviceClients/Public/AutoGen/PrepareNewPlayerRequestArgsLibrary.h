...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|LiveOpsDemoMS|Utils|Json", DisplayName="PrepareNewPlayerRequestArgs To JSON String")
	static FString PrepareNewPlayerRequestArgsToJsonString(const UPrepareNewPlayerRequestArgs* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|LiveOpsDemoMS|Utils|Make/Break", DisplayName="Make PrepareNewPlayerRequestArgs", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UPrepareNewPlayerRequestArgs* Make(int64 UserID, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|LiveOpsDemoMS|Utils|Make/Break", DisplayName="Break PrepareNewPlayerRequestArgs", meta=(NativeBreakFunc))
