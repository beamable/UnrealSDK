...
public:
	...
	static URegisteredPlayer* Make(int64 PlayerId, int32 DeviceCount, int64 LastUpdated, TArray<FString> Platforms, UObject* Outer);
	...
	static void Break(const URegisteredPlayer* Serializable, int64& PlayerId, int32& DeviceCount, int64& LastUpdated, TArray<FString>& Platforms);
};