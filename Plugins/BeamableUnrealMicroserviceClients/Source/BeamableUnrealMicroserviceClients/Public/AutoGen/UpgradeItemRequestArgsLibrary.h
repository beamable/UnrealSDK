...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Make UpgradeItemRequestArgs", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UUpgradeItemRequestArgs* Make(int64 UserID, int64 ItemInstaceID, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Break UpgradeItemRequestArgs", meta=(NativeBreakFunc))
