...
private:
	 ...
	 */
	void BP_UpdateFromDiscordImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, UDiscordSampleMsUpdateFromDiscordRequest* RequestData,
	 ...
	 */
	void CPP_UpdateFromDiscordImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, UDiscordSampleMsUpdateFromDiscordRequest* RequestData,
	 ...
	 * @brief Private implementation that all overloaded BP UFunctions call.	  
	 */
	void BP_UpdateUserWhitelistedStatusImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, UDiscordSampleMsUpdateUserWhitelistedStatusRequest* RequestData,
	 ...
	 * @brief Overload version for binding lambdas when in C++ land. Prefer the BP version whenever possible, this is here mostly for quick experimentation purposes.	 
	 */
	void CPP_UpdateUserWhitelistedStatusImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, UDiscordSampleMsUpdateUserWhitelistedStatusRequest* RequestData,
...
public:
	...
	/**
	 * @brief Makes a request to the Post /UpdateFromDiscord endpoint of the DiscordSampleMs Service.
	 *
	 ...
	 */
	void CPP_UpdateFromDiscord(UDiscordSampleMsUpdateFromDiscordRequest* Request, const FOnDiscordSampleMsUpdateFromDiscordFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;

		
	/**
	 * @brief Makes a request to the Post /UpdateUserWhitelistedStatus endpoint of the DiscordSampleMs Service.
	 *
	 * PREFER THE UFUNCTION OVERLOAD AS OPPOSED TO THIS. THIS MAINLY EXISTS TO ALLOW LAMBDA BINDING THE HANDLER.
	 * (Dynamic delegates do not allow for that so... we autogen this one to make experimenting in CPP a bit faster and for whenever you need to capture variables).
	 * 
	 ...
	 * @param CallingContext A UObject managed by the UWorld that's making the request. Used to support multiple PIEs (see UBeamUserSlot::GetNamespacedSlotId) and read-only RequestCaches. 
	 */
	void CPP_UpdateUserWhitelistedStatus(UDiscordSampleMsUpdateUserWhitelistedStatusRequest* Request, const FOnDiscordSampleMsUpdateUserWhitelistedStatusFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr) const;
	 ...
	 * @param CallingContext A UObject managed by the UWorld that's making the request. Used to support multiple PIEs (see UBeamUserSlot::GetNamespacedSlotId) and read-only RequestCaches. 
	 */
	UFUNCTION(BlueprintCallable, BlueprintInternalUseOnly, Category="Beam|DiscordSampleMs|Utils|Make/Break", meta=(DefaultToSelf="CallingContext", AdvancedDisplay="OpHandle,CallingContext", AutoCreateRefTerm="OnSuccess,OnError,OnComplete,OpHandle", BeamFlowFunction))
	void UpdateFromDiscord(UDiscordSampleMsUpdateFromDiscordRequest* Request, const FOnDiscordSampleMsUpdateFromDiscordSuccess& OnSuccess, const FOnDiscordSampleMsUpdateFromDiscordError& OnError, const FOnDiscordSampleMsUpdateFromDiscordComplete& OnComplete, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle = FBeamOperationHandle(), const UObject* CallingContext = nullptr);
