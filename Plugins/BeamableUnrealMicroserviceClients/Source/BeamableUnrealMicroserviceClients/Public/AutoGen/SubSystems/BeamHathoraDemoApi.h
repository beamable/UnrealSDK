...
private:
	 ...
	 */
	void BP_InitializePlayerImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus, UHathoraDemoInitializePlayerRequest* RequestData,
	 ...
	 */
	void CPP_InitializePlayerImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus, UHathoraDemoInitializePlayerRequest* RequestData,
