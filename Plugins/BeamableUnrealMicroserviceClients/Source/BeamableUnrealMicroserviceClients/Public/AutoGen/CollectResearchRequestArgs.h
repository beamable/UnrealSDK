...
#include "CollectResearchRequestArgs.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLEUNREALMICROSERVICECLIENTS_API UCollectResearchRequestArgs : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
