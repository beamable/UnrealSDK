...
#include "BeamableCoreBlueprintNodes/Public/BeamFlow/ApiRequest/AutoGen/Ticket/K2BeamNode_ApiRequest_DeleteTickets.h"
...
{
	return GET_FUNCTION_NAME_CHECKED(UBeamTicketApi, GetSelf);
}

FName UK2BeamNode_ApiRequest_DeleteTickets::GetRequestFunctionName() const
{
	return GET_FUNCTION_NAME_CHECKED(UBeamTicketApi, DeleteTickets);
}
...
{
	return UBeamTicketApi::StaticClass();
}
