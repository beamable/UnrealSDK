...
#include "BeamableCoreBlueprintNodes/Public/BeamFlow/ApiRequest/AutoGen/Ticket/K2BeamNode_ApiRequest_PostTickets.h"
...
{
	return GET_FUNCTION_NAME_CHECKED(UBeamTicketApi, PostTickets);
}
