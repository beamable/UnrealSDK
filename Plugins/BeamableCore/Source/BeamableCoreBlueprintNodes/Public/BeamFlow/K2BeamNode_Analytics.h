...
#include "K2BeamNode_Analytics.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_Analytics : public UK2Node, public IK2Node_AddPinInterface
{
	GENERATED_BODY()
	...
	UPROPERTY()
	TArray<FString> AdditionalInputsNames;

public:
	UPROPERTY(BlueprintReadWrite, EditAnywhere)
	bool bShowAsArray;

	// IK2Node_AddPinInterface implementation
