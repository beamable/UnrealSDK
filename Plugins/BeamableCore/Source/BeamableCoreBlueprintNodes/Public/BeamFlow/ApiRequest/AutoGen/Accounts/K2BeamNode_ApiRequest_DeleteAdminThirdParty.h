...
#include "K2BeamNode_ApiRequest_DeleteAdminThirdParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteAdminThirdParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/accounts/{objectId}/admin/third-party  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteAdminThirdParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
