...
#include "K2BeamNode_ApiRequest_GetManifestDiffs.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestDiffs"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest/diffs  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestDiffs : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
