...
#include "K2BeamNode_ApiRequest_GetCouponsCount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCouponsCount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/commerce/{objectId}/coupons/count  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCouponsCount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
