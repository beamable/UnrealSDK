...
#include "K2BeamNode_ApiRequest_PutAttachments.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAttachments"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/mail/attachments  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAttachments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
