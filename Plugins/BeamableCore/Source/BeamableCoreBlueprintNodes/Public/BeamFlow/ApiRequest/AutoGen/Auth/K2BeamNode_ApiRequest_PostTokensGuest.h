...
#include "K2BeamNode_ApiRequest_PostTokensGuest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTokensGuest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/tokens/guest  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTokensGuest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
