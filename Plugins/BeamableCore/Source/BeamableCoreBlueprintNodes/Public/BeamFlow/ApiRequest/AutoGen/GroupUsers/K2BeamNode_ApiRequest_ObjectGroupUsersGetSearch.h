...
#include "K2BeamNode_ApiRequest_ObjectGroupUsersGetSearch.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupUsersGetSearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
