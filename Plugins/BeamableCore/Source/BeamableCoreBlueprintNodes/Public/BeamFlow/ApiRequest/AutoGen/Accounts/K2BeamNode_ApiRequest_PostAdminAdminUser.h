...
#include "K2BeamNode_ApiRequest_PostAdminAdminUser.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostAdminAdminUser"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/accounts/admin/admin-user  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostAdminAdminUser : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
