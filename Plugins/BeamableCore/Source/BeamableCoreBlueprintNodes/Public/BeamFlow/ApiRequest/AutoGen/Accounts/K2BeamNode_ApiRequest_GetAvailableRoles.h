...
#include "K2BeamNode_ApiRequest_GetAvailableRoles.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailableRoles"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/accounts/{objectId}/available-roles  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailableRoles : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
