...
#include "K2BeamNode_ApiRequest_DeleteLaunchMessage.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteLaunchMessage"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/realms/launch-message  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteLaunchMessage : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
