...
#include "K2BeamNode_ApiRequest_DeleteLobbies.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteLobbies"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/players/{playerId}/lobbies  of the PlayerLobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteLobbies : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
