...
#include "K2BeamNode_ApiRequest_ObjectCalendarsPostClaimByObjectId.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectCalendarsPostClaimByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
