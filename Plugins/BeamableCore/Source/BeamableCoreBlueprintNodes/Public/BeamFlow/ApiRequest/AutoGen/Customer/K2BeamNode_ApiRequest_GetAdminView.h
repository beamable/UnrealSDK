...
#include "K2BeamNode_ApiRequest_GetAdminView.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminView"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/admin-view  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminView : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
