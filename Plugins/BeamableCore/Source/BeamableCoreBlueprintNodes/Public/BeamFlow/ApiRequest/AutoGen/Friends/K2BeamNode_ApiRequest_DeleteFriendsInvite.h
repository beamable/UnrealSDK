...
#include "K2BeamNode_ApiRequest_DeleteFriendsInvite.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteFriendsInvite"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/social/friends/invite  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteFriendsInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
