...
#include "K2BeamNode_ApiRequest_GetAdminCustomer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminCustomer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/admin/customer  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminCustomer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
