...
#include "K2BeamNode_ApiRequest_PostExternalIdentity.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostExternalIdentity : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
