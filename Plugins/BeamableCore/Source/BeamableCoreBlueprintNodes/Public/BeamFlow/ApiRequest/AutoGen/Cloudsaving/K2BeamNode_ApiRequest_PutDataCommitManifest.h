...
#include "K2BeamNode_ApiRequest_PutDataCommitManifest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutDataCommitManifest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/cloudsaving/data/commitManifest  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutDataCommitManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
