...
#include "K2BeamNode_ApiRequest_DeleteMeThirdParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteMeThirdParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/accounts/me/third-party  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteMeThirdParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
