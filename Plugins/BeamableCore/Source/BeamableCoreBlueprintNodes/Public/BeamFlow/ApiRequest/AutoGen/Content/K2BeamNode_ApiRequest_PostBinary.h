...
#include "K2BeamNode_ApiRequest_PostBinary.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostBinary"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/binary  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostBinary : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
