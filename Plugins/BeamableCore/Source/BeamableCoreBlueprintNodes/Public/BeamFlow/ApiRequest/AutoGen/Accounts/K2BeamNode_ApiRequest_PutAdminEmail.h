...
#include "K2BeamNode_ApiRequest_PutAdminEmail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAdminEmail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/accounts/{objectId}/admin/email  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAdminEmail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
