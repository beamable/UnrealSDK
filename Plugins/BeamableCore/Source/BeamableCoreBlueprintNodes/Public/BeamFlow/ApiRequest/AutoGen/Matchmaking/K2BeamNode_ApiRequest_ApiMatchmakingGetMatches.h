...
#include "K2BeamNode_ApiRequest_ApiMatchmakingGetMatches.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiMatchmakingGetMatches : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
