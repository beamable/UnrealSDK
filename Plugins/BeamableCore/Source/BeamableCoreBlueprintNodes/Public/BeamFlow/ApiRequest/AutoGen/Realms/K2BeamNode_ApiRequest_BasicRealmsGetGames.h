...
#include "K2BeamNode_ApiRequest_BasicRealmsGetGames.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicRealmsGetGames"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/games  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicRealmsGetGames : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
