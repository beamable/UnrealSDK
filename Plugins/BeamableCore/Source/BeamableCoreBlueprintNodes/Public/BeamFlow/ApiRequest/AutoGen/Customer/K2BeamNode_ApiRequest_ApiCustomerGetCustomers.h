...
#include "K2BeamNode_ApiRequest_ApiCustomerGetCustomers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiCustomerGetCustomers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiCustomerGetCustomers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
