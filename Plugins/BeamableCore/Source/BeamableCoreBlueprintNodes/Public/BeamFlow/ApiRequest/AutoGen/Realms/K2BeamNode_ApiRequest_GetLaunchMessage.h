...
#include "K2BeamNode_ApiRequest_GetLaunchMessage.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetLaunchMessage"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/launch-message  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetLaunchMessage : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
