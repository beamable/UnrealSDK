...
#include "K2BeamNode_ApiRequest_GetServicesLogsQuery.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetServicesLogsQuery"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/services/logs/query/{queryId}  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetServicesLogsQuery : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
