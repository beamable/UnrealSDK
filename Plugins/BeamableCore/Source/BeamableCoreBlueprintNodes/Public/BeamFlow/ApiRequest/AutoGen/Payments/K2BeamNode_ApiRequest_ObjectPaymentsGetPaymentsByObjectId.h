...
#include "K2BeamNode_ApiRequest_ObjectPaymentsGetPaymentsByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectPaymentsGetPaymentsByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/payments/{objectId}/  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectPaymentsGetPaymentsByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
