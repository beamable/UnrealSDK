...
#include "K2BeamNode_ApiRequest_GetServicesSecret.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetServicesSecret"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/services/secret  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetServicesSecret : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
