...
#include "K2BeamNode_ApiRequest_DeleteStats.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteStats"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/stats/{objectId}/  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteStats : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
