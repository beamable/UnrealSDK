...
#include "K2BeamNode_ApiRequest_GetOtelAuthReaderConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOtelAuthReaderConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/otel/auth/reader/config  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOtelAuthReaderConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
