...
#include "K2BeamNode_ApiRequest_DeleteEntries.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteEntries"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/leaderboards/{objectId}/entries  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteEntries : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
