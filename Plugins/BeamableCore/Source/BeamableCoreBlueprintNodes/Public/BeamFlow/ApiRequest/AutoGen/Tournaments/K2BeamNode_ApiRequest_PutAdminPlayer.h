...
#include "K2BeamNode_ApiRequest_PutAdminPlayer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAdminPlayer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/tournaments/admin/player  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAdminPlayer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
