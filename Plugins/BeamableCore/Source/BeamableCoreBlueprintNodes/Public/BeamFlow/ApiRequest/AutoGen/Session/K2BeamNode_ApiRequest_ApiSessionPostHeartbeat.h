...
#include "K2BeamNode_ApiRequest_ApiSessionPostHeartbeat.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiSessionPostHeartbeat"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/sessions/heartbeat  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiSessionPostHeartbeat : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
