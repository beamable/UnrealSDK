...
#include "K2BeamNode_ApiRequest_GetCustomerAliasAvailable.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCustomerAliasAvailable"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/customer/alias/available  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCustomerAliasAvailable : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
