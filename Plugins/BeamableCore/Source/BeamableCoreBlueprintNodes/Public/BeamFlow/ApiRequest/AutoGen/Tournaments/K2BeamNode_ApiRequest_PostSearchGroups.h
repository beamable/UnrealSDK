...
#include "K2BeamNode_ApiRequest_PostSearchGroups.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSearchGroups"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/tournaments/search/groups  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSearchGroups : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
