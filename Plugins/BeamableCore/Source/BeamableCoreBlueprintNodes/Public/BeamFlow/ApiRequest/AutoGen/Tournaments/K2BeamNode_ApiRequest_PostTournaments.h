...
#include "K2BeamNode_ApiRequest_PostTournaments.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTournaments"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/tournaments/  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTournaments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
