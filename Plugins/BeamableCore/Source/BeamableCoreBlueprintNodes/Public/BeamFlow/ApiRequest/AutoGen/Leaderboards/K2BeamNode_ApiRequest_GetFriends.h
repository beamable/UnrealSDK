...
#include "K2BeamNode_ApiRequest_GetFriends.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetFriends : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
