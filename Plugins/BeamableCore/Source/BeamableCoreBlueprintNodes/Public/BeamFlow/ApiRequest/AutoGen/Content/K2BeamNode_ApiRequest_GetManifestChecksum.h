...
#include "K2BeamNode_ApiRequest_GetManifestChecksum.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestChecksum"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest/checksum  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestChecksum : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
