...
#include "K2BeamNode_ApiRequest_PostQueryLogsResult.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostQueryLogsResult"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/queryLogs/result  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostQueryLogsResult : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
