...
#include "K2BeamNode_ApiRequest_PostDataUploadURLFromPortal.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostDataUploadURLFromPortal"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/cloudsaving/data/uploadURLFromPortal  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostDataUploadURLFromPortal : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
