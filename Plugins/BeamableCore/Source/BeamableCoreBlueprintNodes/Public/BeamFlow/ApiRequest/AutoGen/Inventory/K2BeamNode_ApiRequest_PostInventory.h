...
#include "K2BeamNode_ApiRequest_PostInventory.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostInventory"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/inventory/{objectId}/  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostInventory : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
