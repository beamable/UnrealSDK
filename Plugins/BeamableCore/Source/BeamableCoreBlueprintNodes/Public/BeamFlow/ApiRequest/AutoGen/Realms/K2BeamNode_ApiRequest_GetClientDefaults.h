...
#include "K2BeamNode_ApiRequest_GetClientDefaults.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetClientDefaults"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/client/defaults  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetClientDefaults : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
