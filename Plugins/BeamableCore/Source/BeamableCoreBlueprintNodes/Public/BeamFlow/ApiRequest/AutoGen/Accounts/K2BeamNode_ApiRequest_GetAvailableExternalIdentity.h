...
#include "K2BeamNode_ApiRequest_GetAvailableExternalIdentity.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailableExternalIdentity : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
