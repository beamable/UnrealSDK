...
#include "K2BeamNode_ApiRequest_PutProxyReload.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutProxyReload"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/inventory/{objectId}/proxy/reload  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutProxyReload : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
