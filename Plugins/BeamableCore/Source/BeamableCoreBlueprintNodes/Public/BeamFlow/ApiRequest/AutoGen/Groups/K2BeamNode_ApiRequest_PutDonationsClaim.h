...
#include "K2BeamNode_ApiRequest_PutDonationsClaim.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutDonationsClaim"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/groups/{objectId}/donations/claim  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutDonationsClaim : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
