...
#include "K2BeamNode_ApiRequest_GetMatchmakingTickets.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMatchmakingTickets"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/matchmaking/tickets  of the PlayerTicket Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMatchmakingTickets : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
