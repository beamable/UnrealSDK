...
#include "K2BeamNode_ApiRequest_BasicContentPostManifest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicContentPostManifest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/manifest  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicContentPostManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
