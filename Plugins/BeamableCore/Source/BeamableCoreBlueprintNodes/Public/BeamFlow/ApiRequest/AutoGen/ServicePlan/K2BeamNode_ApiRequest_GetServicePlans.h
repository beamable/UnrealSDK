...
#include "K2BeamNode_ApiRequest_GetServicePlans.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetServicePlans"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/service-plans  of the ServicePlan Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetServicePlans : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
