...
#include "K2BeamNode_ApiRequest_PostCouponPurchaseTrack.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCouponPurchaseTrack"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/coupon/purchase/track  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCouponPurchaseTrack : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
