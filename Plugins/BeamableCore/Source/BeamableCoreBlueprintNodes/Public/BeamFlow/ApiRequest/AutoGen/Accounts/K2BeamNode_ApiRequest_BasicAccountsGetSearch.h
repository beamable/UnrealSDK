...
#include "K2BeamNode_ApiRequest_BasicAccountsGetSearch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicAccountsGetSearch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/search  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicAccountsGetSearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
