...
#include "K2BeamNode_ApiRequest_PostGeneric.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostGeneric"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/notification/generic  of the Notification Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostGeneric : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
