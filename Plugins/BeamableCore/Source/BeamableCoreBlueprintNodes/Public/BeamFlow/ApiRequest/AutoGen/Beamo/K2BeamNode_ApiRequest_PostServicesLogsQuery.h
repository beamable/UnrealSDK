...
#include "K2BeamNode_ApiRequest_PostServicesLogsQuery.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostServicesLogsQuery"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/services/{serviceName}/logs/query  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostServicesLogsQuery : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
