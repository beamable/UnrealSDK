...
#include "K2BeamNode_ApiRequest_GetAvailability.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailability"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/group-users/{objectId}/availability  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailability : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
