...
#include "K2BeamNode_ApiRequest_PutContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/events/{objectId}/content  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
