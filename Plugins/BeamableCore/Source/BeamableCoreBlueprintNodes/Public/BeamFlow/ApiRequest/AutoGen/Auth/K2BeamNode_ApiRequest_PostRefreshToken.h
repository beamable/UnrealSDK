...
#include "K2BeamNode_ApiRequest_PostRefreshToken.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostRefreshToken"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/refresh-token  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostRefreshToken : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
