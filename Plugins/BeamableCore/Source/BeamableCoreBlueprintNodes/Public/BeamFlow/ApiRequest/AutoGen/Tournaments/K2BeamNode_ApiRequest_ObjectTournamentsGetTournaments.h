...
#include "K2BeamNode_ApiRequest_ObjectTournamentsGetTournaments.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectTournamentsGetTournaments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
