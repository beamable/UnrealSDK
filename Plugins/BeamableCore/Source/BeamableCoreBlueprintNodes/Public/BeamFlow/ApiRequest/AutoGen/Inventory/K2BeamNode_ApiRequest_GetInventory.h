...
#include "K2BeamNode_ApiRequest_GetInventory.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetInventory"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/inventory/{objectId}/  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetInventory : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
