...
#include "K2BeamNode_ApiRequest_GetCalendars.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCalendars"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/calendars/{objectId}/  of the Calendars Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCalendars : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
