...
#include "K2BeamNode_ApiRequest_PostKick.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostKick"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/groups/{objectId}/kick  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostKick : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
