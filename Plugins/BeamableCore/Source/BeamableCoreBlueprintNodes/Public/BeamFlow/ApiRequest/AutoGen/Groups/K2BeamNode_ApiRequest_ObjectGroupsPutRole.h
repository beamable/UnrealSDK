...
#include "K2BeamNode_ApiRequest_ObjectGroupsPutRole.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupsPutRole : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
