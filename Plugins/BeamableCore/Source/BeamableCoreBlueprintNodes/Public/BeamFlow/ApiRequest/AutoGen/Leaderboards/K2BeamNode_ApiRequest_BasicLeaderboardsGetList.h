...
#include "K2BeamNode_ApiRequest_BasicLeaderboardsGetList.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicLeaderboardsGetList"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/leaderboards/list  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicLeaderboardsGetList : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
