...
#include "K2BeamNode_ApiRequest_GetCustomers.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCustomers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
