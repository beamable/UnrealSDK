...
#include "K2BeamNode_ApiRequest_GetMultipliers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMultipliers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/inventory/{objectId}/multipliers  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMultipliers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
