...
#include "K2BeamNode_ApiRequest_GetUploadAPI.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetUploadAPI"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/uploadAPI  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetUploadAPI : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
