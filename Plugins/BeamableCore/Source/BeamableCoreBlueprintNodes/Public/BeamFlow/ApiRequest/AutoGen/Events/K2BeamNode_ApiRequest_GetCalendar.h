...
#include "K2BeamNode_ApiRequest_GetCalendar.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCalendar"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/events/calendar  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCalendar : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
