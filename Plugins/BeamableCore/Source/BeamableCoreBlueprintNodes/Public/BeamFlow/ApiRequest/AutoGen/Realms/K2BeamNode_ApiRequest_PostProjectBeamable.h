...
#include "K2BeamNode_ApiRequest_PostProjectBeamable.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostProjectBeamable"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/realms/project/beamable  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostProjectBeamable : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
