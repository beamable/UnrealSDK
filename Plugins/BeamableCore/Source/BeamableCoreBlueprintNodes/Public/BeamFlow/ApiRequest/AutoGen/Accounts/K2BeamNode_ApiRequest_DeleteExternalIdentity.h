...
#include "K2BeamNode_ApiRequest_DeleteExternalIdentity.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteExternalIdentity : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
