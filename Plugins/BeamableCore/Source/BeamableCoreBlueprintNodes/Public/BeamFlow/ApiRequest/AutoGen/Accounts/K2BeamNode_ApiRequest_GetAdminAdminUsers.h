...
#include "K2BeamNode_ApiRequest_GetAdminAdminUsers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminAdminUsers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/admin/admin-users  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminAdminUsers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
