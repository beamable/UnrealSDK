...
#include "K2BeamNode_ApiRequest_GetKeys.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetKeys"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/auth/keys  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetKeys : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
