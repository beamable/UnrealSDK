...
#include "K2BeamNode_ApiRequest_GetClientBatch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetClientBatch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/stats/client/batch  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetClientBatch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
