...
#include "K2BeamNode_ApiRequest_PostMatch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostMatch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/matchmaking/{objectId}/match  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostMatch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
