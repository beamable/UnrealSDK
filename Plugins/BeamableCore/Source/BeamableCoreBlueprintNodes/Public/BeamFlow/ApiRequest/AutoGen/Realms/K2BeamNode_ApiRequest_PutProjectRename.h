...
#include "K2BeamNode_ApiRequest_PutProjectRename.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutProjectRename"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/realms/project/rename  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutProjectRename : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
