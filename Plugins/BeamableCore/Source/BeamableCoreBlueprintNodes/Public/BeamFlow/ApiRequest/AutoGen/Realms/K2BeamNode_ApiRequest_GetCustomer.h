...
#include "K2BeamNode_ApiRequest_GetCustomer.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCustomer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
