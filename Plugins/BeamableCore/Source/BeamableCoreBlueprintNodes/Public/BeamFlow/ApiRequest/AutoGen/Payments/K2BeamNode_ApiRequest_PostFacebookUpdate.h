...
#include "K2BeamNode_ApiRequest_PostFacebookUpdate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostFacebookUpdate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/facebook/update  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostFacebookUpdate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
