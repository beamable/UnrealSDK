...
#include "K2BeamNode_ApiRequest_ApiCustomerGetConfigByCustomerId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiCustomerGetConfigByCustomerId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/config  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiCustomerGetConfigByCustomerId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
