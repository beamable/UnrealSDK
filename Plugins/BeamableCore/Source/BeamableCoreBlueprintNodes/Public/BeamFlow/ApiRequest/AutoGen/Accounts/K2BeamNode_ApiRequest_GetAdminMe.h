...
#include "K2BeamNode_ApiRequest_GetAdminMe.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminMe"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/admin/me  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminMe : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
