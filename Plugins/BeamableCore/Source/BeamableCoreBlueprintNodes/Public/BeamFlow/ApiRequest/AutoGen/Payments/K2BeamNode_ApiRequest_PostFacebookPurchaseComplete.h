...
#include "K2BeamNode_ApiRequest_PostFacebookPurchaseComplete.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostFacebookPurchaseComplete"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/facebook/purchase/complete  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostFacebookPurchaseComplete : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
