...
#include "K2BeamNode_ApiRequest_BasicMailPostBulk.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicMailPostBulk"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/mail/bulk  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicMailPostBulk : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
