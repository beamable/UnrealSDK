...
#include "K2BeamNode_ApiRequest_PostSignup.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSignup"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/accounts/signup  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSignup : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
