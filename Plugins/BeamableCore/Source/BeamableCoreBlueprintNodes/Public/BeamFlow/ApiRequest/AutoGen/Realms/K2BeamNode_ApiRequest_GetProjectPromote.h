...
#include "K2BeamNode_ApiRequest_GetProjectPromote.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetProjectPromote"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/project/promote  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetProjectPromote : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
