...
#include "K2BeamNode_ApiRequest_GetSkus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSkus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/commerce/skus  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSkus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
