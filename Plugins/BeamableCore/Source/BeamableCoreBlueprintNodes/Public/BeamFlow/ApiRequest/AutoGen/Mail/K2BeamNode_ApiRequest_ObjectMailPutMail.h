...
#include "K2BeamNode_ApiRequest_ObjectMailPutMail.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailPutMail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
