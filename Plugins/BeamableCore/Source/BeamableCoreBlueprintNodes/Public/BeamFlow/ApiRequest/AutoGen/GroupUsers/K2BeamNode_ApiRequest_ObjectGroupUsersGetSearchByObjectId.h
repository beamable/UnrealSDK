...
#include "K2BeamNode_ApiRequest_ObjectGroupUsersGetSearchByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectGroupUsersGetSearchByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/group-users/{objectId}/search  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupUsersGetSearchByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
