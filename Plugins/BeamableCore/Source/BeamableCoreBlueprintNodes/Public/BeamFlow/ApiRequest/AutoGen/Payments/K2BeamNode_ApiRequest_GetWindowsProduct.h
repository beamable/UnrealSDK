...
#include "K2BeamNode_ApiRequest_GetWindowsProduct.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetWindowsProduct"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/windows/product  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetWindowsProduct : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
