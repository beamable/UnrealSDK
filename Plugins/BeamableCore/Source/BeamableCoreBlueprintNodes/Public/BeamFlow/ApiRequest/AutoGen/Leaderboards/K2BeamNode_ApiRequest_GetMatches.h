...
#include "K2BeamNode_ApiRequest_GetMatches.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMatches : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
