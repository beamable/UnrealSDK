...
#include "K2BeamNode_ApiRequest_PostEmailUpdateInit.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostEmailUpdateInit"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/accounts/email-update/init  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostEmailUpdateInit : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
