...
#include "K2BeamNode_ApiRequest_ApiPartyPostInviteById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiPartyPostInviteById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/parties/{id}/invite  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPartyPostInviteById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
