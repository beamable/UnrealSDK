...
#include "K2BeamNode_ApiRequest_GetClientHistory.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetClientHistory"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/session/client/history  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetClientHistory : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
