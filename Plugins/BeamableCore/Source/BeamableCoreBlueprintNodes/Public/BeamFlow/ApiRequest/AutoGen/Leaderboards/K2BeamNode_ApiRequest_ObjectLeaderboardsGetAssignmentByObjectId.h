...
#include "K2BeamNode_ApiRequest_ObjectLeaderboardsGetAssignmentByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectLeaderboardsGetAssignmentByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/leaderboards/{objectId}/assignment  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectLeaderboardsGetAssignmentByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
