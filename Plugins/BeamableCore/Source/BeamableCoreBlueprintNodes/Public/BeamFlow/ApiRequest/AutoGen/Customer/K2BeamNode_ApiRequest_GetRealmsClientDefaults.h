...
#include "K2BeamNode_ApiRequest_GetRealmsClientDefaults.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRealmsClientDefaults"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/realms/{realmId}/client-defaults  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRealmsClientDefaults : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
