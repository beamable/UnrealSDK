...
#include "K2BeamNode_ApiRequest_PutOtelViews.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutOtelViews"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/beamo/otel/views/{viewId}  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutOtelViews : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
