...
#include "K2BeamNode_ApiRequest_PostLoglevelContext.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostLoglevelContext"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/loglevel-context  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostLoglevelContext : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
