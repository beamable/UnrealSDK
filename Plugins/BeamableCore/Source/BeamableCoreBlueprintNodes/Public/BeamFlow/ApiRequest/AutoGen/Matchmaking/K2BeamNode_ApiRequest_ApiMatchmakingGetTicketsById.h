...
#include "K2BeamNode_ApiRequest_ApiMatchmakingGetTicketsById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiMatchmakingGetTicketsById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/matchmaking/tickets/{id}  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiMatchmakingGetTicketsById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
