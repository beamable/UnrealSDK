...
#include "K2BeamNode_ApiRequest_GetManifestChecksums.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestChecksums"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest/checksums  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestChecksums : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
