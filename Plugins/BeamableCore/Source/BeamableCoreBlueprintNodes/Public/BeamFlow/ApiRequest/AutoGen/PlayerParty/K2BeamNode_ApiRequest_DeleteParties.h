...
#include "K2BeamNode_ApiRequest_DeleteParties.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteParties"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/players/{playerId}/parties  of the PlayerParty Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteParties : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
