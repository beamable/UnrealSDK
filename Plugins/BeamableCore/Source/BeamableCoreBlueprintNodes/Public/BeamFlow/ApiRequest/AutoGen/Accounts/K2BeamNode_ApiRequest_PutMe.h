...
#include "K2BeamNode_ApiRequest_PutMe.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutMe"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/accounts/me  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutMe : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
