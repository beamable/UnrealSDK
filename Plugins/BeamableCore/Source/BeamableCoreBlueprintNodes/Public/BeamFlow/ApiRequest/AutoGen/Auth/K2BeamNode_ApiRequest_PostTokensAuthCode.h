...
#include "K2BeamNode_ApiRequest_PostTokensAuthCode.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTokensAuthCode"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/tokens/auth-code  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTokensAuthCode : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
