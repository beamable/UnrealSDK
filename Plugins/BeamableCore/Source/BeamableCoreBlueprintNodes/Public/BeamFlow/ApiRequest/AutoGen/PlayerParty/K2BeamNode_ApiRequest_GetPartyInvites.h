...
#include "K2BeamNode_ApiRequest_GetPartyInvites.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPartyInvites"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/party/invites  of the PlayerParty Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPartyInvites : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
