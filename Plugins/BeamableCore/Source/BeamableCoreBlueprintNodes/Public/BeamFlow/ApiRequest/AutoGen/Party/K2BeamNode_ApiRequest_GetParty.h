...
#include "K2BeamNode_ApiRequest_GetParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/parties/{id}  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
