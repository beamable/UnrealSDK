...
#include "K2BeamNode_ApiRequest_BasicBeamoGetStoragePerformance.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetStoragePerformance"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/storage/performance  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetStoragePerformance : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
