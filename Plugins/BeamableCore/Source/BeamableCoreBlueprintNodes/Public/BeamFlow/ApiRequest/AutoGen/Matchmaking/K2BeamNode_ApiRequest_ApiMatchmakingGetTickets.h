...
#include "K2BeamNode_ApiRequest_ApiMatchmakingGetTickets.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiMatchmakingGetTickets"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/matchmaking/tickets  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiMatchmakingGetTickets : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
