...
#include "K2BeamNode_ApiRequest_GetOffersAdmin.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOffersAdmin"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/commerce/{objectId}/offersAdmin  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOffersAdmin : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
