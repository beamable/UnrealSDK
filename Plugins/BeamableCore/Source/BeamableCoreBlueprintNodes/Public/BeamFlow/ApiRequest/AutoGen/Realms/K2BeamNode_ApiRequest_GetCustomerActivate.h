...
#include "K2BeamNode_ApiRequest_GetCustomerActivate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCustomerActivate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/customer/activate  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCustomerActivate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
