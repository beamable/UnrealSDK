...
#include "K2BeamNode_ApiRequest_PostBlocked.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostBlocked"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/social/blocked  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostBlocked : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
