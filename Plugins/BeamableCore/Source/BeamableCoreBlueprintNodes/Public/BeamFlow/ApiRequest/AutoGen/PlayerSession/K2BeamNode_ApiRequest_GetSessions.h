...
#include "K2BeamNode_ApiRequest_GetSessions.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSessions"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/sessions  of the PlayerSession Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSessions : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
