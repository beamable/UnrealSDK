...
#include "K2BeamNode_ApiRequest_PutScore.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutScore"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/event-players/{objectId}/score  of the EventPlayers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutScore : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
