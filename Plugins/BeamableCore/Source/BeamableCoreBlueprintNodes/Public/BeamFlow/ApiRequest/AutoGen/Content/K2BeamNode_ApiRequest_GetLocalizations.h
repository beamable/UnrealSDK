...
#include "K2BeamNode_ApiRequest_GetLocalizations.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetLocalizations"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/localizations  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetLocalizations : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
