...
#include "K2BeamNode_ApiRequest_DeleteGroups.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteGroups"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/groups/{objectId}/  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteGroups : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
