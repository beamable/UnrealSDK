...
#include "K2BeamNode_ApiRequest_GetRoleReport.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRoleReport"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/accounts/{objectId}/role/report  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRoleReport : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
