...
#include "K2BeamNode_ApiRequest_PostBatch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostBatch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/stats/batch  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostBatch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
