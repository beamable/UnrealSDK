...
#include "K2BeamNode_ApiRequest_PostVerify.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostVerify"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/customers/verify  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostVerify : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
