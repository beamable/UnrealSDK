...
#include "K2BeamNode_ApiRequest_DeleteQueryLogs.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteQueryLogs"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/beamo/queryLogs  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteQueryLogs : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
