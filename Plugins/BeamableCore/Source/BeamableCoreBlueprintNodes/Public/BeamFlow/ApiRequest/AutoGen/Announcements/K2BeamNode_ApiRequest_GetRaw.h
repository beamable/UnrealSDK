...
#include "K2BeamNode_ApiRequest_GetRaw.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRaw"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/announcements/{objectId}/raw  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRaw : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
