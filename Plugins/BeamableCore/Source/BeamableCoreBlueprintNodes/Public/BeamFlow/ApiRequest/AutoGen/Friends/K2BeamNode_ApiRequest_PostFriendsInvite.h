...
#include "K2BeamNode_ApiRequest_PostFriendsInvite.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostFriendsInvite"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/social/friends/invite  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostFriendsInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
