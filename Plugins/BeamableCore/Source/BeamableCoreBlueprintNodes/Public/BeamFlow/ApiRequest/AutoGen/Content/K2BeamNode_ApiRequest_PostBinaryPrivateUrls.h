...
#include "K2BeamNode_ApiRequest_PostBinaryPrivateUrls.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostBinaryPrivateUrls"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/binary/private/urls  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostBinaryPrivateUrls : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
