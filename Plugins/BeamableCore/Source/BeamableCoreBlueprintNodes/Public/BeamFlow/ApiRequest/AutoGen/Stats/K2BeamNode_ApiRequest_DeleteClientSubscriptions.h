...
#include "K2BeamNode_ApiRequest_DeleteClientSubscriptions.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteClientSubscriptions"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/stats/{objectId}/client/subscriptions  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteClientSubscriptions : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
