...
#include "K2BeamNode_ApiRequest_BasicAnnouncementsGetContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicAnnouncementsGetContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/announcements/content  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicAnnouncementsGetContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
