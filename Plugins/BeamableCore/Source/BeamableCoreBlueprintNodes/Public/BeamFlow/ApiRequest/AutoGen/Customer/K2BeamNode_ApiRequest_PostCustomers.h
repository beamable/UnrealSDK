...
#include "K2BeamNode_ApiRequest_PostCustomers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCustomers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/customers  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCustomers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
