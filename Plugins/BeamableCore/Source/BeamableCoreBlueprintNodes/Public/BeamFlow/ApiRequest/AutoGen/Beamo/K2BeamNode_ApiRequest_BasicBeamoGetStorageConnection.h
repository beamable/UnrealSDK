...
#include "K2BeamNode_ApiRequest_BasicBeamoGetStorageConnection.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetStorageConnection"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/storage/connection  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetStorageConnection : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
