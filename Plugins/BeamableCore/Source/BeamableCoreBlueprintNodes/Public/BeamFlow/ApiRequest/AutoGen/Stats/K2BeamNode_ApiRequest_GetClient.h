...
#include "K2BeamNode_ApiRequest_GetClient.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetClient"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/stats/{objectId}/client  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetClient : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
