...
#include "K2BeamNode_ApiRequest_PostPlayer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPlayer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/notification/player  of the Notification Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPlayer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
