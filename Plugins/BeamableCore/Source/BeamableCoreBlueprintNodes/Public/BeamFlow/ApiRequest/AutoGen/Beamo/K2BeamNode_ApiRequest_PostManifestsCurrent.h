...
#include "K2BeamNode_ApiRequest_PostManifestsCurrent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestsCurrent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/manifests/current  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestsCurrent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
