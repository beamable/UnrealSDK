...
#include "K2BeamNode_ApiRequest_PostPetition.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPetition"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/groups/{objectId}/petition  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPetition : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
