...
#include "K2BeamNode_ApiRequest_PutAccounts.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAccounts"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/accounts/{objectId}/  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAccounts : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
