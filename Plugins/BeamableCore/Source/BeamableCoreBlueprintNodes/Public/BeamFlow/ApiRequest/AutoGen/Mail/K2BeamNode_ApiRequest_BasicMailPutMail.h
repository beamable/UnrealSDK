...
#include "K2BeamNode_ApiRequest_BasicMailPutMail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicMailPutMail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/mail/  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicMailPutMail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
