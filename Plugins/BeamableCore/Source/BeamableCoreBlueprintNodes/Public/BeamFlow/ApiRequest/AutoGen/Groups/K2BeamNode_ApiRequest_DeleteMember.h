...
#include "K2BeamNode_ApiRequest_DeleteMember.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteMember"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/groups/{objectId}/member  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteMember : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
