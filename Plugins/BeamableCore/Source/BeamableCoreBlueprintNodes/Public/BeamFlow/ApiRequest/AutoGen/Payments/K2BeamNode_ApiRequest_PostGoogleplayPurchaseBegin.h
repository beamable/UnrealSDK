...
#include "K2BeamNode_ApiRequest_PostGoogleplayPurchaseBegin.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostGoogleplayPurchaseBegin"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/googleplay/purchase/begin  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostGoogleplayPurchaseBegin : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
