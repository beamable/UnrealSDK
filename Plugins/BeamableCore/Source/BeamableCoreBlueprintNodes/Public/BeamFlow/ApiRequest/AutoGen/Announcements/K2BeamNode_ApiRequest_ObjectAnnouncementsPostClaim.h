...
#include "K2BeamNode_ApiRequest_ObjectAnnouncementsPostClaim.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectAnnouncementsPostClaim : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
