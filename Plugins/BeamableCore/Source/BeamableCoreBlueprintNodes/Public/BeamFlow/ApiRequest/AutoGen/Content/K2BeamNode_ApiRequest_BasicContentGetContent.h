...
#include "K2BeamNode_ApiRequest_BasicContentGetContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicContentGetContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/content  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicContentGetContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
