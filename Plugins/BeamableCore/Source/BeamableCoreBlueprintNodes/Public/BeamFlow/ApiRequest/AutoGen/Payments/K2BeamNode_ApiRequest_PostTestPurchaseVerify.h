...
#include "K2BeamNode_ApiRequest_PostTestPurchaseVerify.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTestPurchaseVerify"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/test/purchase/verify  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTestPurchaseVerify : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
