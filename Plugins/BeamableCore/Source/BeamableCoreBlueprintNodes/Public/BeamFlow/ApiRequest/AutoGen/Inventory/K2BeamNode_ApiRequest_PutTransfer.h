...
#include "K2BeamNode_ApiRequest_PutTransfer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutTransfer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/inventory/{objectId}/transfer  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutTransfer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
