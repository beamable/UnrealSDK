...
#include "K2BeamNode_ApiRequest_PutPreview.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPreview"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/inventory/{objectId}/preview  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPreview : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
