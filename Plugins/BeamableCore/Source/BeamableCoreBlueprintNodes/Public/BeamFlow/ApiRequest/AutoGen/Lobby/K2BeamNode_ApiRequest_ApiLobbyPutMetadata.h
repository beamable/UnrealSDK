...
#include "K2BeamNode_ApiRequest_ApiLobbyPutMetadata.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyPutMetadata : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
