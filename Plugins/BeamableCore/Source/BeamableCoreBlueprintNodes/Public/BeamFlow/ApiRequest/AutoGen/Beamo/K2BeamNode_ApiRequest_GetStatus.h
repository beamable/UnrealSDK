...
#include "K2BeamNode_ApiRequest_GetStatus.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
