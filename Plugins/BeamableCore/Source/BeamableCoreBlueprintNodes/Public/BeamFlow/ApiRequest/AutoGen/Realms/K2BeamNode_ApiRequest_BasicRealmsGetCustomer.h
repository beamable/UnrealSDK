...
#include "K2BeamNode_ApiRequest_BasicRealmsGetCustomer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicRealmsGetCustomer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/customer  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicRealmsGetCustomer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
