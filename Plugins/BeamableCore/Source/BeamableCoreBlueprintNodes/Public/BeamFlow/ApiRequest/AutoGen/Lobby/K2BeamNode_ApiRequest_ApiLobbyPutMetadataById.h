...
#include "K2BeamNode_ApiRequest_ApiLobbyPutMetadataById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiLobbyPutMetadataById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/lobbies/{id}/metadata  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyPutMetadataById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
