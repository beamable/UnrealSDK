...
#include "K2BeamNode_ApiRequest_GetStats.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetStats"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/stats/{objectId}/  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetStats : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
