...
#include "K2BeamNode_ApiRequest_PutGame.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutGame"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/realms/game  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutGame : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
