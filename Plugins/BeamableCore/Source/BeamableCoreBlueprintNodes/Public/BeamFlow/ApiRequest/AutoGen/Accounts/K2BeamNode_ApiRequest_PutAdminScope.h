...
#include "K2BeamNode_ApiRequest_PutAdminScope.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAdminScope"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/accounts/{objectId}/admin/scope  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAdminScope : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
