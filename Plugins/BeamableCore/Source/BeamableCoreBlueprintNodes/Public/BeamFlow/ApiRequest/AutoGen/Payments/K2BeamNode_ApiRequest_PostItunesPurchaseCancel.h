...
#include "K2BeamNode_ApiRequest_PostItunesPurchaseCancel.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostItunesPurchaseCancel"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/itunes/purchase/cancel  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostItunesPurchaseCancel : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
