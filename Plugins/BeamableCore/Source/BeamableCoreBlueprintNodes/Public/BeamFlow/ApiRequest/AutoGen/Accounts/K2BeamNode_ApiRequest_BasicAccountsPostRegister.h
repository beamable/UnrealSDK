...
#include "K2BeamNode_ApiRequest_BasicAccountsPostRegister.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicAccountsPostRegister"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/accounts/register  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicAccountsPostRegister : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
