...
#include "K2BeamNode_ApiRequest_PostPasswordUpdateConfirm.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPasswordUpdateConfirm"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/accounts/password-update/confirm  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPasswordUpdateConfirm : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
