...
#include "K2BeamNode_ApiRequest_GetRooms.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRooms"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/chatV2/{objectId}/rooms  of the ChatV2 Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRooms : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
