...
#include "K2BeamNode_ApiRequest_PostManifestsPull.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestsPull"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/manifests/pull  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestsPull : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
