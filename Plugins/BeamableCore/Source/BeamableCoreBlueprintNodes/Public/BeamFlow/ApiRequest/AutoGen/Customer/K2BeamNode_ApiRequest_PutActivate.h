...
#include "K2BeamNode_ApiRequest_PutActivate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutActivate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/customers/activate  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutActivate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
