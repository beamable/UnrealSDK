...
#include "K2BeamNode_ApiRequest_ApiAuthGetTokens.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiAuthGetTokens"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/auth/tokens  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiAuthGetTokens : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
