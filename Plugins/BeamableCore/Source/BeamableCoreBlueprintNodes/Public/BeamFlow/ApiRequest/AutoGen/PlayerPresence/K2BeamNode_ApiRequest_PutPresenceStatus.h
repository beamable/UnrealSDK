...
#include "K2BeamNode_ApiRequest_PutPresenceStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPresenceStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/players/{playerId}/presence/status  of the PlayerPresence Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPresenceStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
