...
#include "K2BeamNode_ApiRequest_ObjectMailPutMailByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectMailPutMailByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/mail/{objectId}/  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailPutMailByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
