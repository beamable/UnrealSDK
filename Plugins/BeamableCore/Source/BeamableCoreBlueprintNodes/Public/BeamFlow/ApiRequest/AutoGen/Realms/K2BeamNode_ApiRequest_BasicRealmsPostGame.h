...
#include "K2BeamNode_ApiRequest_BasicRealmsPostGame.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicRealmsPostGame"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/realms/game  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicRealmsPostGame : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
