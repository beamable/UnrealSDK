...
#include "K2BeamNode_ApiRequest_PostFriendsMake.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostFriendsMake"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/social/friends/make  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostFriendsMake : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
