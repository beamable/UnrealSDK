...
#include "K2BeamNode_ApiRequest_PutRealmsConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutRealmsConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/customers/{customerId}/realms/{realmId}/config  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutRealmsConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
