...
#include "K2BeamNode_ApiRequest_GetDetail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetDetail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/mail/{objectId}/detail  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetDetail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
