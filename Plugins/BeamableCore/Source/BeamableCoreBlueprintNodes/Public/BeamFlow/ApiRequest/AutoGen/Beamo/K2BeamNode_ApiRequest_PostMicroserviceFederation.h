...
#include "K2BeamNode_ApiRequest_PostMicroserviceFederation.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostMicroserviceFederation"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/microservice/federation  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostMicroserviceFederation : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
