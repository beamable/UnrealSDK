...
#include "K2BeamNode_ApiRequest_PostSend.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSend"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/push/send  of the Push Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSend : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
