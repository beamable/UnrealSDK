...
#include "K2BeamNode_ApiRequest_PutServicesFederationTraffic.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutServicesFederationTraffic"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/beamo/services/{serviceName}/federation/traffic  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutServicesFederationTraffic : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
