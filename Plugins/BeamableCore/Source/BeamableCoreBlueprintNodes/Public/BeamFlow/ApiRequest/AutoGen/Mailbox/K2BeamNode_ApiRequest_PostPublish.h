...
#include "K2BeamNode_ApiRequest_PostPublish.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPublish"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/mailbox/publish  of the Mailbox Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPublish : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
