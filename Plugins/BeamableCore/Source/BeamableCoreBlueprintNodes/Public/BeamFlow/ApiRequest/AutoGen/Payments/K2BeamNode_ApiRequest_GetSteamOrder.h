...
#include "K2BeamNode_ApiRequest_GetSteamOrder.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSteamOrder"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/steam/order  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSteamOrder : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
