...
#include "K2BeamNode_ApiRequest_ApiLobbyGetLobbies.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiLobbyGetLobbies"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/lobbies  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyGetLobbies : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
