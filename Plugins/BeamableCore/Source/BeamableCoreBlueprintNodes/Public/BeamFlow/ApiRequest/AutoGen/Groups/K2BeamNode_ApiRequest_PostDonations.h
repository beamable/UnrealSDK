...
#include "K2BeamNode_ApiRequest_PostDonations.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostDonations"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/groups/{objectId}/donations  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostDonations : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
