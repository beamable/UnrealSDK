...
#include "K2BeamNode_ApiRequest_GetNotification.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetNotification"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/notification/  of the Notification Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetNotification : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
