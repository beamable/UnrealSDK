...
#include "K2BeamNode_ApiRequest_ObjectTournamentsGetTournamentsByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectTournamentsGetTournamentsByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/tournaments/{objectId}/  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectTournamentsGetTournamentsByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
