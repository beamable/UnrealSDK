...
#include "K2BeamNode_ApiRequest_BasicRealmsGetConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicRealmsGetConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/config  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicRealmsGetConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
