...
#include "K2BeamNode_ApiRequest_PostLeaderboards.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostLeaderboards"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/leaderboards/{objectId}/  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostLeaderboards : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
