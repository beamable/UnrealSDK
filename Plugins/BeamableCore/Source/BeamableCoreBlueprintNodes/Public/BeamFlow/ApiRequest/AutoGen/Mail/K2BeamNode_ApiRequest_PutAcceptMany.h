...
#include "K2BeamNode_ApiRequest_PutAcceptMany.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAcceptMany"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/mail/{objectId}/accept/many  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAcceptMany : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
