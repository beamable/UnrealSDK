...
#include "K2BeamNode_ApiRequest_ObjectAnnouncementsPostClaimByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectAnnouncementsPostClaimByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/announcements/{objectId}/claim  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectAnnouncementsPostClaimByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
