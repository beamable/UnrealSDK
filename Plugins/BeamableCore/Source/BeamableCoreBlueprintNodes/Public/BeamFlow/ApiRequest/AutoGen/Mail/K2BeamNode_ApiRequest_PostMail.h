...
#include "K2BeamNode_ApiRequest_PostMail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostMail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/mail/{objectId}/  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostMail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
