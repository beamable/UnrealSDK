...
#include "K2BeamNode_ApiRequest_PutPresence.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPresence"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/players/{playerId}/presence  of the PlayerPresence Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPresence : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
