...
#include "K2BeamNode_ApiRequest_PostManifestDeploy.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestDeploy"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/manifest/deploy  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestDeploy : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
