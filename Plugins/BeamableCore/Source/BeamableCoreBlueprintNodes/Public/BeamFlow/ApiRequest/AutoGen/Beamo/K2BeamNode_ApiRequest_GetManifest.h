...
#include "K2BeamNode_ApiRequest_GetManifest.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
