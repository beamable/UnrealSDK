...
#include "K2BeamNode_ApiRequest_BasicContentGetManifest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicContentGetManifest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicContentGetManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
