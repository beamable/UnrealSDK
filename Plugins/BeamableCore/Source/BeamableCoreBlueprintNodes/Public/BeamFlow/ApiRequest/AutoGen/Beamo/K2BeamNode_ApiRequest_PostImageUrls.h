...
#include "K2BeamNode_ApiRequest_PostImageUrls.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostImageUrls"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/image/urls  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostImageUrls : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
