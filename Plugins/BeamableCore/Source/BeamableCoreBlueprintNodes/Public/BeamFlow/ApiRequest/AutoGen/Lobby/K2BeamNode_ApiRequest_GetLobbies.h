...
#include "K2BeamNode_ApiRequest_GetLobbies.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetLobbies : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
