...
#include "K2BeamNode_ApiRequest_DeleteInvite.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteInvite"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/parties/{id}/invite  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
