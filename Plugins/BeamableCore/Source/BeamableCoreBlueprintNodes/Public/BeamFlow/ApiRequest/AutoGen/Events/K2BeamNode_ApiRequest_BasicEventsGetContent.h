...
#include "K2BeamNode_ApiRequest_BasicEventsGetContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicEventsGetContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/events/content  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicEventsGetContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
