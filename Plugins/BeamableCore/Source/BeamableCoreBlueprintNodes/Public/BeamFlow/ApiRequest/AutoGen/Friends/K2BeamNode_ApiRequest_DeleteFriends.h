...
#include "K2BeamNode_ApiRequest_DeleteFriends.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteFriends"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/social/friends  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteFriends : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
