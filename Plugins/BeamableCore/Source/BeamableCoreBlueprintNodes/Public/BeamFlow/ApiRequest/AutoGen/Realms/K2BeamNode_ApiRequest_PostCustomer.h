...
#include "K2BeamNode_ApiRequest_PostCustomer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCustomer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/realms/customer  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCustomer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
