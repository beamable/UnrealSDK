...
#include "K2BeamNode_ApiRequest_PutPromote.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPromote"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/parties/{id}/promote  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPromote : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
