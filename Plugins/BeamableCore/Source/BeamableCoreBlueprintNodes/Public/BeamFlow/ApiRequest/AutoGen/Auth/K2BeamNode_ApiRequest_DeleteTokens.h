...
#include "K2BeamNode_ApiRequest_DeleteTokens.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteTokens"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/auth/tokens  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteTokens : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
