...
#include "K2BeamNode_ApiRequest_PutPurchase.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPurchase"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/commerce/{objectId}/purchase  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPurchase : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
