...
#include "K2BeamNode_ApiRequest_PostAuthCodes.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostAuthCodes"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/auth-codes  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostAuthCodes : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
