...
#include "K2BeamNode_ApiRequest_PostLobbies.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostLobbies"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/lobbies  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostLobbies : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
