...
#include "K2BeamNode_ApiRequest_DeleteInflightFailures.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteInflightFailures"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/admin/inflight/failures  of the Admin Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteInflightFailures : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
