...
#include "K2BeamNode_ApiRequest_GetPlans.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPlans"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/plans  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPlans : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
