...
#include "K2BeamNode_ApiRequest_PostServicesFederation.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostServicesFederation"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/services/federation  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostServicesFederation : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
