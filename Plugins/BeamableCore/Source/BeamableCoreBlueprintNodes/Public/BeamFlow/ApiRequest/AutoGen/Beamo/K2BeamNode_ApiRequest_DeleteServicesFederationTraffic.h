...
#include "K2BeamNode_ApiRequest_DeleteServicesFederationTraffic.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteServicesFederationTraffic"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/beamo/services/{serviceName}/federation/traffic  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteServicesFederationTraffic : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
