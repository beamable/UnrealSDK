...
#include "K2BeamNode_ApiRequest_ObjectGroupsGetGroupsByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectGroupsGetGroupsByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/groups/{objectId}/  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupsGetGroupsByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
