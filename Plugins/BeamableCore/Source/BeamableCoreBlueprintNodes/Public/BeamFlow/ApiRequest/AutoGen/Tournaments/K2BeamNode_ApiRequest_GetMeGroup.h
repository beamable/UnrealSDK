...
#include "K2BeamNode_ApiRequest_GetMeGroup.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMeGroup"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/tournaments/me/group  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMeGroup : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
