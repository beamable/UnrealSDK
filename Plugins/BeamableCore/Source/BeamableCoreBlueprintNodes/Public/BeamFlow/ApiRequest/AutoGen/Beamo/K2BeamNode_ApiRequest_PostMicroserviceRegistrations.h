...
#include "K2BeamNode_ApiRequest_PostMicroserviceRegistrations.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostMicroserviceRegistrations"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/microservice/registrations  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostMicroserviceRegistrations : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
