...
#include "K2BeamNode_ApiRequest_PostChannel.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostChannel"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/notification/channel  of the Notification Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostChannel : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
