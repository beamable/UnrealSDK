...
#include "K2BeamNode_ApiRequest_GetPayment.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPayment"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/payments/{transactionId}  of the Payment Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPayment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
