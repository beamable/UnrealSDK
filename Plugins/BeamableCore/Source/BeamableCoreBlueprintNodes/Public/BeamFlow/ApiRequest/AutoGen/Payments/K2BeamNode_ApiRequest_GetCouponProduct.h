...
#include "K2BeamNode_ApiRequest_GetCouponProduct.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCouponProduct"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/coupon/product  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCouponProduct : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
