...
#include "K2BeamNode_ApiRequest_GetItems.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetItems"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/inventory/items  of the Inventory Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetItems : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
