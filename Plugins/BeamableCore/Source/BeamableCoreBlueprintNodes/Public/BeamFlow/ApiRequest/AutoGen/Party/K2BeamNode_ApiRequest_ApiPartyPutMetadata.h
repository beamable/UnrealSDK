...
#include "K2BeamNode_ApiRequest_ApiPartyPutMetadata.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPartyPutMetadata : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
