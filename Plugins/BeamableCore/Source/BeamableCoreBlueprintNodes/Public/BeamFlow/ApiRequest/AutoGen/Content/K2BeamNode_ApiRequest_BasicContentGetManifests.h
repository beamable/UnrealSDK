...
#include "K2BeamNode_ApiRequest_BasicContentGetManifests.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicContentGetManifests"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifests  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicContentGetManifests : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
