...
#include "K2BeamNode_ApiRequest_PostRooms.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostRooms"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/chatV2/{objectId}/rooms  of the ChatV2 Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostRooms : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
