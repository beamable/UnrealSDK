...
#include "K2BeamNode_ApiRequest_PostInvite.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
