...
#include "K2BeamNode_ApiRequest_GetAvailableExternal_identity.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailableExternal_identity"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/available/external_identity  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailableExternal_identity : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
