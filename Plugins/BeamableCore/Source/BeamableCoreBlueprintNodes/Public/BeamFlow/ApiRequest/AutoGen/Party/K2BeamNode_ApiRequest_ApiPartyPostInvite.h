...
#include "K2BeamNode_ApiRequest_ApiPartyPostInvite.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPartyPostInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
