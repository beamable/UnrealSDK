...
#include "K2BeamNode_ApiRequest_PostSkus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSkus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/commerce/skus  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSkus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
