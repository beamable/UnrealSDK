...
#include "K2BeamNode_ApiRequest_GetAudits.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAudits"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/audits  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAudits : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
