...
#include "K2BeamNode_ApiRequest_PostManifestsArchive.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestsArchive"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/manifests/archive  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestsArchive : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
