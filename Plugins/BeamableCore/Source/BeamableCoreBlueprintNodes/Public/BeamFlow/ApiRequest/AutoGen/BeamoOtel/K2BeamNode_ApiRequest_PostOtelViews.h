...
#include "K2BeamNode_ApiRequest_PostOtelViews.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostOtelViews"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/otel/views  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostOtelViews : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
