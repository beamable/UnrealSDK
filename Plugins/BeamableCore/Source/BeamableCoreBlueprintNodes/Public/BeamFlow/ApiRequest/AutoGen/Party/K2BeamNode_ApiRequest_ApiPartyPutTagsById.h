...
#include "K2BeamNode_ApiRequest_ApiPartyPutTagsById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiPartyPutTagsById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/parties/{id}/tags  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPartyPutTagsById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
