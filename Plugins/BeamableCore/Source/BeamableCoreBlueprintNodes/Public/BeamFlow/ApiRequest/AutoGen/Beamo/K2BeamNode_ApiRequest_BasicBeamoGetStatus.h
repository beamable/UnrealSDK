...
#include "K2BeamNode_ApiRequest_BasicBeamoGetStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/status  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
