...
#include "K2BeamNode_ApiRequest_PutSubscribe.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutSubscribe"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/stats/subscribe  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutSubscribe : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
