...
#include "K2BeamNode_ApiRequest_GetStoragePerformance.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetStoragePerformance : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
