...
#include "K2BeamNode_ApiRequest_PutAdminThirdParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutAdminThirdParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/accounts/{objectId}/admin/third-party  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutAdminThirdParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
