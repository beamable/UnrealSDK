...
#include "K2BeamNode_ApiRequest_GetOtelAuthWriterConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOtelAuthWriterConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/otel/auth/writer/config  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOtelAuthWriterConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
