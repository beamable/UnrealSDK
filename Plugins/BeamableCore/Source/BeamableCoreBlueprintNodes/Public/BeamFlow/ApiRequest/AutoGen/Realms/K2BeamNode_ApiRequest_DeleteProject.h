...
#include "K2BeamNode_ApiRequest_DeleteProject.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteProject"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/realms/project  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteProject : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
