...
#include "K2BeamNode_ApiRequest_DeleteJoin.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteJoin"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/group-users/{objectId}/join  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteJoin : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
