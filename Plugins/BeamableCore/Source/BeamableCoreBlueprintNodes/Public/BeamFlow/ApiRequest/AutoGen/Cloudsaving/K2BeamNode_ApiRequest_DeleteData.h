...
#include "K2BeamNode_ApiRequest_DeleteData.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteData"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/cloudsaving/data  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteData : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
