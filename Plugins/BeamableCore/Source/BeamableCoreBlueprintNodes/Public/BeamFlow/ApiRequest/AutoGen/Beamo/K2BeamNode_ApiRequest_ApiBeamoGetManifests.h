...
#include "K2BeamNode_ApiRequest_ApiBeamoGetManifests.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetManifests"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/manifests  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetManifests : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
