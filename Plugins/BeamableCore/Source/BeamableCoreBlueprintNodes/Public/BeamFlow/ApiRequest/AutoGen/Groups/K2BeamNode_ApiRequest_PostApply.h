...
#include "K2BeamNode_ApiRequest_PostApply.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostApply"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/groups/{objectId}/apply  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostApply : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
