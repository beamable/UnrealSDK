...
#include "K2BeamNode_ApiRequest_GetTickets.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetTickets : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
