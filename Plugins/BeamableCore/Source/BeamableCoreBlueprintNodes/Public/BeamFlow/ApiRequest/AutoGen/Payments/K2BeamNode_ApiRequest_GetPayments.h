...
#include "K2BeamNode_ApiRequest_GetPayments.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPayments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
