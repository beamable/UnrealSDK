...
#include "K2BeamNode_ApiRequest_PutEntry.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutEntry"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/leaderboards/{objectId}/entry  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutEntry : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
