...
#include "K2BeamNode_ApiRequest_GetPing.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPing"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/events/{objectId}/ping  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPing : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
