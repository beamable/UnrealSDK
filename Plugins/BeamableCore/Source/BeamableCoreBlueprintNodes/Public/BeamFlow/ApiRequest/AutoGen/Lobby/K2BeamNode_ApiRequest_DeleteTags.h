...
#include "K2BeamNode_ApiRequest_DeleteTags.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteTags"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/lobbies/{id}/tags  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteTags : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
