...
#include "K2BeamNode_ApiRequest_GetDataMetadata.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetDataMetadata"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/cloudsaving/data/metadata  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetDataMetadata : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
