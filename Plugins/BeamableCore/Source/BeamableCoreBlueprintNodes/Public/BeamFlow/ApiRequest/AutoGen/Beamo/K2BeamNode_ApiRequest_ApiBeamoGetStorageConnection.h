...
#include "K2BeamNode_ApiRequest_ApiBeamoGetStorageConnection.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetStorageConnection"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/storage/connection  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetStorageConnection : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
