...
#include "K2BeamNode_ApiRequest_GetManifests.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifests : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
