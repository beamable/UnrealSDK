...
#include "K2BeamNode_ApiRequest_BasicContentPostManifestPull.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicContentPostManifestPull"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/manifest/pull  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicContentPostManifestPull : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
