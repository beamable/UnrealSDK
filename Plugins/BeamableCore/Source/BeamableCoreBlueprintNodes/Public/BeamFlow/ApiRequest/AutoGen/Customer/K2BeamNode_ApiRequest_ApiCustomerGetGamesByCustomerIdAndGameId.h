...
#include "K2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerIdAndGameId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerIdAndGameId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/games/{gameId}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerIdAndGameId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
