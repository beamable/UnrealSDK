...
#include "K2BeamNode_ApiRequest_GetChatV2.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetChatV2"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/chatV2/{objectId}/  of the ChatV2 Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetChatV2 : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
