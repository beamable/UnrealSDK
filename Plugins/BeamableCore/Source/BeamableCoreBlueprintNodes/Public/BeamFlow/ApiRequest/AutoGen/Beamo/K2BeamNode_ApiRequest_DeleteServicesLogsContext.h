...
#include "K2BeamNode_ApiRequest_DeleteServicesLogsContext.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteServicesLogsContext"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/beamo/services/{serviceName}/logs/context  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteServicesLogsContext : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
