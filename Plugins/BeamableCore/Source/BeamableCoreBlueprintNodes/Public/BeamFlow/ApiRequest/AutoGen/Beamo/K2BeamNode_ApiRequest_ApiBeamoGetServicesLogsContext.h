...
#include "K2BeamNode_ApiRequest_ApiBeamoGetServicesLogsContext.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetServicesLogsContext"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/services/logs/context  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetServicesLogsContext : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
