...
#include "K2BeamNode_ApiRequest_GetRealms.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRealms"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/realms/{realmId}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRealms : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
