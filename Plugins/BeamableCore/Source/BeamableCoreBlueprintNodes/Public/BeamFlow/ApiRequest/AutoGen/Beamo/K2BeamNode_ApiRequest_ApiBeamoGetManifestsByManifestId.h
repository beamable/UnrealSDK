...
#include "K2BeamNode_ApiRequest_ApiBeamoGetManifestsByManifestId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetManifestsByManifestId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/manifests/{manifestId}  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetManifestsByManifestId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
