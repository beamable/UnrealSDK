...
#include "K2BeamNode_ApiRequest_ApiLobbyPutTagsById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiLobbyPutTagsById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/lobbies/{id}/tags  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyPutTagsById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
