...
#include "K2BeamNode_ApiRequest_GetInflightFailures.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetInflightFailures"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/admin/inflight/failures  of the Admin Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetInflightFailures : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
