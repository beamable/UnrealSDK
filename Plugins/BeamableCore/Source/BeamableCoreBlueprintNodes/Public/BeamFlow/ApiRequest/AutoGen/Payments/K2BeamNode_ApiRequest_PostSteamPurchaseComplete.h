...
#include "K2BeamNode_ApiRequest_PostSteamPurchaseComplete.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSteamPurchaseComplete"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/steam/purchase/complete  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSteamPurchaseComplete : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
