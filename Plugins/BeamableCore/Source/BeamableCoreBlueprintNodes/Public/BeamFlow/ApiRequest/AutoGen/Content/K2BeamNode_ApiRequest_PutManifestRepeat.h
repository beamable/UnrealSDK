...
#include "K2BeamNode_ApiRequest_PutManifestRepeat.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutManifestRepeat"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/content/manifest/repeat  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutManifestRepeat : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
