...
#include "K2BeamNode_ApiRequest_PostManifest.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
