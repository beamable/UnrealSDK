...
#include "K2BeamNode_ApiRequest_PutRefresh.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutRefresh"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/events/{objectId}/refresh  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutRefresh : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
