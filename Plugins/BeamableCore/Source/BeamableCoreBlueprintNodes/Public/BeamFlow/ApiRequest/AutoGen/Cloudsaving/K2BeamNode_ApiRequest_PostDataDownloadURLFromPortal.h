...
#include "K2BeamNode_ApiRequest_PostDataDownloadURLFromPortal.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostDataDownloadURLFromPortal"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/cloudsaving/data/downloadURLFromPortal  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostDataDownloadURLFromPortal : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
