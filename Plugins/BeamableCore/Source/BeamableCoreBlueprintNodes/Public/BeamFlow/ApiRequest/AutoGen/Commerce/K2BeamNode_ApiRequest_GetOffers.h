...
#include "K2BeamNode_ApiRequest_GetOffers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOffers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/commerce/{objectId}/offers  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOffers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
