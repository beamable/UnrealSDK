...
#include "K2BeamNode_ApiRequest_PostSearchExtended.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSearchExtended"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/stats/search/extended  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSearchExtended : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
