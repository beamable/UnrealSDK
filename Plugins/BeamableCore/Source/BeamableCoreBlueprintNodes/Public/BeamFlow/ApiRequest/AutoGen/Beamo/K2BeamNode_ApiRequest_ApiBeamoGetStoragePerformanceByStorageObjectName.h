...
#include "K2BeamNode_ApiRequest_ApiBeamoGetStoragePerformanceByStorageObjectName.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetStoragePerformanceByStorageObjectName"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/storage/{storageObjectName}/performance  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetStoragePerformanceByStorageObjectName : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
