...
#include "K2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/games  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiCustomerGetGamesByCustomerId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
