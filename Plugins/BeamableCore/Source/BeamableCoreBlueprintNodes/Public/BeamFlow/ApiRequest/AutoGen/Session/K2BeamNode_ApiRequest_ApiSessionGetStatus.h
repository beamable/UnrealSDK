...
#include "K2BeamNode_ApiRequest_ApiSessionGetStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiSessionGetStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/sessions/status  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiSessionGetStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
