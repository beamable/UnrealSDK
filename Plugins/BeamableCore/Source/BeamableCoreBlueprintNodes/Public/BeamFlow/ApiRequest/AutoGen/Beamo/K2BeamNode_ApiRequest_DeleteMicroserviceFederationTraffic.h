...
#include "K2BeamNode_ApiRequest_DeleteMicroserviceFederationTraffic.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteMicroserviceFederationTraffic"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/beamo/microservice/federation/traffic  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteMicroserviceFederationTraffic : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
