...
#include "K2BeamNode_ApiRequest_DeleteMeDevice.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteMeDevice"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/accounts/me/device  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteMeDevice : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
