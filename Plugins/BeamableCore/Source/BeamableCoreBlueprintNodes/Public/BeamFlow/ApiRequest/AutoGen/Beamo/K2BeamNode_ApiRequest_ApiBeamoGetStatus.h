...
#include "K2BeamNode_ApiRequest_ApiBeamoGetStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiBeamoGetStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/status  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiBeamoGetStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
