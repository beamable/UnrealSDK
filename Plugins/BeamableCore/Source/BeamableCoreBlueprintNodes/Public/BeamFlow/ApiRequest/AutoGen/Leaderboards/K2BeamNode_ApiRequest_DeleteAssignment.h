...
#include "K2BeamNode_ApiRequest_DeleteAssignment.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteAssignment"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/leaderboards/{objectId}/assignment  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteAssignment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
