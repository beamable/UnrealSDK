...
#include "K2BeamNode_ApiRequest_Authenticate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_Authenticate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/auth/token  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_Authenticate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
