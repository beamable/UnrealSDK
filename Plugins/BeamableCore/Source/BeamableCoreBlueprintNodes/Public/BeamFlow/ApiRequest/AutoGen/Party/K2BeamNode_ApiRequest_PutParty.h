...
#include "K2BeamNode_ApiRequest_PutParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/parties/{id}  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
