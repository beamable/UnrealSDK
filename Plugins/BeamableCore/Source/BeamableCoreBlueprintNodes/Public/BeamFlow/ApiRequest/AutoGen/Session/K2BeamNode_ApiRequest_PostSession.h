...
#include "K2BeamNode_ApiRequest_PostSession.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSession"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/session/  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSession : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
