...
#include "K2BeamNode_ApiRequest_DeleteBlocked.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteBlocked"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/social/blocked  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteBlocked : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
