...
#include "K2BeamNode_ApiRequest_PostStatsUpdate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostStatsUpdate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/commerce/{objectId}/stats/update  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostStatsUpdate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
