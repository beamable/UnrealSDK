...
#include "K2BeamNode_ApiRequest_PostCatalogLegacy.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCatalogLegacy"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/commerce/catalog/legacy  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCatalogLegacy : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
