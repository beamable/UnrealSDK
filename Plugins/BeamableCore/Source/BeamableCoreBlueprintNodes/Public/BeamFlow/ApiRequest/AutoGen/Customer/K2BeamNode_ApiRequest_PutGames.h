...
#include "K2BeamNode_ApiRequest_PutGames.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutGames"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/customers/{customerId}/games/{gameId}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutGames : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
