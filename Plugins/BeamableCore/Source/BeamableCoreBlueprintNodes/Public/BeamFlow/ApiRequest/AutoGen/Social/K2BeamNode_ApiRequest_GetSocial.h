...
#include "K2BeamNode_ApiRequest_GetSocial.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSocial"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/social/  of the Social Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSocial : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
