...
#include "K2BeamNode_ApiRequest_GetTemplate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetTemplate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/mail/template  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetTemplate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
