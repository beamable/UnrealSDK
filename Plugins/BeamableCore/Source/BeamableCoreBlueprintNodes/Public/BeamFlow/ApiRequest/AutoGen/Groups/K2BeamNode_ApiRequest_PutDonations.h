...
#include "K2BeamNode_ApiRequest_PutDonations.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutDonations"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/groups/{objectId}/donations  of the Groups Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutDonations : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
