...
#include "K2BeamNode_ApiRequest_PutMicroserviceFederationTraffic.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutMicroserviceFederationTraffic"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/beamo/microservice/federation/traffic  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutMicroserviceFederationTraffic : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
