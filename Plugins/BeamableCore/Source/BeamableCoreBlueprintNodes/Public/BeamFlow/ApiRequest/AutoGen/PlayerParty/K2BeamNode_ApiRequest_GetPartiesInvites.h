...
#include "K2BeamNode_ApiRequest_GetPartiesInvites.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPartiesInvites"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/parties/invites  of the PlayerParty Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPartiesInvites : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
