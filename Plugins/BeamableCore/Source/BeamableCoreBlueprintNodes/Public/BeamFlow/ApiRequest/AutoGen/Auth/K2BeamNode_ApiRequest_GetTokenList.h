...
#include "K2BeamNode_ApiRequest_GetTokenList.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetTokenList"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/auth/token/list  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetTokenList : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
