...
#include "K2BeamNode_ApiRequest_GetUid.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetUid"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/leaderboards/uid  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetUid : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
