...
#include "K2BeamNode_ApiRequest_ApiLobbyPostServerById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiLobbyPostServerById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/lobbies/{id}/server  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyPostServerById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
