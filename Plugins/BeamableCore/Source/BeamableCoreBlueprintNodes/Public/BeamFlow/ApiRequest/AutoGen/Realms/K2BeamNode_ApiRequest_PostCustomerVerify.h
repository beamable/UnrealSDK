...
#include "K2BeamNode_ApiRequest_PostCustomerVerify.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCustomerVerify"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/realms/customer/verify  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCustomerVerify : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
