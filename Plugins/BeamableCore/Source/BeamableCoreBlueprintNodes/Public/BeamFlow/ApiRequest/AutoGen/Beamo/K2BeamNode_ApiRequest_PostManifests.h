...
#include "K2BeamNode_ApiRequest_PostManifests.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifests"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/manifests  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifests : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
