...
#include "K2BeamNode_ApiRequest_GetPlayer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPlayer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/leaderboards/player  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPlayer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
