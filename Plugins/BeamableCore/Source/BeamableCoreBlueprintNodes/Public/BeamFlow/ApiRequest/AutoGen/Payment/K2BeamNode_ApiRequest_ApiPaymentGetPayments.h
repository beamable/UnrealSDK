...
#include "K2BeamNode_ApiRequest_ApiPaymentGetPayments.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiPaymentGetPayments"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/payments  of the Payment Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPaymentGetPayments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
