...
#include "K2BeamNode_ApiRequest_GetLobby.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetLobby"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/lobbies/{id}  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetLobby : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
