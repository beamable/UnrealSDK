...
#include "K2BeamNode_ApiRequest_BasicFriendsGetFriends.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicFriendsGetFriends"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/social/  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicFriendsGetFriends : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
