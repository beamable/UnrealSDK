...
#include "K2BeamNode_ApiRequest_PostManifestsPromote.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestsPromote"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/manifests/promote  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestsPromote : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
