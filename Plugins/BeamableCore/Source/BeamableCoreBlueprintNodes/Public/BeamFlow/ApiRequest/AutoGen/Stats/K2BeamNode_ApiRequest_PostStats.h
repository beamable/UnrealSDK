...
#include "K2BeamNode_ApiRequest_PostStats.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostStats"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/stats/{objectId}/  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostStats : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
