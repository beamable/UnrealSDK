...
#include "K2BeamNode_ApiRequest_PostLogsUrl.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostLogsUrl"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/logsUrl  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostLogsUrl : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
