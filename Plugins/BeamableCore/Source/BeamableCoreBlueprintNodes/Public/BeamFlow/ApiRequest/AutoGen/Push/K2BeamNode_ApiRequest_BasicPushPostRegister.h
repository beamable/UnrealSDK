...
#include "K2BeamNode_ApiRequest_BasicPushPostRegister.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicPushPostRegister"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/push/register  of the Push Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicPushPostRegister : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
