...
#include "K2BeamNode_ApiRequest_GetConfig.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
