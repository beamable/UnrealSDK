...
#include "K2BeamNode_ApiRequest_PutListingsCooldown.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutListingsCooldown"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/commerce/{objectId}/listings/cooldown  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutListingsCooldown : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
