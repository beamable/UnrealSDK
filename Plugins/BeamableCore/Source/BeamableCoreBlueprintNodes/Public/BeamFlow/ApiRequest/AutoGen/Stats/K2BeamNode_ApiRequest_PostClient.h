...
#include "K2BeamNode_ApiRequest_PostClient.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostClient"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/stats/{objectId}/client  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostClient : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
