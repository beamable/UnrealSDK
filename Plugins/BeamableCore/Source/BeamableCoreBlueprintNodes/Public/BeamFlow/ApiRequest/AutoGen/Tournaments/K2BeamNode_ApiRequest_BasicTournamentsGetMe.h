...
#include "K2BeamNode_ApiRequest_BasicTournamentsGetMe.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicTournamentsGetMe"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/tournaments/me  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicTournamentsGetMe : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
