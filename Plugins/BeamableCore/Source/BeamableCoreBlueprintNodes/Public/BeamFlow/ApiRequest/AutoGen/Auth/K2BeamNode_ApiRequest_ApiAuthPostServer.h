...
#include "K2BeamNode_ApiRequest_ApiAuthPostServer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiAuthPostServer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/server  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiAuthPostServer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
