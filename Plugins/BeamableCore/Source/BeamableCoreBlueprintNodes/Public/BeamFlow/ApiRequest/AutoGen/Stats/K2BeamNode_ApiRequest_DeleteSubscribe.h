...
#include "K2BeamNode_ApiRequest_DeleteSubscribe.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteSubscribe"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/stats/subscribe  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteSubscribe : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
