...
#include "K2BeamNode_ApiRequest_ObjectLeaderboardsGetFriendsByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectLeaderboardsGetFriendsByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/leaderboards/{objectId}/friends  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectLeaderboardsGetFriendsByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
