...
#include "K2BeamNode_ApiRequest_ObjectMailPostSearchByObjectId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ObjectMailPostSearchByObjectId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/mail/{objectId}/search  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailPostSearchByObjectId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
