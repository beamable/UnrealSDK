...
#include "K2BeamNode_ApiRequest_PostRewards.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostRewards"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/tournaments/rewards  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostRewards : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
