...
#include "K2BeamNode_ApiRequest_PostManifestsUnarchive.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostManifestsUnarchive"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/manifests/unarchive  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestsUnarchive : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
