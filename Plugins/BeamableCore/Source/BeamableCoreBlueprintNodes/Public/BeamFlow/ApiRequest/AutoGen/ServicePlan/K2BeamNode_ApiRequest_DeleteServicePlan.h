...
#include "K2BeamNode_ApiRequest_DeleteServicePlan.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteServicePlan"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/service-plans/{name}  of the ServicePlan Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteServicePlan : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
