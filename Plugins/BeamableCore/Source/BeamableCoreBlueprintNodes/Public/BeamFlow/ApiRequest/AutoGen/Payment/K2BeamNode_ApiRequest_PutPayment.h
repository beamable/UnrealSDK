...
#include "K2BeamNode_ApiRequest_PutPayment.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutPayment"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/payments/{transactionId}  of the Payment Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutPayment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
