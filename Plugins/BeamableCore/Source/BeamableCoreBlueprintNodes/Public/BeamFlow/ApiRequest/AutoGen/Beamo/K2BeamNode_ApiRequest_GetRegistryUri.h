...
#include "K2BeamNode_ApiRequest_GetRegistryUri.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRegistryUri"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/registry-uri  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRegistryUri : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
