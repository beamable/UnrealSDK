...
#include "K2BeamNode_ApiRequest_GetManifestPrivate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestPrivate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest/private  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestPrivate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
