...
#include "K2BeamNode_ApiRequest_ApiCustomerGetCustomerByCustomerId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiCustomerGetCustomerByCustomerId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiCustomerGetCustomerByCustomerId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
