...
#include "K2BeamNode_ApiRequest_PostCouponPurchaseCancel.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCouponPurchaseCancel"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/coupon/purchase/cancel  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCouponPurchaseCancel : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
