...
#include "K2BeamNode_ApiRequest_PostScore.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostScore"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/tournaments/score  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostScore : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
