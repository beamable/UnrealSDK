...
#include "K2BeamNode_ApiRequest_PostParties.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostParties"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/parties  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostParties : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
