...
#include "K2BeamNode_ApiRequest_GetItunesProduct.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetItunesProduct"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/itunes/product  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetItunesProduct : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
