...
#include "K2BeamNode_ApiRequest_GetHistory.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetHistory"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/session/history  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetHistory : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
