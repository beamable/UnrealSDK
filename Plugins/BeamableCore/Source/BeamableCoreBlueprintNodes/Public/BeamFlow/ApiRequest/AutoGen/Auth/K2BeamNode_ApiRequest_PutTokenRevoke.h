...
#include "K2BeamNode_ApiRequest_PutTokenRevoke.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutTokenRevoke"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/auth/token/revoke  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutTokenRevoke : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
