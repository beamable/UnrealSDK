...
#include "K2BeamNode_ApiRequest_PostQuery.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostQuery"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/presence/query  of the Presence Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostQuery : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
