...
#include "K2BeamNode_ApiRequest_PutSwap.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutSwap"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/leaderboards/{objectId}/swap  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutSwap : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
