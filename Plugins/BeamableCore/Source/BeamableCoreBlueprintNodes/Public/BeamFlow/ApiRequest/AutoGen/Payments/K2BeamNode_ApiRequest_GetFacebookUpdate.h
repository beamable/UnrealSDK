...
#include "K2BeamNode_ApiRequest_GetFacebookUpdate.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetFacebookUpdate"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/facebook/update  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetFacebookUpdate : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
