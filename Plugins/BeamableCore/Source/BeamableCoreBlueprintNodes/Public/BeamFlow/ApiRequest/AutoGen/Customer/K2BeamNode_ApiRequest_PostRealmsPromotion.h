...
#include "K2BeamNode_ApiRequest_PostRealmsPromotion.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostRealmsPromotion"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/customers/{customerId}/realms/{destinationRealmId}/promotion  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostRealmsPromotion : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
