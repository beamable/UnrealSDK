...
#include "K2BeamNode_ApiRequest_GetMicroserviceSecret.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMicroserviceSecret"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/microservice/secret  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMicroserviceSecret : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
