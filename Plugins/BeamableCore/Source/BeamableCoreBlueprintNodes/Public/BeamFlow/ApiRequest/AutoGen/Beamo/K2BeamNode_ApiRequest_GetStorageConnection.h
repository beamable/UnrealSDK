...
#include "K2BeamNode_ApiRequest_GetStorageConnection.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetStorageConnection : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
