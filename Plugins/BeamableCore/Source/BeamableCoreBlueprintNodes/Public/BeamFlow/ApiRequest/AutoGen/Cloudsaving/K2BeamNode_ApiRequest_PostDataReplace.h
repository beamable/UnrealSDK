...
#include "K2BeamNode_ApiRequest_PostDataReplace.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostDataReplace"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/cloudsaving/data/replace  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostDataReplace : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
