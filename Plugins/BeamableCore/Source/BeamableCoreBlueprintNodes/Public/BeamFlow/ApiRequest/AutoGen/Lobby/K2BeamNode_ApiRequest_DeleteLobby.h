...
#include "K2BeamNode_ApiRequest_DeleteLobby.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteLobby"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/lobbies/{id}  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteLobby : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
