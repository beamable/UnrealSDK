...
#include "K2BeamNode_ApiRequest_ApiPlayerLobbyGetLobbiesByPlayerId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiPlayerLobbyGetLobbiesByPlayerId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/lobbies  of the PlayerLobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPlayerLobbyGetLobbiesByPlayerId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
