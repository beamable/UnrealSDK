...
#include "K2BeamNode_ApiRequest_BasicAnnouncementsDeleteAnnouncements.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicAnnouncementsDeleteAnnouncements"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/announcements/  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicAnnouncementsDeleteAnnouncements : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
