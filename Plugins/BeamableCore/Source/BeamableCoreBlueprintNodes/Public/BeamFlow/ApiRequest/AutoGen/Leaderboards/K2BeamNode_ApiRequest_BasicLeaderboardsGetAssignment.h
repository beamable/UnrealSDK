...
#include "K2BeamNode_ApiRequest_BasicLeaderboardsGetAssignment.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicLeaderboardsGetAssignment"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/leaderboards/assignment  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicLeaderboardsGetAssignment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
