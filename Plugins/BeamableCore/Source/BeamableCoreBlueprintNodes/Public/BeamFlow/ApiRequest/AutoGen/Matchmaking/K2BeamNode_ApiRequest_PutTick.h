...
#include "K2BeamNode_ApiRequest_PutTick.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutTick"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/matchmaking/{objectId}/tick  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutTick : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
