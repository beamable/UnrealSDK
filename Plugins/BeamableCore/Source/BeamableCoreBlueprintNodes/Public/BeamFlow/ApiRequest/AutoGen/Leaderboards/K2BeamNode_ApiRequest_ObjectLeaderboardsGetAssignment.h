...
#include "K2BeamNode_ApiRequest_ObjectLeaderboardsGetAssignment.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectLeaderboardsGetAssignment : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
