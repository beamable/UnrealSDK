...
#include "K2BeamNode_ApiRequest_BasicBeamoPostManifestPull.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoPostManifestPull"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/manifest/pull  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoPostManifestPull : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
