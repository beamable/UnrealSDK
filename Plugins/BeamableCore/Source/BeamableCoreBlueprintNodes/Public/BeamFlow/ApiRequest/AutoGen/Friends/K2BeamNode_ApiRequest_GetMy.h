...
#include "K2BeamNode_ApiRequest_GetMy.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMy"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/social/my  of the Friends Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMy : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
