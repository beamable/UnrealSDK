...
#include "K2BeamNode_ApiRequest_PostCoupons.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostCoupons"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/commerce/{objectId}/coupons  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostCoupons : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
