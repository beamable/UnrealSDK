...
#include "K2BeamNode_ApiRequest_BasicNotificationPostServer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicNotificationPostServer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/notification/server  of the Notification Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicNotificationPostServer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
