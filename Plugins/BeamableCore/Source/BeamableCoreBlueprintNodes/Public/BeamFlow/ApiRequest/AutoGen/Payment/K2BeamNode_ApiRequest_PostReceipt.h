...
#include "K2BeamNode_ApiRequest_PostReceipt.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostReceipt"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/payments/receipt  of the Payment Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostReceipt : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
