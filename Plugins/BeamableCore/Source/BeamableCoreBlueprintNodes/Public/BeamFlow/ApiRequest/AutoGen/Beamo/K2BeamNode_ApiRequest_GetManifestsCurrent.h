...
#include "K2BeamNode_ApiRequest_GetManifestsCurrent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestsCurrent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/manifests/current  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestsCurrent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
