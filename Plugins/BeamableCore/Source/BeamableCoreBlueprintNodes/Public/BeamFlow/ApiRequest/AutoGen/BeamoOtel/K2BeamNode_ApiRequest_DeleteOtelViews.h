...
#include "K2BeamNode_ApiRequest_DeleteOtelViews.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteOtelViews"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/beamo/otel/views/{viewId}  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteOtelViews : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
