...
#include "K2BeamNode_ApiRequest_PostApplyContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostApplyContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/events/applyContent  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostApplyContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
