...
#include "K2BeamNode_ApiRequest_ObjectMailPostBulk.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailPostBulk : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
