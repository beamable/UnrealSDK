...
#include "K2BeamNode_ApiRequest_PutRealms.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutRealms"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/customers/{customerId}/realms/{realmId}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutRealms : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
