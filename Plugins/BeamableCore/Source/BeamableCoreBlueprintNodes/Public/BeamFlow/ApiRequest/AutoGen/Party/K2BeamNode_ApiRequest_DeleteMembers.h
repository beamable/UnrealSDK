...
#include "K2BeamNode_ApiRequest_DeleteMembers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteMembers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/parties/{id}/members  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteMembers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
