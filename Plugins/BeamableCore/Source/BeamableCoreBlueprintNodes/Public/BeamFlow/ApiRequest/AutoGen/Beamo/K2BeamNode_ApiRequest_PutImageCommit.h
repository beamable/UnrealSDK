...
#include "K2BeamNode_ApiRequest_PutImageCommit.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutImageCommit"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/beamo/image/commit  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutImageCommit : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
