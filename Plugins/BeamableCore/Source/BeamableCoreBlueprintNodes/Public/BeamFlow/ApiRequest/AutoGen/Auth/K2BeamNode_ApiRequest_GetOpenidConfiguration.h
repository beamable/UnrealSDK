...
#include "K2BeamNode_ApiRequest_GetOpenidConfiguration.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOpenidConfiguration"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/.well-known/openid-configuration  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOpenidConfiguration : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
