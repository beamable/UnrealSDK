...
#include "K2BeamNode_ApiRequest_PostServicePlans.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostServicePlans"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/service-plans  of the ServicePlan Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostServicePlans : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
