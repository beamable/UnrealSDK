...
#include "K2BeamNode_ApiRequest_ObjectAccountsPutRole.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectAccountsPutRole : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
