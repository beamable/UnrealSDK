...
#include "K2BeamNode_ApiRequest_PostServicesMetricsRequest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostServicesMetricsRequest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/beamo/services/{serviceName}/metrics-request  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostServicesMetricsRequest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
