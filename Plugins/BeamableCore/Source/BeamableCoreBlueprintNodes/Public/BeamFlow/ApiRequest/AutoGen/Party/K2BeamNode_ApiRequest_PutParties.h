...
#include "K2BeamNode_ApiRequest_PutParties.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutParties"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/parties  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutParties : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
