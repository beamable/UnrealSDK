...
#include "K2BeamNode_ApiRequest_GetRegistry.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRegistry"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/registry  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRegistry : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
