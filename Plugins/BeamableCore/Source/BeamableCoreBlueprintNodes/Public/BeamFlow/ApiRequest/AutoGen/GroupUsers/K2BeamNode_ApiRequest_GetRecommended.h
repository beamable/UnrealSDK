...
#include "K2BeamNode_ApiRequest_GetRecommended.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRecommended"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/group-users/{objectId}/recommended  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRecommended : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
