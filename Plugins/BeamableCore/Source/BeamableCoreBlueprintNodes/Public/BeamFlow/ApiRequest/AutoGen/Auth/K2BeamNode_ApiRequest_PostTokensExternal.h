...
#include "K2BeamNode_ApiRequest_PostTokensExternal.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTokensExternal"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/tokens/external  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTokensExternal : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
