...
#include "K2BeamNode_ApiRequest_ObjectMailGetMail.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailGetMail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
