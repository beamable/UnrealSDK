...
#include "K2BeamNode_ApiRequest_DeleteAdminScope.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteAdminScope"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/accounts/{objectId}/admin/scope  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteAdminScope : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
