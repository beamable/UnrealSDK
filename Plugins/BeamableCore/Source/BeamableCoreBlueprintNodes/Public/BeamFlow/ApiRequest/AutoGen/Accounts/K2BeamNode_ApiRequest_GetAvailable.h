...
#include "K2BeamNode_ApiRequest_GetAvailable.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailable"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/available  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailable : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
