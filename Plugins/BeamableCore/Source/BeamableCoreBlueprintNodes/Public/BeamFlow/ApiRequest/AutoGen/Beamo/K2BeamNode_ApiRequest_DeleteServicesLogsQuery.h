...
#include "K2BeamNode_ApiRequest_DeleteServicesLogsQuery.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteServicesLogsQuery"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/beamo/services/logs/query/{queryId}  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteServicesLogsQuery : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
