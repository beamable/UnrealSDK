...
#include "K2BeamNode_ApiRequest_DeleteAdminInflightFailures.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteAdminInflightFailures"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /basic/realms/admin/inflight/failures  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteAdminInflightFailures : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
