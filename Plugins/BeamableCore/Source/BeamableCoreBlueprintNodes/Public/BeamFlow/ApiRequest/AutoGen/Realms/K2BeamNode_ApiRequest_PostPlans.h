...
#include "K2BeamNode_ApiRequest_PostPlans.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPlans"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/realms/plans  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPlans : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
