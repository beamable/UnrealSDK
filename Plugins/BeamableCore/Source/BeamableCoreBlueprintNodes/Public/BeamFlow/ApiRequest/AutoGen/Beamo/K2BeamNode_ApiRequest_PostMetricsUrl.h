...
#include "K2BeamNode_ApiRequest_PostMetricsUrl.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostMetricsUrl"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/beamo/metricsUrl  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostMetricsUrl : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
