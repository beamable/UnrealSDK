...
#include "K2BeamNode_ApiRequest_BasicSessionPostHeartbeat.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicSessionPostHeartbeat"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/session/heartbeat  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicSessionPostHeartbeat : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
