...
#include "K2BeamNode_ApiRequest_PostSessions.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostSessions"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/sessions  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostSessions : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
