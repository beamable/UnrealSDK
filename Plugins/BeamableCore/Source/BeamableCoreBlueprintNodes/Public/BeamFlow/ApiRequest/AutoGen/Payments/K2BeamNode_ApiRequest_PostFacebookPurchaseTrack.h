...
#include "K2BeamNode_ApiRequest_PostFacebookPurchaseTrack.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostFacebookPurchaseTrack"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/facebook/purchase/track  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostFacebookPurchaseTrack : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
