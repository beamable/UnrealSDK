...
#include "K2BeamNode_ApiRequest_ObjectLeaderboardsGetMatches.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectLeaderboardsGetMatches : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
