...
#include "K2BeamNode_ApiRequest_PostTestPurchaseFail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTestPurchaseFail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/test/purchase/fail  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTestPurchaseFail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
