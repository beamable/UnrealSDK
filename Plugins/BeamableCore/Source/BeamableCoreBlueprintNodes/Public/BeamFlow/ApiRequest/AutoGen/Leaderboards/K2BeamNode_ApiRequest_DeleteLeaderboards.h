...
#include "K2BeamNode_ApiRequest_DeleteLeaderboards.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteLeaderboards"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/leaderboards/{objectId}/  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteLeaderboards : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
