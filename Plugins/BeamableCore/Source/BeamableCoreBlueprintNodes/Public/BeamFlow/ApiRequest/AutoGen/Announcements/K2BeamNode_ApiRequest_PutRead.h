...
#include "K2BeamNode_ApiRequest_PutRead.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutRead"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/announcements/{objectId}/read  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutRead : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
