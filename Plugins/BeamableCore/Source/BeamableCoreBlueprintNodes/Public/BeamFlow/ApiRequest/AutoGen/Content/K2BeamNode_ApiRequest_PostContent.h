...
#include "K2BeamNode_ApiRequest_PostContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
