...
#include "K2BeamNode_ApiRequest_GetAvailableDeviceId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailableDeviceId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/available/device-id  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailableDeviceId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
