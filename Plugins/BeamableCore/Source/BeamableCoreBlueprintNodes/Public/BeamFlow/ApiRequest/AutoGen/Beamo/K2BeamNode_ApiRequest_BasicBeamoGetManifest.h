...
#include "K2BeamNode_ApiRequest_BasicBeamoGetManifest.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetManifest"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/manifest  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetManifest : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
