...
#include "K2BeamNode_ApiRequest_GetAliases.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAliases"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/aliases/{alias}  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAliases : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
