...
#include "K2BeamNode_ApiRequest_BasicAnnouncementsGetSearch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicAnnouncementsGetSearch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/announcements/search  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicAnnouncementsGetSearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
