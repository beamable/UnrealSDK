...
#include "K2BeamNode_ApiRequest_GetAdminPlayer.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminPlayer"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/tournaments/admin/player  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminPlayer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
