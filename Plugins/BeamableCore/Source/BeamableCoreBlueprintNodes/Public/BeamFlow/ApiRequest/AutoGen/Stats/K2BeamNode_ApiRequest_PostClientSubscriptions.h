...
#include "K2BeamNode_ApiRequest_PostClientSubscriptions.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostClientSubscriptions"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/stats/{objectId}/client/subscriptions  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostClientSubscriptions : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
