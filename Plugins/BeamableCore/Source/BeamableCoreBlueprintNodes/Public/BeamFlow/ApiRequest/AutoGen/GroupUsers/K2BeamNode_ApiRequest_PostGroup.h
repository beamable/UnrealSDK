...
#include "K2BeamNode_ApiRequest_PostGroup.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostGroup"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/group-users/{objectId}/group  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostGroup : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
