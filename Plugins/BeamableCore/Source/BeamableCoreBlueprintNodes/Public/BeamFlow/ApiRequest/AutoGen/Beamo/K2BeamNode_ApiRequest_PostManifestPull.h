...
#include "K2BeamNode_ApiRequest_PostManifestPull.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostManifestPull : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
