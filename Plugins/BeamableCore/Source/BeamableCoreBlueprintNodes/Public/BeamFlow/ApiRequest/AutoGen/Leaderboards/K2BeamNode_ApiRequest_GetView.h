...
#include "K2BeamNode_ApiRequest_GetView.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetView"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/leaderboards/{objectId}/view  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetView : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
