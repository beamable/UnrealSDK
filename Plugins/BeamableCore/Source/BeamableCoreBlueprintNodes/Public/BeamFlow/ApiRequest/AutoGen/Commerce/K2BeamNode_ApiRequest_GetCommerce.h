...
#include "K2BeamNode_ApiRequest_GetCommerce.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCommerce"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/commerce/{objectId}/  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCommerce : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
