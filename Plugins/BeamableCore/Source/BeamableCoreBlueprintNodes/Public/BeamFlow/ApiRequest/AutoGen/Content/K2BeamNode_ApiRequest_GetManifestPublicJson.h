...
#include "K2BeamNode_ApiRequest_GetManifestPublicJson.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestPublicJson"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/content/manifest/public/json  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestPublicJson : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
