...
#include "K2BeamNode_ApiRequest_GetRealmsPromotion.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRealmsPromotion"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/customers/{customerId}/realms/{destinationRealmId}/promotion  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRealmsPromotion : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
