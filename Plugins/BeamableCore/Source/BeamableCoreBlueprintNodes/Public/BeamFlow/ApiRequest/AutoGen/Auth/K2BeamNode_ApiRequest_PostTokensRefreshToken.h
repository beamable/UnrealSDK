...
#include "K2BeamNode_ApiRequest_PostTokensRefreshToken.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTokensRefreshToken"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/tokens/refresh-token  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTokensRefreshToken : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
