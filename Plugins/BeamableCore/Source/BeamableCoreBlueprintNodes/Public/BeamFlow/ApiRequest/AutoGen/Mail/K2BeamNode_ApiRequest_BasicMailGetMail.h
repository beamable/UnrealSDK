...
#include "K2BeamNode_ApiRequest_BasicMailGetMail.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicMailGetMail"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/mail/  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicMailGetMail : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
