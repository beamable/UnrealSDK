...
#include "K2BeamNode_ApiRequest_GetEventPlayers.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetEventPlayers"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/event-players/{objectId}/  of the EventPlayers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetEventPlayers : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
