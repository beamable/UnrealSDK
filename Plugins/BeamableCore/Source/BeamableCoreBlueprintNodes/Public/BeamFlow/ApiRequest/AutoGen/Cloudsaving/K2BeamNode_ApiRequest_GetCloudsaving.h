...
#include "K2BeamNode_ApiRequest_GetCloudsaving.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCloudsaving"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/cloudsaving/  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCloudsaving : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
