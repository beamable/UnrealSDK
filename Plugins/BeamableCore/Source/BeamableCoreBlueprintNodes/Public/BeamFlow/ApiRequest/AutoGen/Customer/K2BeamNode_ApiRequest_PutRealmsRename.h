...
#include "K2BeamNode_ApiRequest_PutRealmsRename.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutRealmsRename"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/customers/{customerId}/realms/{realmId}/rename  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutRealmsRename : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
