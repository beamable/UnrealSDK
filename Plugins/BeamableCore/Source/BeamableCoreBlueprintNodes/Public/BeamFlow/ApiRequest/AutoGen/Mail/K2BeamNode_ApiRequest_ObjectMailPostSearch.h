...
#include "K2BeamNode_ApiRequest_ObjectMailPostSearch.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectMailPostSearch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
