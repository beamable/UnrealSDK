...
#include "K2BeamNode_ApiRequest_PutLobbies.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutLobbies"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/lobbies  of the Lobby Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutLobbies : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
