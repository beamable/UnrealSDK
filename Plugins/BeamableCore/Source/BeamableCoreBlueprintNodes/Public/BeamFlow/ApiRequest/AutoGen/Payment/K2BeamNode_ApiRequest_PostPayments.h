...
#include "K2BeamNode_ApiRequest_PostPayments.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostPayments"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/payments  of the Payment Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostPayments : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
