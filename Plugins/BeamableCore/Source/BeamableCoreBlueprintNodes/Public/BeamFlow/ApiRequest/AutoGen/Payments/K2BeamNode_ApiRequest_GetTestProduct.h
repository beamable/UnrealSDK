...
#include "K2BeamNode_ApiRequest_GetTestProduct.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetTestProduct"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/test/product  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetTestProduct : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
