...
#include "K2BeamNode_ApiRequest_PostHeartbeat.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostHeartbeat : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
