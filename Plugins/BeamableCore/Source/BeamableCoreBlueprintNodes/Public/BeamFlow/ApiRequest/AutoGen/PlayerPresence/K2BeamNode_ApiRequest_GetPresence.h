...
#include "K2BeamNode_ApiRequest_GetPresence.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetPresence"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/presence  of the PlayerPresence Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetPresence : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
