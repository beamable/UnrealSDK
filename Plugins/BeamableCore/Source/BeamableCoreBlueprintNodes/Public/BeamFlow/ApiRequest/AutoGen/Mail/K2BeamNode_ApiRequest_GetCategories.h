...
#include "K2BeamNode_ApiRequest_GetCategories.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetCategories"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/mail/{objectId}/categories  of the Mail Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetCategories : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
