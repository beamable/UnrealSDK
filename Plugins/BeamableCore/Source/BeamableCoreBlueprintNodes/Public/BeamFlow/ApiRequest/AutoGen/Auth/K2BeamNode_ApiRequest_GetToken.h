...
#include "K2BeamNode_ApiRequest_GetToken.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetToken"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/auth/token  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetToken : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
