...
#include "K2BeamNode_ApiRequest_GetEvents.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetEvents"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/events/{objectId}/  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetEvents : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
