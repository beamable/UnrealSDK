...
#include "K2BeamNode_ApiRequest_ApiMatchmakingGetMatchesById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiMatchmakingGetMatchesById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/matchmaking/matches/{id}  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiMatchmakingGetMatchesById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
