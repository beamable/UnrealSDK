...
#include "K2BeamNode_ApiRequest_GetSessionsClient.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSessionsClient"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/players/{playerId}/sessions/client  of the PlayerSession Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSessionsClient : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
