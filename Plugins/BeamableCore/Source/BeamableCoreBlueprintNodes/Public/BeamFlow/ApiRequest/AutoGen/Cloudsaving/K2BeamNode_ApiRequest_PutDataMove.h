...
#include "K2BeamNode_ApiRequest_PutDataMove.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutDataMove"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/cloudsaving/data/move  of the Cloudsaving Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutDataMove : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
