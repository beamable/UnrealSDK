...
#include "K2BeamNode_ApiRequest_GetStandingsGroup.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetStandingsGroup"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/tournaments/standings/group  of the Tournaments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetStandingsGroup : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
