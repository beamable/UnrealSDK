...
#include "K2BeamNode_ApiRequest_GetOtelViews.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetOtelViews"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/beamo/otel/views  of the BeamoOtel Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetOtelViews : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
