...
#include "K2BeamNode_ApiRequest_ObjectEventPlayersPostClaim.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectEventPlayersPostClaim : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
