...
#include "K2BeamNode_ApiRequest_DeleteTickets.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteTickets"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /api/matchmaking/tickets/{id}  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteTickets : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
