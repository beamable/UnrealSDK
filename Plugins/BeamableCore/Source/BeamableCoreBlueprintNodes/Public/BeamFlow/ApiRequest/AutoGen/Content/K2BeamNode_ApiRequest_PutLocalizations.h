...
#include "K2BeamNode_ApiRequest_PutLocalizations.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutLocalizations"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/content/localizations  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutLocalizations : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
