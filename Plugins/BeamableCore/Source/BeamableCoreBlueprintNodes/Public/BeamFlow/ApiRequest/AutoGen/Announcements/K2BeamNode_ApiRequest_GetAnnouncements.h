...
#include "K2BeamNode_ApiRequest_GetAnnouncements.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAnnouncements"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/announcements/{objectId}/  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAnnouncements : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
