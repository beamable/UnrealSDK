...
#include "K2BeamNode_ApiRequest_GetMatch.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetMatch"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /object/matchmaking/{objectId}/match  of the Matchmaking Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetMatch : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
