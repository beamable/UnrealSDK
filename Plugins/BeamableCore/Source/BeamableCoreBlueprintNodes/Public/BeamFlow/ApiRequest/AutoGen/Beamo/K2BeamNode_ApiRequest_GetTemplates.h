...
#include "K2BeamNode_ApiRequest_GetTemplates.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetTemplates : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
