...
#include "K2BeamNode_ApiRequest_PostWindowsPurchaseTrack.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostWindowsPurchaseTrack"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/payments/windows/purchase/track  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostWindowsPurchaseTrack : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
