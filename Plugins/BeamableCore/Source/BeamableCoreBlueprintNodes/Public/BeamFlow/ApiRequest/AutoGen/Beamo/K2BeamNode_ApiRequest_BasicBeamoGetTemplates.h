...
#include "K2BeamNode_ApiRequest_BasicBeamoGetTemplates.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetTemplates"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/templates  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetTemplates : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
