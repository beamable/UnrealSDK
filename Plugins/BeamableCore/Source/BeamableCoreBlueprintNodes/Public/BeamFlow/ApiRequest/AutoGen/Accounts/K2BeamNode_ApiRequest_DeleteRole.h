...
#include "K2BeamNode_ApiRequest_DeleteRole.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteRole"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/accounts/{objectId}/role  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteRole : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
