...
#include "K2BeamNode_ApiRequest_ApiPartyPutMetadataById.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiPartyPutMetadataById"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /api/parties/{id}/metadata  of the Party Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiPartyPutMetadataById : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
