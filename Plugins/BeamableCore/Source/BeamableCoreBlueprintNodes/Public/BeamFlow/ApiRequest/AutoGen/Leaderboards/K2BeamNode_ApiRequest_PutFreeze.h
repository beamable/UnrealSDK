...
#include "K2BeamNode_ApiRequest_PutFreeze.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutFreeze"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /object/leaderboards/{objectId}/freeze  of the Leaderboards Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutFreeze : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
