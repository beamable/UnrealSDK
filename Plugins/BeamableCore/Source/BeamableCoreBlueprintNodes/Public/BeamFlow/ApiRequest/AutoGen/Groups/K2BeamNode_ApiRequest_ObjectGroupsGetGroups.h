...
#include "K2BeamNode_ApiRequest_ObjectGroupsGetGroups.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupsGetGroups : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
