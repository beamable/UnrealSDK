...
#include "K2BeamNode_ApiRequest_GetManifestCurrent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetManifestCurrent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/manifest/current  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetManifestCurrent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
