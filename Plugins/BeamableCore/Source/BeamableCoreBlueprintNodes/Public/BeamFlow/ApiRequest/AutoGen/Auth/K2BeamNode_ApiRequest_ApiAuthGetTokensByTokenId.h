...
#include "K2BeamNode_ApiRequest_ApiAuthGetTokensByTokenId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_ApiAuthGetTokensByTokenId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /api/auth/tokens/{tokenId}  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiAuthGetTokensByTokenId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
