...
#include "K2BeamNode_ApiRequest_DeleteContent.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteContent"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/events/{objectId}/content  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteContent : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
