...
#include "K2BeamNode_ApiRequest_PostText.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostText"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/content/text  of the Content Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostText : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
