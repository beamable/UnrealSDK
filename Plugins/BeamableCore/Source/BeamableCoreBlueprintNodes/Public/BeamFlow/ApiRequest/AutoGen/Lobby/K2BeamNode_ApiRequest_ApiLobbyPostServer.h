...
#include "K2BeamNode_ApiRequest_ApiLobbyPostServer.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ApiLobbyPostServer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
