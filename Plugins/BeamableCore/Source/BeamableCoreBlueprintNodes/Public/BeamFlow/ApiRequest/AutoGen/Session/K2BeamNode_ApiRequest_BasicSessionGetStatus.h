...
#include "K2BeamNode_ApiRequest_BasicSessionGetStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicSessionGetStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/session/status  of the Session Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicSessionGetStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
