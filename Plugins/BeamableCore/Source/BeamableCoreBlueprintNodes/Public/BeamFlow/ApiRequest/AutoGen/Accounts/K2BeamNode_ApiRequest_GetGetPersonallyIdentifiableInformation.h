...
#include "K2BeamNode_ApiRequest_GetGetPersonallyIdentifiableInformation.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetGetPersonallyIdentifiableInformation"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/get-personally-identifiable-information  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetGetPersonallyIdentifiableInformation : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
