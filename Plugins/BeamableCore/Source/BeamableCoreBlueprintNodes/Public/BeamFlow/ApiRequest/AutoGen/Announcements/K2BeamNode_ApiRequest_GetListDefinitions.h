...
#include "K2BeamNode_ApiRequest_GetListDefinitions.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetListDefinitions"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/announcements/list/definitions  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetListDefinitions : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
