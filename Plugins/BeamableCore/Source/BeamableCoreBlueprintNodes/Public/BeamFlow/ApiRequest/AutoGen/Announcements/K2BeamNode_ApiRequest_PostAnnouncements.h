...
#include "K2BeamNode_ApiRequest_PostAnnouncements.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostAnnouncements"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /basic/announcements/  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostAnnouncements : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
