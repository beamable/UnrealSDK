...
#include "K2BeamNode_ApiRequest_BasicBeamoGetManifests.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_BasicBeamoGetManifests"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/beamo/manifests  of the Beamo Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_BasicBeamoGetManifests : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
