...
#include "K2BeamNode_ApiRequest_DeleteStatus.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_DeleteStatus"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Delete /object/commerce/{objectId}/status  of the Commerce Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_DeleteStatus : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
