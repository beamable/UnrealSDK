...
#include "K2BeamNode_ApiRequest_PostServer.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostServer : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
