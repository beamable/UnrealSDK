...
#include "K2BeamNode_ApiRequest_PutConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PutConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Put /basic/realms/config  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PutConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
