...
#include "K2BeamNode_ApiRequest_GetListTags.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetListTags"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/announcements/list/tags  of the Announcements Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetListTags : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
