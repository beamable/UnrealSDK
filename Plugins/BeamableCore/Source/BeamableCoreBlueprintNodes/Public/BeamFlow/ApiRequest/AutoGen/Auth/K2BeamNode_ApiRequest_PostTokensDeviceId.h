...
#include "K2BeamNode_ApiRequest_PostTokensDeviceId.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostTokensDeviceId"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /api/auth/tokens/device-id  of the Auth Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostTokensDeviceId : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
