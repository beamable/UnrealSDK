...
#include "K2BeamNode_ApiRequest_GetSteamPrices.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetSteamPrices"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/payments/steam/prices  of the Payments Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetSteamPrices : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
