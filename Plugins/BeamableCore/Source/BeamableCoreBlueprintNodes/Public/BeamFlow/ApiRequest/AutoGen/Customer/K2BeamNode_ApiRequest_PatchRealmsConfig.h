...
#include "K2BeamNode_ApiRequest_PatchRealmsConfig.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PatchRealmsConfig"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Patch /api/customers/{customerId}/realms/{realmId}/config  of the Customer Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PatchRealmsConfig : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
