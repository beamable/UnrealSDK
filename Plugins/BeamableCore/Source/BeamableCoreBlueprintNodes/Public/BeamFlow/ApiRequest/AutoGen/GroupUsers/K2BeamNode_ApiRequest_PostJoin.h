...
#include "K2BeamNode_ApiRequest_PostJoin.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostJoin"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/group-users/{objectId}/join  of the GroupUsers Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostJoin : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
