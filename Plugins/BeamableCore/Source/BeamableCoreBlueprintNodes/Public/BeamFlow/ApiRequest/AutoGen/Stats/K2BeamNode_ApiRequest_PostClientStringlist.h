...
#include "K2BeamNode_ApiRequest_PostClientStringlist.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_PostClientStringlist"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /object/stats/{objectId}/client/stringlist  of the Stats Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_PostClientStringlist : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
