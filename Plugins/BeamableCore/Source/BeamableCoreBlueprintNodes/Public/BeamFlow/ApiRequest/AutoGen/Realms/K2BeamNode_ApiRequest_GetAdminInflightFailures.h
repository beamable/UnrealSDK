...
#include "K2BeamNode_ApiRequest_GetAdminInflightFailures.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAdminInflightFailures"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/realms/admin/inflight/failures  of the Realms Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAdminInflightFailures : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
