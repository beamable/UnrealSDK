...
#include "K2BeamNode_ApiRequest_ObjectGroupsPostInvite.generated.h"
...
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_ObjectGroupsPostInvite : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
