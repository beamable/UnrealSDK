...
#include "K2BeamNode_ApiRequest_GetAvailableThirdParty.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetAvailableThirdParty"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/accounts/available/third-party  of the Accounts Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetAvailableThirdParty : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
