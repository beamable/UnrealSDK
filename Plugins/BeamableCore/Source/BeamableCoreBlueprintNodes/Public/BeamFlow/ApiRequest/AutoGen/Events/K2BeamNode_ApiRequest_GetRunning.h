...
#include "K2BeamNode_ApiRequest_GetRunning.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_GetRunning"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Get /basic/events/running  of the Events Service. 
*/
UCLASS(meta=(BeamFlow))
class BEAMABLECOREBLUEPRINTNODES_API UK2BeamNode_ApiRequest_GetRunning : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
