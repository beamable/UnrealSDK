...
class UK2BeamNode_Operation_FrictionlessAuth : public UK2BeamNode_Operation
{
	...
	virtual FName GetRuntimeSubsystemSelfFunctionName() const override { return GET_FUNCTION_NAME_CHECKED(UBeamRuntime, GetSelf); }
...
#define DECLARE_OPERATION_K2_NODE(OperationName, OperationSubSystem)
