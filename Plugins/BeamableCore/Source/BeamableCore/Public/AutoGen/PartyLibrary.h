...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Party|4 - Json", DisplayName="Party To JSON String")
	static FString PartyToJsonString(const UParty* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Party|3 - Backend", DisplayName="Make Party", meta=(DefaultToSelf="Outer", AdvancedDisplay="Id, Restriction, Leader, MaxSize, Members, PendingInvites, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Party|3 - Backend", DisplayName="Break Party", meta=(NativeBreakFunc))
