...
#include "RealmsBasicNewCustomerRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API URealmsBasicNewCustomerRequestBody : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
