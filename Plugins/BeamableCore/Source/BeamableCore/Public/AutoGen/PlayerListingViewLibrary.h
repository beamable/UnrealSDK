...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="PlayerListingView To JSON String")
	static FString PlayerListingViewToJsonString(const UPlayerListingView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make PlayerListingView", meta=(DefaultToSelf="Outer", AdvancedDisplay="Cooldown, PurchasesRemain, SecondsRemain, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break PlayerListingView", meta=(NativeBreakFunc))
