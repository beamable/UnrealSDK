...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Listing To JSON String")
	static FString ListingToJsonString(const UListing* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Listing", meta=(DefaultToSelf="Outer", AdvancedDisplay="PurchaseLimit, ScheduleInstancePurchaseLimit, Schedule, ActiveDurationCoolDownSeconds, ActiveDurationSeconds, ActiveDurationPurchaseLimit, ActivePeriod, ButtonText, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Listing", meta=(NativeBreakFunc))
