...
#include "GroupUsersObjectInFlightMessage.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UGroupUsersObjectInFlightMessage : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
