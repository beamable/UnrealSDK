...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|4 - Json", DisplayName="EntitlementRequirement To JSON String")
	static FString EntitlementRequirementToJsonString(const UEntitlementRequirement* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Make EntitlementRequirement", meta=(DefaultToSelf="Outer", AdvancedDisplay="Specialization, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Break EntitlementRequirement", meta=(NativeBreakFunc))
