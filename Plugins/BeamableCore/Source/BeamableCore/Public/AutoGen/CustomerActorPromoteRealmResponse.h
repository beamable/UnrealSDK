...
#include "CustomerActorPromoteRealmResponse.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UCustomerActorPromoteRealmResponse : public UObject, public IBeamJsonSerializableUObject, public IBeamBaseResponseBodyInterface
{
	GENERATED_BODY()
...
public:
	...
	FOptionalArrayOfPromotionScope Scopes = {};
