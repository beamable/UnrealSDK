...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Groups|4 - Json", DisplayName="RoleChangeRequestBody To JSON String")
	static FString RoleChangeRequestBodyToJsonString(const URoleChangeRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Groups|3 - Backend", DisplayName="Make RoleChangeRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="SubGroup, Outer", NativeMakeFunc))
	static URoleChangeRequestBody* Make(int64 GamerTag, FString Role, FOptionalInt64 SubGroup, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Groups|3 - Backend", DisplayName="Break RoleChangeRequestBody", meta=(NativeBreakFunc))
