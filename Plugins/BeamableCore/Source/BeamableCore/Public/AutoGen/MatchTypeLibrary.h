...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|4 - Json", DisplayName="MatchType To JSON String")
	static FString MatchTypeToJsonString(const UMatchType* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Make MatchType", meta=(DefaultToSelf="Outer", AdvancedDisplay="Id, WaitAfterMinReachedSecs, MaxWaitDurationSecs, MatchingIntervalSecs, FederatedGameServerNamespace, Teams, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Break MatchType", meta=(NativeBreakFunc))
