...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="GetTemplatesResponse To JSON String")
	static FString GetTemplatesResponseToJsonString(const UGetTemplatesResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make GetTemplatesResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UGetTemplatesResponse* Make(TArray<UServiceTemplate*> Templates, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break GetTemplatesResponse", meta=(NativeBreakFunc))
