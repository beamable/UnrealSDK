...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="ContentDefinition To JSON String")
	static FString ContentDefinitionToJsonString(const UContentDefinition* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make ContentDefinition", meta=(DefaultToSelf="Outer", AdvancedDisplay="Tags, Variants, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break ContentDefinition", meta=(NativeBreakFunc))
