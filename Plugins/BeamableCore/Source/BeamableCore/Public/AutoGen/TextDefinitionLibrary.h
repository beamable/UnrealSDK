...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Content|4 - Json", DisplayName="TextDefinition To JSON String")
	static FString TextDefinitionToJsonString(const UTextDefinition* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Make TextDefinition", meta=(DefaultToSelf="Outer", AdvancedDisplay="Tags, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Break TextDefinition", meta=(NativeBreakFunc))
