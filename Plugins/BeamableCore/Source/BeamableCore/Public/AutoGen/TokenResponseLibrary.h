...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|Utils|Json", DisplayName="TokenResponse To JSON String")
	static FString TokenResponseToJsonString(const UTokenResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Accounts|Utils|Make/Break", DisplayName="Make TokenResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="AccessToken, RefreshToken, ChallengeToken, Scopes, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|Utils|Make/Break", DisplayName="Break TokenResponse", meta=(NativeBreakFunc))
