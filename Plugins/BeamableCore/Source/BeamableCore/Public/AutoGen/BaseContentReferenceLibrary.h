...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Content|4 - Json", DisplayName="BaseContentReference To JSON String")
	static FString BaseContentReferenceToJsonString(const UBaseContentReference* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Make BaseContentReference", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UBaseContentReference* Make(UContentReference* Content, UTextReference* Text, UBinaryReference* Binary, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Break BaseContentReference", meta=(NativeBreakFunc))
