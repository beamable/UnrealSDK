...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|Utils|Json", DisplayName="EmptyMessage To JSON String")
	static FString EmptyMessageToJsonString(const UEmptyMessage* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|Utils|Make/Break", DisplayName="Make EmptyMessage", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
