...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|4 - Json", DisplayName="ItemArchetype To JSON String")
	static FString ItemArchetypeToJsonString(const UItemArchetype* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Inventory|3 - Backend", DisplayName="Make ItemArchetype", meta=(DefaultToSelf="Outer", AdvancedDisplay="External, ClientPermission, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|3 - Backend", DisplayName="Break ItemArchetype", meta=(NativeBreakFunc))
