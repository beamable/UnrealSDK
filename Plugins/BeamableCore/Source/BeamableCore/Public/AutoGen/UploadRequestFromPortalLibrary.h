...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="UploadRequestFromPortal To JSON String")
	static FString UploadRequestFromPortalToJsonString(const UUploadRequestFromPortal* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make UploadRequestFromPortal", meta=(DefaultToSelf="Outer", AdvancedDisplay="LastModified, Metadata, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break UploadRequestFromPortal", meta=(NativeBreakFunc))
