...
#include "StartServiceLogsRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UStartServiceLogsRequestBody : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
