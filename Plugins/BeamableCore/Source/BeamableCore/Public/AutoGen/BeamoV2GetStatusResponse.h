...
#include "BeamoV2GetStatusResponse.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UBeamoV2GetStatusResponse : public UObject, public IBeamJsonSerializableUObject, public IBeamBaseResponseBodyInterface
{
	GENERATED_BODY()
...
public:
	...
	FOptionalArrayOfBeamoV2ServiceStatus Services = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, DisplayName="Storage Statuses", Category="Beam")
	FOptionalArrayOfBeamoV2ServiceStorageStatus StorageStatuses = {};
