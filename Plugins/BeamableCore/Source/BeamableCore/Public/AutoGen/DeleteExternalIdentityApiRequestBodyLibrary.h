...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|4 - Json", DisplayName="DeleteExternalIdentityApiRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Make DeleteExternalIdentityApiRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="ProviderNamespace, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Break DeleteExternalIdentityApiRequestBody", meta=(NativeBreakFunc))
