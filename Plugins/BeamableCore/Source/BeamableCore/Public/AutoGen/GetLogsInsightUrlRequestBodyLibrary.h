...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="GetLogsInsightUrlRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make GetLogsInsightUrlRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="StartTime, Filter, EndTime, Order, Limit, Filters, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break GetLogsInsightUrlRequestBody", meta=(NativeBreakFunc))
