...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="PlayerOfferView To JSON String")
	static FString PlayerOfferViewToJsonString(const UPlayerOfferView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make PlayerOfferView", meta=(DefaultToSelf="Outer", AdvancedDisplay="ButtonText, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break PlayerOfferView", meta=(NativeBreakFunc))
