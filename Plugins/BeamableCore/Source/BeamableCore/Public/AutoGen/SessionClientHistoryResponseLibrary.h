...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|4 - Json", DisplayName="SessionClientHistoryResponse To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Make SessionClientHistoryResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="InstallDate, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Break SessionClientHistoryResponse", meta=(NativeBreakFunc))
