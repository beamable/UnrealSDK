...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|4 - Json", DisplayName="TeamContentProto To JSON String")
	static FString TeamContentProtoToJsonString(const UTeamContentProto* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Make TeamContentProto", meta=(DefaultToSelf="Outer", AdvancedDisplay="Name, MaxPlayers, MinPlayers, Outer", NativeMakeFunc))
	static UTeamContentProto* Make(FOptionalString Name, FOptionalInt32 MaxPlayers, FOptionalInt32 MinPlayers, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Break TeamContentProto", meta=(NativeBreakFunc))
