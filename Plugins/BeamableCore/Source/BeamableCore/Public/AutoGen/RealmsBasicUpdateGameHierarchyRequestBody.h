...
#include "RealmsBasicUpdateGameHierarchyRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API URealmsBasicUpdateGameHierarchyRequestBody : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
