...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Mailbox|4 - Json", DisplayName="MessageRequestBody To JSON String")
	static FString MessageRequestBodyToJsonString(const UMessageRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Mailbox|3 - Backend", DisplayName="Make MessageRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Body, Pid, PlayerId, Channel, RealmId, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Mailbox|3 - Backend", DisplayName="Break MessageRequestBody", meta=(NativeBreakFunc))
