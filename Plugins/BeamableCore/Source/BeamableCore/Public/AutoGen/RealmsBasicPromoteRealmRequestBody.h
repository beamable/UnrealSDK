...
#include "RealmsBasicPromoteRealmRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API URealmsBasicPromoteRealmRequestBody : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
