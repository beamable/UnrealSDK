...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="DatabaseMeasurements To JSON String")
	static FString DatabaseMeasurementsToJsonString(const UDatabaseMeasurements* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make DatabaseMeasurements", meta=(DefaultToSelf="Outer", AdvancedDisplay="GroupId, HostId, Granularity, End, Start, ProcessId, Measurements, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break DatabaseMeasurements", meta=(NativeBreakFunc))
