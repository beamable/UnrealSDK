...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|ServicePlan|Utils|Make/Break", DisplayName="Make ServicePlanActorServicePlan", meta=(DefaultToSelf="Outer", AdvancedDisplay="ServiceLimits, Created, Outer", NativeMakeFunc))
	static UServicePlanActorServicePlan* Make(FString Name, UServicePlanActorDataDomain* DataDomain, FOptionalServicePlanActorServiceLimits ServiceLimits, FOptionalDateTime Created, UObject* Outer);
	...
	static void Break(const UServicePlanActorServicePlan* Serializable, FString& Name, UServicePlanActorDataDomain*& DataDomain, FOptionalServicePlanActorServiceLimits& ServiceLimits, FOptionalDateTime& Created);
};