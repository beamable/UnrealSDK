...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|4 - Json", DisplayName="OfferDefinition To JSON String")
	static FString OfferDefinitionToJsonString(const UOfferDefinition* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Make OfferDefinition", meta=(DefaultToSelf="Outer", AdvancedDisplay="LootRoll, Metadata, ObtainItems, ObtainCurrency, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Break OfferDefinition", meta=(NativeBreakFunc))
