...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="OfferDefinition To JSON String")
	static FString OfferDefinitionToJsonString(const UOfferDefinition* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make OfferDefinition", meta=(DefaultToSelf="Outer", AdvancedDisplay="LootRoll, Metadata, ObtainItems, ObtainCurrency, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break OfferDefinition", meta=(NativeBreakFunc))
