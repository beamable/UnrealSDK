...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="LeaderboardApiViewRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make LeaderboardApiViewRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bFriends, bGuild, Max, Focus, From, Outlier, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break LeaderboardApiViewRequestBody", meta=(NativeBreakFunc))
