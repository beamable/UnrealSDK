...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|4 - Json", DisplayName="SearchAnnouncementsRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Make SearchAnnouncementsRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Date, Outer", NativeMakeFunc))
	static USearchAnnouncementsRequestBody* Make(FOptionalString Date, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Break SearchAnnouncementsRequestBody", meta=(NativeBreakFunc))
