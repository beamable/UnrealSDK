...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Json", DisplayName="Beam - SessionUser To JSON String")
	static FString SessionUserToJsonString(const USessionUser* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make SessionUser", meta=(DefaultToSelf="Outer", AdvancedDisplay="Cid, Heartbeat, Password, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break SessionUser", meta=(NativeBreakFunc))
