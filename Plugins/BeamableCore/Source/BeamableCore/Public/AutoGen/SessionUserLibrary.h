...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="SessionUser To JSON String")
	static FString SessionUserToJsonString(const USessionUser* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make SessionUser", meta=(DefaultToSelf="Outer", AdvancedDisplay="Cid, Heartbeat, Password, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break SessionUser", meta=(NativeBreakFunc))
