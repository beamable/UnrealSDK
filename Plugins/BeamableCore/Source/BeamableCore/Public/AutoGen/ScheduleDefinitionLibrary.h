...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|4 - Json", DisplayName="ScheduleDefinition To JSON String")
	static FString ScheduleDefinitionToJsonString(const UScheduleDefinition* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Make ScheduleDefinition", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Break ScheduleDefinition", meta=(NativeBreakFunc))
