...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="LeaderboardPlayerAssignmentRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make LeaderboardPlayerAssignmentRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bJoinBoard, Outer", NativeMakeFunc))
	static ULeaderboardPlayerAssignmentRequestBody* Make(FString BoardId, FOptionalBool bJoinBoard, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break LeaderboardPlayerAssignmentRequestBody", meta=(NativeBreakFunc))
