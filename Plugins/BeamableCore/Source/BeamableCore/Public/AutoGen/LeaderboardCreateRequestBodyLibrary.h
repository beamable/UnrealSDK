...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="LeaderboardCreateRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make LeaderboardCreateRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bPartitioned, FreezeTime, ScoreName, CohortSettings, Permissions, MaxEntries, Ttl, Derivatives, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break LeaderboardCreateRequestBody", meta=(NativeBreakFunc))
