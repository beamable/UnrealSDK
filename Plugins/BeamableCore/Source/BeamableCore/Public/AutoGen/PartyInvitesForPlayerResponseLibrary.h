...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="PartyInvitesForPlayerResponse To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make PartyInvitesForPlayerResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Invitations, Outer", NativeMakeFunc))
	static UPartyInvitesForPlayerResponse* Make(FOptionalArrayOfPartyInvitation Invitations, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break PartyInvitesForPlayerResponse", meta=(NativeBreakFunc))
