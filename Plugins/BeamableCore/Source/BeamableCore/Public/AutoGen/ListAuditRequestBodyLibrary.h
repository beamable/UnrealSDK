...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|4 - Json", DisplayName="ListAuditRequestBody To JSON String")
	static FString ListAuditRequestBodyToJsonString(const UListAuditRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Make ListAuditRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Providerid, Provider, State, Txid, Player, Start, Limit, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Break ListAuditRequestBody", meta=(NativeBreakFunc))
