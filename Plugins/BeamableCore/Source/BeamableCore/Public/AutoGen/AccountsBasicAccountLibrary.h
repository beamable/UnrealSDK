...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|4 - Json", DisplayName="AccountsBasicAccount To JSON String")
	static FString AccountsBasicAccountToJsonString(const UAccountsBasicAccount* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Make AccountsBasicAccount", meta=(DefaultToSelf="Outer", AdvancedDisplay="bWasMigrated, UserName, DeviceId, Language, Password, Country, RoleString, Email, RealmId, Heartbeat, Roles, DeviceIds, InFlight, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Break AccountsBasicAccount", meta=(NativeBreakFunc))
