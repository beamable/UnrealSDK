...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="ManifestView To JSON String")
	static FString ManifestViewToJsonString(const UManifestView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make ManifestView", meta=(DefaultToSelf="Outer", AdvancedDisplay="CreatedByAccountId, Comments, StorageReference, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break ManifestView", meta=(NativeBreakFunc))
