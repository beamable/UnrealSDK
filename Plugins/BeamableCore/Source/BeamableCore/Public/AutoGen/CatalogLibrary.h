...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|4 - Json", DisplayName="Catalog To JSON String")
	static FString CatalogToJsonString(const UCatalog* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Make Catalog", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Break Catalog", meta=(NativeBreakFunc))
