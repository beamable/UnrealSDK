...
#include "RealmsBasicInFlightFailure.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API URealmsBasicInFlightFailure : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:
	...
	URealmsBasicInFlightMessage* InFlightMessage = {};
