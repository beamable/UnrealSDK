...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Matchmaking", DisplayName="Beam - Make PutTick",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPutTickRequest* Make(int64 _ObjectId, UObject* Outer);
};
