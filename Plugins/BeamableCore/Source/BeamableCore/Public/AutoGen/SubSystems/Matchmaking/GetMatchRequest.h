...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Matchmaking", DisplayName="Beam - Make GetMatch",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetMatchRequest* Make(int64 _ObjectId, UObject* Outer);
};
