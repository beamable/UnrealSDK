...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Matchmaking", DisplayName="Beam - Make ApiMatchmakingGetTickets",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Players,_bIncludeInactive,_Skip,_Limit,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
