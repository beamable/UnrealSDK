...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Stats|3 - Backend", DisplayName="Make PostClientStringlist",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Set,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
