...
UGetClientRequest* UGetClientRequest::MakeGetClientRequest(FString _ObjectId, FOptionalString _Stats, UObject* Outer)
{
	UGetClientRequest* Req = NewObject<UGetClientRequest>(Outer);
