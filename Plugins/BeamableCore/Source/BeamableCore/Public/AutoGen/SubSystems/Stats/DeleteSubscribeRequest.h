...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Stats|3 - Backend", DisplayName="Make DeleteSubscribe",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Subscriptions,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
