...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Stats", DisplayName="Beam - Make GetStats",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_Stats,Outer"))
	static UGetStatsRequest* Make(FString _ObjectId, FOptionalString _Stats, UObject* Outer);
};
