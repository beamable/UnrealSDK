...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Stats|Utils|Make/Break", DisplayName="Make PostSearchExtended",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Offset,_Limit,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
	static UPostSearchExtendedRequest* Make(FString _Domain, FString _ObjectType, FString _Access, TArray<UStatsSearchCriteria*> _Criteria, TArray<FString> _StatKeys, FOptionalInt32 _Offset, FOptionalInt32 _Limit, UObject* RequestOwner, TMap<FString, FString> CustomHeaders);
};
