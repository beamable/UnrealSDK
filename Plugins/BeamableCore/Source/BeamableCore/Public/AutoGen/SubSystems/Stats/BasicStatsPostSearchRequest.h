...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Stats", DisplayName="Beam - Make BasicStatsPostSearch",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UBasicStatsPostSearchRequest* Make(FString _Domain, FString _Access, FString _ObjectType, TArray<UStatsSearchCriteria*> _Criteria, UObject* RequestOwner);
};
