...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Stats", DisplayName="Beam - Make BasicStatsPostSearch",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UBasicStatsPostSearchRequest* Make(FString _Domain, FString _Access, FString _ObjectType, TArray<UStatsSearchCriteria*> _Criteria, UObject* Outer);
};
