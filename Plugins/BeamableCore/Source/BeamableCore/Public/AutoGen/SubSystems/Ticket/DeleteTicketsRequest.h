...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Ticket", DisplayName="Beam - Make DeleteTickets",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
