...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Ticket", DisplayName="Beam - Make GetTickets",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
