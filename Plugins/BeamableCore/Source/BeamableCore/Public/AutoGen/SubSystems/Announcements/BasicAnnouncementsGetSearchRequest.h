...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Announcements|3 - Backend", DisplayName="Make BasicAnnouncementsGetSearch",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Date,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
