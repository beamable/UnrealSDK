...
UPutReadRequest* UPutReadRequest::MakePutReadRequest(int64 _ObjectId, FOptionalString _Announcement, FOptionalArrayOfString _Announcements, UObject* Outer)
{
