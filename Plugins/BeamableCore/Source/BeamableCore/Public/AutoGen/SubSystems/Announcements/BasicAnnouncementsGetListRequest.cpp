...
#include "BasicAnnouncementsGetListRequest.h"
...
UBasicAnnouncementsGetListRequest* UBasicAnnouncementsGetListRequest::MakeBasicAnnouncementsGetListRequest(UObject* Outer)
{
	UBasicAnnouncementsGetListRequest* Req = NewObject<UBasicAnnouncementsGetListRequest>(Outer);
