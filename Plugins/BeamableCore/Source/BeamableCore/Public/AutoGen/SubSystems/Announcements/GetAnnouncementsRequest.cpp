...
#include "GetAnnouncementsRequest.h"
...
UGetAnnouncementsRequest* UGetAnnouncementsRequest::MakeGetAnnouncementsRequest(int64 _ObjectId, FOptionalBool _bIncludeDeleted, UObject* Outer)
{
