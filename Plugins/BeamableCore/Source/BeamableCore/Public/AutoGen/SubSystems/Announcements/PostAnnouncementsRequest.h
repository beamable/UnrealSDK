...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Announcements", DisplayName="Beam - Make PostAnnouncements",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_StartDate,_Gift,_EndDate,_Tags,_StatRequirements,_Attachments,_ClientData,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
