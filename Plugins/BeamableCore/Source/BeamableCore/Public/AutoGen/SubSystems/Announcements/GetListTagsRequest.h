...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Announcements|Backend", DisplayName="Make GetListTags",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_TagNameFilter,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
