...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Cloudsaving", DisplayName="Beam - Make PutDataMove",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_PlayerId,Outer"))
	static UPutDataMoveRequest* Make(FOptionalInt64 _PlayerId, UObject* Outer);
};
