...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Cloudsaving", DisplayName="Beam - Make PutDataMoveFromPortal",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_PlayerId,Outer"))
	static UPutDataMoveFromPortalRequest* Make(FOptionalInt64 _PlayerId, UObject* Outer);
};
