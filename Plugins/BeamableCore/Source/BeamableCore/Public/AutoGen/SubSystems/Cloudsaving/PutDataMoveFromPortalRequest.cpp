...
#include "PutDataMoveFromPortalRequest.h"
...
UPutDataMoveFromPortalRequest* UPutDataMoveFromPortalRequest::MakePutDataMoveFromPortalRequest(FOptionalInt64 _PlayerId, UObject* Outer)
{
	UPutDataMoveFromPortalRequest* Req = NewObject<UPutDataMoveFromPortalRequest>(Outer);
