...
#include "PostDataReplaceRequest.h"
...
UPostDataReplaceRequest* UPostDataReplaceRequest::MakePostDataReplaceRequest(int64 _SourcePlayerId, int64 _TargetPlayerId, UObject* Outer)
{
