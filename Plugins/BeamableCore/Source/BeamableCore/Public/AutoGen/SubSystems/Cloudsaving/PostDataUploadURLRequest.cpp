...
#include "PostDataUploadURLRequest.h"
...
UPostDataUploadURLRequest* UPostDataUploadURLRequest::MakePostDataUploadURLRequest(TArray<UUploadRequestBody*> _Request, FOptionalInt64 _PlayerId, UObject* Outer)
{
	UPostDataUploadURLRequest* Req = NewObject<UPostDataUploadURLRequest>(Outer);
