...
#include "PostPasswordUpdateInitRequest.h"
...
UPostPasswordUpdateInitRequest* UPostPasswordUpdateInitRequest::MakePostPasswordUpdateInitRequest(FString _Email, FOptionalString _CodeType, UObject* Outer)
{
