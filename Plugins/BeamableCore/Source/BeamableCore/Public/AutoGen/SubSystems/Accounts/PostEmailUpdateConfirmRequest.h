...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make PostEmailUpdateConfirm",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UPostEmailUpdateConfirmRequest* Make(FString _Code, FString _Password, UObject* RequestOwner);
};
