...
#include "ObjectAccountsPutRoleRequest.h"
...
UObjectAccountsPutRoleRequest* UObjectAccountsPutRoleRequest::MakeObjectAccountsPutRoleRequest(int64 _ObjectId, FOptionalString _Cid, FOptionalString _Realm, FOptionalString _Role, UObject* Outer)
{
