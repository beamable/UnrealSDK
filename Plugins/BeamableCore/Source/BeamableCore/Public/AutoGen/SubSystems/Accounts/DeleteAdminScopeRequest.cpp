...
#include "DeleteAdminScopeRequest.h"
...
UDeleteAdminScopeRequest* UDeleteAdminScopeRequest::MakeDeleteAdminScopeRequest(int64 _ObjectId, FString _Realm, FString _Role, UObject* Outer)
{
