...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Accounts|Backend", DisplayName="Make PostExternalIdentity",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_ChallengeSolution,_ProviderNamespace,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
