...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make GetAdminAdminUsers",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetAdminAdminUsersRequest* Make(UObject* Outer);
};
