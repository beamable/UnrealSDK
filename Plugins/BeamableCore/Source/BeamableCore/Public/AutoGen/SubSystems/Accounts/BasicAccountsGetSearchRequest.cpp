...
#include "BasicAccountsGetSearchRequest.h"
...
UBasicAccountsGetSearchRequest* UBasicAccountsGetSearchRequest::MakeBasicAccountsGetSearchRequest(FString _Query, int32 _Page, int32 _Pagesize, UObject* Outer)
{
