...
#include "PostPasswordUpdateConfirmRequest.h"
...
UPostPasswordUpdateConfirmRequest* UPostPasswordUpdateConfirmRequest::MakePostPasswordUpdateConfirmRequest(FString _Code, FString _NewPassword, FOptionalString _Email, UObject* Outer)
{
	UPostPasswordUpdateConfirmRequest* Req = NewObject<UPostPasswordUpdateConfirmRequest>(Outer);
