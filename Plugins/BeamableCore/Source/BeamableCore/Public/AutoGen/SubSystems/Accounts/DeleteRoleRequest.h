...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make DeleteRole",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UDeleteRoleRequest* Make(int64 _ObjectId, FString _Realm, FString _Role, UObject* Outer);
};
