...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make DeleteMeDevice",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_DeviceIds,Outer"))
	static UDeleteMeDeviceRequest* Make(FOptionalArrayOfString _DeviceIds, UObject* Outer);
};
