...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Accounts|3 - Backend", DisplayName="Make DeleteMeDevice",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_DeviceIds,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
