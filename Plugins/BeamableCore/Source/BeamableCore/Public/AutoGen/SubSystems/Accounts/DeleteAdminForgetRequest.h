...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make DeleteAdminForget",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UDeleteAdminForgetRequest* Make(int64 _ObjectId, UObject* Outer);
};
