...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Accounts", DisplayName="Beam - Make BasicAccountsGetMe",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UBasicAccountsGetMeRequest* Make(UObject* RequestOwner);
};
