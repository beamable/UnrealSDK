...
#include "PutAdminThirdPartyRequest.h"
...
UPutAdminThirdPartyRequest* UPutAdminThirdPartyRequest::MakePutAdminThirdPartyRequest(int64 _ObjectId, int64 _FromAccountId, UThirdPartyAssociation* _ThirdParty, UObject* Outer)
{
