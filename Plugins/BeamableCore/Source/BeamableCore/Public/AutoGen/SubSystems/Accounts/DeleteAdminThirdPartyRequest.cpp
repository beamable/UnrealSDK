...
#include "DeleteAdminThirdPartyRequest.h"
...
UDeleteAdminThirdPartyRequest* UDeleteAdminThirdPartyRequest::MakeDeleteAdminThirdPartyRequest(int64 _ObjectId, FString _ThirdParty, FString _UserAppId, UObject* Outer)
{
