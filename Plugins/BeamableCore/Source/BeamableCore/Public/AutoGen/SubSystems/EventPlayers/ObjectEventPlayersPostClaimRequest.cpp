...
#include "ObjectEventPlayersPostClaimRequest.h"
...
UObjectEventPlayersPostClaimRequest* UObjectEventPlayersPostClaimRequest::MakeObjectEventPlayersPostClaimRequest(int64 _ObjectId, FString _EventId, UObject* Outer)
{
	UObjectEventPlayersPostClaimRequest* Req = NewObject<UObjectEventPlayersPostClaimRequest>(Outer);
