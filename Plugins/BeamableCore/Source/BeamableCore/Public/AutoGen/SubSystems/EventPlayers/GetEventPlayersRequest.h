...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|EventPlayers", DisplayName="Beam - Make GetEventPlayers",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetEventPlayersRequest* Make(int64 _ObjectId, UObject* Outer);
};
