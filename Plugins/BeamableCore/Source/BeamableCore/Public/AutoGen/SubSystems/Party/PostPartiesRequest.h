...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Party|Backend", DisplayName="Make PostParties",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Restriction,_Leader,_MaxSize,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
