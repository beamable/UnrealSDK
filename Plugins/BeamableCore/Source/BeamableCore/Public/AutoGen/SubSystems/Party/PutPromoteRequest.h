...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Party", DisplayName="Beam - Make PutPromote",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_PlayerId,RequestOwner"))
	static UPutPromoteRequest* Make(FGuid _Id, FOptionalString _PlayerId, UObject* RequestOwner);
};
