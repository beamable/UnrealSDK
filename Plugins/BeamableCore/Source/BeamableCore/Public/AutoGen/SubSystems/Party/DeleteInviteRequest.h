...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Party", DisplayName="Beam - Make DeleteInvite",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_PlayerId,RequestOwner"))
	static UDeleteInviteRequest* Make(FGuid _Id, FOptionalString _PlayerId, UObject* RequestOwner);
};
