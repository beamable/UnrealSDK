...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Party", DisplayName="Beam - Make ApiPartyPostInvite",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_PlayerId,RequestOwner"))
	static UApiPartyPostInviteRequest* Make(FGuid _Id, FOptionalString _PlayerId, UObject* RequestOwner);
};
