...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Mail", DisplayName="Beam - Make GetCategories",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetCategoriesRequest* Make(int64 _ObjectId, UObject* Outer);
};
