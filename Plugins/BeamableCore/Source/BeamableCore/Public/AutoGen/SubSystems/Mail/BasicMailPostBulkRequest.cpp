...
#include "BasicMailPostBulkRequest.h"
...
UBasicMailPostBulkRequest* UBasicMailPostBulkRequest::MakeBasicMailPostBulkRequest(TArray<USendMailRequestBody*> _SendMailRequests, UObject* Outer)
{
