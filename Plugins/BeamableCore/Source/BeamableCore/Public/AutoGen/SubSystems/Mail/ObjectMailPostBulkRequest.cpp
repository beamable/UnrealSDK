...
#include "ObjectMailPostBulkRequest.h"
...
UObjectMailPostBulkRequest* UObjectMailPostBulkRequest::MakeObjectMailPostBulkRequest(int64 _ObjectId, TArray<USendMailRequestBody*> _SendMailRequests, UObject* Outer)
{
	UObjectMailPostBulkRequest* Req = NewObject<UObjectMailPostBulkRequest>(Outer);
