...
#include "PutAcceptManyRequest.h"
...
UPutAcceptManyRequest* UPutAcceptManyRequest::MakePutAcceptManyRequest(int64 _ObjectId, TArray<int64> _MailIds, UObject* Outer)
{
	UPutAcceptManyRequest* Req = NewObject<UPutAcceptManyRequest>(Outer);
