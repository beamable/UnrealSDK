...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Mail", DisplayName="Beam - Make ObjectMailPostBulk",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UObjectMailPostBulkRequest* Make(int64 _ObjectId, TArray<USendMailRequestBody*> _SendMailRequests, UObject* Outer);
};
