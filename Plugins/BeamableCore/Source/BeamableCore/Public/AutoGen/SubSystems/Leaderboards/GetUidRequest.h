...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Leaderboards", DisplayName="Beam - Make GetUid",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetUidRequest* Make(UObject* Outer);
};
