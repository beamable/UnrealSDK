...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Leaderboards|Backend", DisplayName="Make PutEntry",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bIncrement,_MaxScore,_MinScore,_Stats,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
