...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Leaderboards", DisplayName="Beam - Make DeleteAssignment",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UDeleteAssignmentRequest* Make(FString _ObjectId, int64 _PlayerId, UObject* Outer);
};
