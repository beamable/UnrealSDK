...
UGetViewRequest* UGetViewRequest::MakeGetViewRequest(FString _ObjectId, FOptionalInt32 _Max, FOptionalInt64 _Focus, FOptionalBool _bFriends, FOptionalInt32 _From, FOptionalInt64 _Outlier, FOptionalBool _bGuild, UObject* Outer)
{
	UGetViewRequest* Req = NewObject<UGetViewRequest>(Outer);
