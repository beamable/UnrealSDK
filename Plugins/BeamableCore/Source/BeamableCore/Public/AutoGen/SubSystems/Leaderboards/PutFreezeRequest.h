...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Leaderboards", DisplayName="Beam - Make PutFreeze",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPutFreezeRequest* Make(FString _ObjectId, UObject* Outer);
};
