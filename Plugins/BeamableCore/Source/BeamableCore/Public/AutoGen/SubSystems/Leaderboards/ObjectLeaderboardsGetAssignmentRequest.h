...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Leaderboards", DisplayName="Beam - Make ObjectLeaderboardsGetAssignment",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UObjectLeaderboardsGetAssignmentRequest* Make(FString _ObjectId, UObject* Outer);
};
