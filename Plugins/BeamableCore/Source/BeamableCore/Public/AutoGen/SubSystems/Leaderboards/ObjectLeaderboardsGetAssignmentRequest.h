...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Leaderboards", DisplayName="Beam - Make ObjectLeaderboardsGetAssignment",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UObjectLeaderboardsGetAssignmentRequest* Make(FString _ObjectId, UObject* RequestOwner);
};
