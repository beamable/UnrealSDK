...
#include "DeleteAssignmentRequest.h"
...
UDeleteAssignmentRequest* UDeleteAssignmentRequest::MakeDeleteAssignmentRequest(FString _ObjectId, int64 _PlayerId, UObject* Outer)
{
