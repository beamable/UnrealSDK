...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make PostLeaderboards",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bPartitioned,_FreezeTime,_ScoreName,_CohortSettings,_Permissions,_MaxEntries,_Ttl,_Derivatives,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
