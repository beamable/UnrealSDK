...
#include "ObjectCalendarsPostClaimRequest.h"
...
UObjectCalendarsPostClaimRequest* UObjectCalendarsPostClaimRequest::MakeObjectCalendarsPostClaimRequest(int64 _ObjectId, FString _Id, UObject* Outer)
{
	UObjectCalendarsPostClaimRequest* Req = NewObject<UObjectCalendarsPostClaimRequest>(Outer);
