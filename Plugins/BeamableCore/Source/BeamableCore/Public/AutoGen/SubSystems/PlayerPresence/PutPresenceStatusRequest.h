...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|PlayerPresence", DisplayName="Beam - Make PutPresenceStatus",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Status,_Description,RequestOwner"))
