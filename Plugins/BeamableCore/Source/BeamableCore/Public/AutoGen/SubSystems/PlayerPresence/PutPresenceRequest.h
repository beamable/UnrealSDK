...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|PlayerPresence", DisplayName="Beam - Make PutPresence",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UPutPresenceRequest* Make(FString _PlayerId, UObject* RequestOwner);
};
