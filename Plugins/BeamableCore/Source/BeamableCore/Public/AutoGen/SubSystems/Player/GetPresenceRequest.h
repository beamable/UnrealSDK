...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Player", DisplayName="Beam - Make GetPresence",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
