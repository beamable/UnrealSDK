...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Player", DisplayName="Beam - Make GetPartiesInvites",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UGetPartiesInvitesRequest* Make(FString _PlayerId, UObject* RequestOwner);
};
