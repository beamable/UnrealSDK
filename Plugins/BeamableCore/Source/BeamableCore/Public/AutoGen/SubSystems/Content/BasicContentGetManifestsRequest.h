...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Content", DisplayName="Beam - Make BasicContentGetManifests",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UBasicContentGetManifestsRequest* Make(UObject* RequestOwner);
};
