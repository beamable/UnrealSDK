...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Content|3 - Backend", DisplayName="Make GetManifestHistory",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Id,_Limit,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
