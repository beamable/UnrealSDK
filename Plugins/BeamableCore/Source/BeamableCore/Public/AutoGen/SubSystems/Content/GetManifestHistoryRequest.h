...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Content|Backend", DisplayName="Make GetManifestHistory",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Id,_Limit,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
