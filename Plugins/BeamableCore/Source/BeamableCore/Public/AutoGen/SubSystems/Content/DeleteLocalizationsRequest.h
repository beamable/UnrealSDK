...
#include "AutoGen/DeleteLocalizationRequestBody.h"
...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Content", DisplayName="Beam - Make DeleteLocalizations",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UDeleteLocalizationsRequest* Make(TArray<ULocalizationQuery*> _Localizations, UObject* RequestOwner);
};
