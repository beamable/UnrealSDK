...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make GetAdminView",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bShowHiddenRealms,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
	static UGetAdminViewRequest* Make(FString _CustomerId, FOptionalBool _bShowHiddenRealms, UObject* RequestOwner, TMap<FString, FString> CustomHeaders);
};
