...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make ApiCustomerGetGamesByCustomerId",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bShowHiddenRealms,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
	static UApiCustomerGetGamesByCustomerIdRequest* Make(FString _CustomerId, FOptionalBool _bShowHiddenRealms, UObject* RequestOwner, TMap<FString, FString> CustomHeaders);
};
