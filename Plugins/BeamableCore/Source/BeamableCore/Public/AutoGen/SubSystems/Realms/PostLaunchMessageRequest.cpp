...
#include "PostLaunchMessageRequest.h"
...
UPostLaunchMessageRequest* UPostLaunchMessageRequest::MakePostLaunchMessageRequest(FString _Name, FString _Body, UObject* Outer)
{
