...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetCustomers",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetCustomersRequest* Make(UObject* Outer);
};
