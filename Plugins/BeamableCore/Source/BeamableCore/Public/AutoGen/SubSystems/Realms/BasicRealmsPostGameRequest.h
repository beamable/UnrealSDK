...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make BasicRealmsPostGame",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UBasicRealmsPostGameRequest* Make(FString _GameName, UObject* RequestOwner);
};
