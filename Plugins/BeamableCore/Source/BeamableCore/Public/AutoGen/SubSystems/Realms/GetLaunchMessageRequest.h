...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetLaunchMessage",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetLaunchMessageRequest* Make(UObject* Outer);
};
