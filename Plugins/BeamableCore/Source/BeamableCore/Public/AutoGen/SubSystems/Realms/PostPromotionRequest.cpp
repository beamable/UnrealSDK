...
#include "PostPromotionRequest.h"
...
UPostPromotionRequest* UPostPromotionRequest::MakePostPromotionRequest(FString _SourcePid, FOptionalArrayOfString _Promotions, FOptionalArrayOfString _ContentManifestIds, UObject* Outer)
{
	UPostPromotionRequest* Req = NewObject<UPostPromotionRequest>(Outer);
