...
#include "DeleteLaunchMessageRequest.h"
...
UDeleteLaunchMessageRequest* UDeleteLaunchMessageRequest::MakeDeleteLaunchMessageRequest(FString _File, UObject* Outer)
{
	UDeleteLaunchMessageRequest* Req = NewObject<UDeleteLaunchMessageRequest>(Outer);
