...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetGames",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetGamesRequest* Make(UObject* Outer);
};
