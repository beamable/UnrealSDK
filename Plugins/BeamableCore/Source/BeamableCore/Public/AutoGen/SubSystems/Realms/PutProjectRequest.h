...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make PutProject",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPutProjectRequest* Make(FString _ProjectId, UObject* Outer);
};
