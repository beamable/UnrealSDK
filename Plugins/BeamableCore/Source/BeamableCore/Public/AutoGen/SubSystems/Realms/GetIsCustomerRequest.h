...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetIsCustomer",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetIsCustomerRequest* Make(UObject* Outer);
};
