...
#include "PutProjectRenameRequest.h"
...
UPutProjectRenameRequest* UPutProjectRenameRequest::MakePutProjectRenameRequest(FString _ProjectId, FString _NewName, UObject* Outer)
{
