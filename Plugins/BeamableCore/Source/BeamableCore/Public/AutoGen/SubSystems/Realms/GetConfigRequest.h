...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetConfig",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetConfigRequest* Make(UObject* Outer);
};
