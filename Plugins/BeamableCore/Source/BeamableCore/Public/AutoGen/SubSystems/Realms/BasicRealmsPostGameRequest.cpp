...
#include "BasicRealmsPostGameRequest.h"
...
UBasicRealmsPostGameRequest* UBasicRealmsPostGameRequest::MakeBasicRealmsPostGameRequest(FString _GameName, UObject* Outer)
{
	UBasicRealmsPostGameRequest* Req = NewObject<UBasicRealmsPostGameRequest>(Outer);
