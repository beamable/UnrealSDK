...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make GetPlans",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetPlansRequest* Make(UObject* Outer);
};
