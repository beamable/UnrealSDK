...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Realms", DisplayName="Beam - Make PostLaunchMessage",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPostLaunchMessageRequest* Make(FString _Name, FString _Body, UObject* Outer);
};
