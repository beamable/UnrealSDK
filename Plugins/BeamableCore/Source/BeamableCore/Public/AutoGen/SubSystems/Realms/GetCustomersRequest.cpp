...
UGetCustomersRequest* UGetCustomersRequest::MakeGetCustomersRequest(UObject* Outer)
{
	UGetCustomersRequest* Req = NewObject<UGetCustomersRequest>(Outer);
