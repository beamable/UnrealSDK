...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Notification|Backend", DisplayName="Make BasicNotificationPostServer",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Payload,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
