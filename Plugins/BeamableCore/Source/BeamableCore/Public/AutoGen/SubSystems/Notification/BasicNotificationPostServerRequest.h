...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Notification|3 - Backend", DisplayName="Make BasicNotificationPostServer",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Payload,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
