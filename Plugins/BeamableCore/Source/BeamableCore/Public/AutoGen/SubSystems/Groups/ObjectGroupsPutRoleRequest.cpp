...
#include "ObjectGroupsPutRoleRequest.h"
...
UObjectGroupsPutRoleRequest* UObjectGroupsPutRoleRequest::MakeObjectGroupsPutRoleRequest(int64 _ObjectId, int64 _GamerTag, FString _Role, FOptionalInt64 _SubGroup, UObject* Outer)
{
	UObjectGroupsPutRoleRequest* Req = NewObject<UObjectGroupsPutRoleRequest>(Outer);
