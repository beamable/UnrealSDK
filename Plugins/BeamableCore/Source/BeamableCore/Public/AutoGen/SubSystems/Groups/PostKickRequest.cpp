...
UPostKickRequest* UPostKickRequest::MakePostKickRequest(int64 _ObjectId, int64 _GamerTag, FOptionalInt64 _SubGroup, UObject* Outer)
{
	UPostKickRequest* Req = NewObject<UPostKickRequest>(Outer);
