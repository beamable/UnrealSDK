...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Groups", DisplayName="Beam - Make PostKick",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_SubGroup,Outer"))
	static UPostKickRequest* Make(int64 _ObjectId, int64 _GamerTag, FOptionalInt64 _SubGroup, UObject* Outer);
};
