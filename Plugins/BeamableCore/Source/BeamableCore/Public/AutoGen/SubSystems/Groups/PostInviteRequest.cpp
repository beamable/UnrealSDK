...
UPostInviteRequest* UPostInviteRequest::MakePostInviteRequest(int64 _ObjectId, int64 _GamerTag, FOptionalInt64 _SubGroup, FOptionalBool _bUseNewRewardsSystem, UObject* Outer)
{
