...
#include "PostDonationsRequest.h"
...
UPostDonationsRequest* UPostDonationsRequest::MakePostDonationsRequest(int64 _ObjectId, FString _CurrencyId, int64 _Amount, FOptionalString _Config, UObject* Outer)
{
