...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Groups|3 - Backend", DisplayName="Make ObjectGroupsPostInviteByObjectId",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_SubGroup,_bUseNewRewardsSystem,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
