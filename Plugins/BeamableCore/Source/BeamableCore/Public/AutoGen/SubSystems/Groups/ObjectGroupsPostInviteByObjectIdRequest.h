...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Groups|Backend", DisplayName="Make ObjectGroupsPostInviteByObjectId",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_SubGroup,_bUseNewRewardsSystem,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
