...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Groups", DisplayName="Beam - Make DeleteGroups",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_SubGroup,RequestOwner"))
	static UDeleteGroupsRequest* Make(int64 _ObjectId, FOptionalInt64 _SubGroup, UObject* RequestOwner);
};
