...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Groups", DisplayName="Beam - Make DeleteGroups",  meta=(DefaultToSelf="Outer", AdvancedDisplay="_SubGroup,Outer"))
	static UDeleteGroupsRequest* Make(int64 _ObjectId, FOptionalInt64 _SubGroup, UObject* Outer);
};
