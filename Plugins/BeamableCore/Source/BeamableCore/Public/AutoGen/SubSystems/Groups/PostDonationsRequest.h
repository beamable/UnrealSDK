...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Groups|Backend", DisplayName="Make PostDonations",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Config,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
