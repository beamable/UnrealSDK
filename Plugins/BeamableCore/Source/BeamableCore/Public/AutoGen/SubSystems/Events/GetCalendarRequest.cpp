...
UGetCalendarRequest* UGetCalendarRequest::MakeGetCalendarRequest(FOptionalString _From, FOptionalString _To, FOptionalString _Query, FOptionalInt32 _Limit, UObject* Outer)
{
