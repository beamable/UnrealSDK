...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Events", DisplayName="Beam - Make PostApplyContent",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPostApplyContentRequest* Make(UEvent* _Content, UObject* Outer);
};
