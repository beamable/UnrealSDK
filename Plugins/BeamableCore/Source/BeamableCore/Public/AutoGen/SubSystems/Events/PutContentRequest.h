...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Events", DisplayName="Beam - Make PutContent",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_RootEventId,_OriginType,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
