...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Events|Backend", DisplayName="Make PutEndPhase",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Time,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
