...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Events", DisplayName="Beam - Make GetPing",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetPingRequest* Make(int64 _ObjectId, UObject* Outer);
};
