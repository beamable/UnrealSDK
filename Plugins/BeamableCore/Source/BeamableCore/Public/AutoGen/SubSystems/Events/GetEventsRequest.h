...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Events", DisplayName="Beam - Make GetEvents",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetEventsRequest* Make(int64 _ObjectId, UObject* Outer);
};
