...
UGetGlobalRequest* UGetGlobalRequest::MakeGetGlobalRequest(FString _TournamentId, FOptionalInt32 _Max, FOptionalInt64 _Focus, FOptionalInt32 _Cycle, FOptionalInt32 _From, UObject* Outer)
{
	UGetGlobalRequest* Req = NewObject<UGetGlobalRequest>(Outer);
