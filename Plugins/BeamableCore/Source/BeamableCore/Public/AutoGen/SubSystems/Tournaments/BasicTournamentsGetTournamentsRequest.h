...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Tournaments|3 - Backend", DisplayName="Make BasicTournamentsGetTournaments",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bIsRunning,_ContentId,_Cycle,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
