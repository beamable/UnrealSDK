...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Tournaments", DisplayName="Beam - Make PostScore",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bIncrement,_ContentId,_Stats,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
