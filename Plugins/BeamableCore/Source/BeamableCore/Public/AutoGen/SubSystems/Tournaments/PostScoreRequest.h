...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Tournaments|Backend", DisplayName="Make PostScore",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bIncrement,_ContentId,_Stats,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
