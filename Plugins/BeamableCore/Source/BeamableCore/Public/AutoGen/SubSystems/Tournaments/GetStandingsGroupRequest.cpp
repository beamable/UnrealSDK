...
#include "GetStandingsGroupRequest.h"
...
UGetStandingsGroupRequest* UGetStandingsGroupRequest::MakeGetStandingsGroupRequest(FString _TournamentId, FOptionalInt32 _Max, FOptionalInt64 _Focus, FOptionalInt32 _Cycle, FOptionalInt32 _From, UObject* Outer)
{
	UGetStandingsGroupRequest* Req = NewObject<UGetStandingsGroupRequest>(Outer);
