...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Tournaments|3 - Backend", DisplayName="Make GetRewards",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_TournamentId,_ContentId,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
