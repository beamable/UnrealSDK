...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Tournaments", DisplayName="Beam - Make ObjectTournamentsGetTournaments",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UObjectTournamentsGetTournamentsRequest* Make(int64 _ObjectId, UObject* Outer);
};
