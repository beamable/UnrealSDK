...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Tournaments", DisplayName="Beam - Make ObjectTournamentsGetTournaments",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UObjectTournamentsGetTournamentsRequest* Make(int64 _ObjectId, UObject* RequestOwner);
};
