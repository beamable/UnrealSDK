...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Tournaments|Backend", DisplayName="Make BasicTournamentsGetMe",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_TournamentId,_ContentId,_bHasUnclaimedRewards,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
