...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Lobby|Backend", DisplayName="Make DeleteTags",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_PlayerId,_Tags,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
