...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Lobby", DisplayName="Beam - Make ApiLobbyPostServerById",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_MatchType,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
