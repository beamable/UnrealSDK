...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Commerce", DisplayName="Beam - Make PostCatalogLegacy",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPostCatalogLegacyRequest* Make(TArray<UStore*> _Stores, TArray<UOfferDefinition*> _OfferDefinitions, UObject* Outer);
};
