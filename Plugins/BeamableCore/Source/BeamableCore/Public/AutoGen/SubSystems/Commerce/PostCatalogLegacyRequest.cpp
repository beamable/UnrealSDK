...
#include "PostCatalogLegacyRequest.h"
...
UPostCatalogLegacyRequest* UPostCatalogLegacyRequest::MakePostCatalogLegacyRequest(TArray<UStore*> _Stores, TArray<UOfferDefinition*> _OfferDefinitions, UObject* Outer)
{
