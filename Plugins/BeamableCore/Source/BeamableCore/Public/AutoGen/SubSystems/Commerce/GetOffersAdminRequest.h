...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Commerce|Backend", DisplayName="Make GetOffersAdmin",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Language,_Time,_Stores,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
