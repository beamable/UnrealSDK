...
public:
	...
	static UGetOffersAdminRequest* MakeGetOffersAdminRequest(int64 _ObjectId, FOptionalString _Language, FOptionalString _Time, FOptionalString _Stores, UObject* Outer);
};
