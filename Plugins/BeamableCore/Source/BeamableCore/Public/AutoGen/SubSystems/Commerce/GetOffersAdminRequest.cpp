...
#include "GetOffersAdminRequest.h"
...
UGetOffersAdminRequest* UGetOffersAdminRequest::MakeGetOffersAdminRequest(int64 _ObjectId, FOptionalString _Language, FOptionalString _Time, FOptionalString _Stores, UObject* Outer)
{
	UGetOffersAdminRequest* Req = NewObject<UGetOffersAdminRequest>(Outer);
