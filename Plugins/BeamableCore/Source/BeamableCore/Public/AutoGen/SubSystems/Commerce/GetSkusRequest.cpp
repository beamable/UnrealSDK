...
UGetSkusRequest* UGetSkusRequest::MakeGetSkusRequest(FOptionalInt64 _Version, UObject* Outer)
{
	UGetSkusRequest* Req = NewObject<UGetSkusRequest>(Outer);
