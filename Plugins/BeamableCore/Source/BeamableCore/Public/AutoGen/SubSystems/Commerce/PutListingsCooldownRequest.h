...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Commerce", DisplayName="Beam - Make PutListingsCooldown",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPutListingsCooldownRequest* Make(int64 _ObjectId, int64 _GamerTag, TArray<UUpdateListingCooldownRequestBody*> _UpdateListingCooldownRequests, UObject* Outer);
};
