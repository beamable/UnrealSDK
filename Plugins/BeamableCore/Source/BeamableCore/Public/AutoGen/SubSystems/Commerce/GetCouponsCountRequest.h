...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Commerce", DisplayName="Beam - Make GetCouponsCount",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetCouponsCountRequest* Make(int64 _ObjectId, UObject* Outer);
};
