...
#include "PutListingsCooldownRequest.h"
...
UPutListingsCooldownRequest* UPutListingsCooldownRequest::MakePutListingsCooldownRequest(int64 _ObjectId, int64 _GamerTag, TArray<UUpdateListingCooldownRequestBody*> _UpdateListingCooldownRequests, UObject* Outer)
{
	UPutListingsCooldownRequest* Req = NewObject<UPutListingsCooldownRequest>(Outer);
