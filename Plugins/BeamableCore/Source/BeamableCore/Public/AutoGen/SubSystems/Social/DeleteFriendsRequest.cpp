...
#include "DeleteFriendsRequest.h"
...
UDeleteFriendsRequest* UDeleteFriendsRequest::MakeDeleteFriendsRequest(FString _PlayerId, UObject* Outer)
{
	UDeleteFriendsRequest* Req = NewObject<UDeleteFriendsRequest>(Outer);
