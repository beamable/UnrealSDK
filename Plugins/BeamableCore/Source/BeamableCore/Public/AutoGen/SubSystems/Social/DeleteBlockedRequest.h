...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Social", DisplayName="Beam - Make DeleteBlocked",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UDeleteBlockedRequest* Make(FString _PlayerId, UObject* Outer);
};
