...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Social", DisplayName="Beam - Make PostBlocked",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPostBlockedRequest* Make(FString _PlayerId, UObject* Outer);
};
