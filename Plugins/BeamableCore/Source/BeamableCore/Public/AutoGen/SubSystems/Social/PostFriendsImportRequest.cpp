...
#include "PostFriendsImportRequest.h"
...
UPostFriendsImportRequest* UPostFriendsImportRequest::MakePostFriendsImportRequest(FString _Source, FString _Token, UObject* Outer)
{
	UPostFriendsImportRequest* Req = NewObject<UPostFriendsImportRequest>(Outer);
