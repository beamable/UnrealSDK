...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Inventory", DisplayName="Beam - Make GetMultipliers",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetMultipliersRequest* Make(int64 _ObjectId, UObject* Outer);
};
