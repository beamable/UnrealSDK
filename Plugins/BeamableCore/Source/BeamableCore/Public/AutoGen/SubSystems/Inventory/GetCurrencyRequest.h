...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Inventory", DisplayName="Beam - Make GetCurrency",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetCurrencyRequest* Make(UObject* Outer);
};
