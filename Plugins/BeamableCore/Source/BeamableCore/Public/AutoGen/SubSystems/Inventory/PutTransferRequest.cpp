...
UPutTransferRequest* UPutTransferRequest::MakePutTransferRequest(int64 _ObjectId, FOptionalString _Transaction, int64 _RecipientPlayer, FOptionalMapOfInt64 _Currencies, UObject* Outer)
{
