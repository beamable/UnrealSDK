...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Inventory|Utils|Make/Break", DisplayName="Make PutPreview",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_bApplyVipBonus,_bIncludeDeltas,_Transaction,_Scopes,_UpdateItems,_NewItems,_DeleteItems,_Currencies,_CurrencyProperties,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
