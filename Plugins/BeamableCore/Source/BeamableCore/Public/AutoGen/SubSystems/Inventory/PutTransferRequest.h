...
public:
	...
	static UPutTransferRequest* Make(int64 _ObjectId, int64 _RecipientPlayer, FOptionalString _Transaction, FOptionalMapOfInt64 _Currencies, UObject* RequestOwner);
};
