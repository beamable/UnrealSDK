...
#include "DeleteTransactionRequest.h"
...
UDeleteTransactionRequest* UDeleteTransactionRequest::MakeDeleteTransactionRequest(int64 _ObjectId, FString _Transaction, UObject* Outer)
{
