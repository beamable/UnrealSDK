...
#include "PostGoogleplayPurchaseFailRequest.h"
...
UPostGoogleplayPurchaseFailRequest* UPostGoogleplayPurchaseFailRequest::MakePostGoogleplayPurchaseFailRequest(int64 _Txid, FString _Reason, UObject* Outer)
{
