...
#include "GetSteamProductRequest.h"
...
UGetSteamProductRequest* UGetSteamProductRequest::MakeGetSteamProductRequest(FString _Sku, UObject* Outer)
{
	UGetSteamProductRequest* Req = NewObject<UGetSteamProductRequest>(Outer);
