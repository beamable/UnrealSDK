...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Payments", DisplayName="Beam - Make PostSteamAuth",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UPostSteamAuthRequest* Make(FString _Ticket, UObject* Outer);
};
