...
#include "PostGoogleplayPurchaseCancelRequest.h"
...
UPostGoogleplayPurchaseCancelRequest* UPostGoogleplayPurchaseCancelRequest::MakePostGoogleplayPurchaseCancelRequest(int64 _Txid, UObject* Outer)
{
