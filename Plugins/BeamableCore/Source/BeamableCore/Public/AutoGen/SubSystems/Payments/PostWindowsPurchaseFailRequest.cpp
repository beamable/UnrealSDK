...
#include "PostWindowsPurchaseFailRequest.h"
...
UPostWindowsPurchaseFailRequest* UPostWindowsPurchaseFailRequest::MakePostWindowsPurchaseFailRequest(int64 _Txid, FString _Reason, UObject* Outer)
{
