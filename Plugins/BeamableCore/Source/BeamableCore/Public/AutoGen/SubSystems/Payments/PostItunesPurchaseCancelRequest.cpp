...
#include "PostItunesPurchaseCancelRequest.h"
...
UPostItunesPurchaseCancelRequest* UPostItunesPurchaseCancelRequest::MakePostItunesPurchaseCancelRequest(int64 _Txid, UObject* Outer)
{
