...
#include "PostTestPurchaseCompleteRequest.h"
...
UPostTestPurchaseCompleteRequest* UPostTestPurchaseCompleteRequest::MakePostTestPurchaseCompleteRequest(int64 _Txid, FString _Receipt, FString _PriceInLocalCurrency, FString _IsoCurrencySymbol, UObject* Outer)
{
	UPostTestPurchaseCompleteRequest* Req = NewObject<UPostTestPurchaseCompleteRequest>(Outer);
