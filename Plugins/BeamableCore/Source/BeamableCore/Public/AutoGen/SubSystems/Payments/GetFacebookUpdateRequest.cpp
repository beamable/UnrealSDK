...
#include "GetFacebookUpdateRequest.h"
...
UGetFacebookUpdateRequest* UGetFacebookUpdateRequest::MakeGetFacebookUpdateRequest(FString _HubMode, FString _HubChallenge, FString _HubVerifyToken, UObject* Outer)
{
