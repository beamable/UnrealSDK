...
#include "PostGoogleplayPurchaseVerifyRequest.h"
...
UPostGoogleplayPurchaseVerifyRequest* UPostGoogleplayPurchaseVerifyRequest::MakePostGoogleplayPurchaseVerifyRequest(FString _Receipt, UObject* Outer)
{
	UPostGoogleplayPurchaseVerifyRequest* Req = NewObject<UPostGoogleplayPurchaseVerifyRequest>(Outer);
