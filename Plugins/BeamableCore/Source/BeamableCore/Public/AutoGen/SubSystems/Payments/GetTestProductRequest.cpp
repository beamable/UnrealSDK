...
#include "GetTestProductRequest.h"
...
UGetTestProductRequest* UGetTestProductRequest::MakeGetTestProductRequest(FString _Sku, UObject* Outer)
{
	UGetTestProductRequest* Req = NewObject<UGetTestProductRequest>(Outer);
