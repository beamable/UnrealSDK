...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Payments", DisplayName="Beam - Make PostFacebookUpdate",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UPostFacebookUpdateRequest* Make(FString _Object, TArray<UFacebookUpdatedEntry*> _Entry, UObject* RequestOwner);
};
