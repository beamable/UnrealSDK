...
#include "PostTestPurchaseTrackRequest.h"
...
UPostTestPurchaseTrackRequest* UPostTestPurchaseTrackRequest::MakePostTestPurchaseTrackRequest(double _PriceInLocalCurrency, FString _SkuName, FString _SkuProductId, FString _Store, TArray<UItemCreateRequestBody*> _ObtainItems, TArray<UCurrencyChange*> _ObtainCurrency, FString _PurchaseId, FString _IsoCurrencySymbol, UObject* Outer)
{
