...
#include "PostTestPurchaseVerifyRequest.h"
...
UPostTestPurchaseVerifyRequest* UPostTestPurchaseVerifyRequest::MakePostTestPurchaseVerifyRequest(FString _Receipt, UObject* Outer)
{
	UPostTestPurchaseVerifyRequest* Req = NewObject<UPostTestPurchaseVerifyRequest>(Outer);
