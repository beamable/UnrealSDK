...
#include "PostItunesPurchaseFailRequest.h"
...
UPostItunesPurchaseFailRequest* UPostItunesPurchaseFailRequest::MakePostItunesPurchaseFailRequest(int64 _Txid, FString _Reason, UObject* Outer)
{
