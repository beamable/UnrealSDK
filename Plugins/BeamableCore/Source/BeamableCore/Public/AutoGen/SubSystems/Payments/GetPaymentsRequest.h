...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Payments", DisplayName="Beam - Make GetPayments",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetPaymentsRequest* Make(int64 _ObjectId, UObject* Outer);
};
