...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|GroupUsers|Backend", DisplayName="Make GetAvailability",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_Name,_Tag,_bSubGroup,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
