...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|GroupUsers", DisplayName="Beam - Make GetRecommended",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetRecommendedRequest* Make(int64 _ObjectId, UObject* Outer);
};
