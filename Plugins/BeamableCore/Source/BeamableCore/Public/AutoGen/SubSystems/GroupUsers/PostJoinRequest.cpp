...
UPostJoinRequest* UPostJoinRequest::MakePostJoinRequest(int64 _ObjectId, FOptionalInt64 _Successor, FOptionalInt64 _Score, FOptionalInt64 _SubGroup, EGroupType _Type, int64 _Group, UObject* Outer)
{
