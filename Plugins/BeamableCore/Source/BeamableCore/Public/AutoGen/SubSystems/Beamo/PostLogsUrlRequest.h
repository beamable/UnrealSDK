...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Beamo|Backend", DisplayName="Make PostLogsUrl",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_StartTime,_NextToken,_Filter,_EndTime,_Limit,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
