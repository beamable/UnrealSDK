...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Beamo", DisplayName="Beam - Make GetStorageConnection",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetStorageConnectionRequest* Make(UObject* Outer);
};
