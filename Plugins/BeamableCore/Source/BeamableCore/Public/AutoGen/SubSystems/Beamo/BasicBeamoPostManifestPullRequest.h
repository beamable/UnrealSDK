...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Beamo", DisplayName="Beam - Make BasicBeamoPostManifestPull",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="RequestOwner"))
	static UBasicBeamoPostManifestPullRequest* Make(FString _SourceRealmPid, UObject* RequestOwner);
};
