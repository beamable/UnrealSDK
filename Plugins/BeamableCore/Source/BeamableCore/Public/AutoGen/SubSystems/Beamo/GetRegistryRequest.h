...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Beamo", DisplayName="Beam - Make GetRegistry",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetRegistryRequest* Make(UObject* Outer);
};
