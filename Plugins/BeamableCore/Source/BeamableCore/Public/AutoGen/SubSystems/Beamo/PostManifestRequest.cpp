...
UPostManifestRequest* UPostManifestRequest::MakePostManifestRequest(TArray<UServiceReference*> _Manifest, FOptionalString _Comments, FOptionalBool _bAutoDeploy, FOptionalArrayOfServiceStorageReference _StorageReferences, UObject* Outer)
{
