...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Beamo|Backend", DisplayName="Make PostQueryLogs",  meta=(DefaultToSelf="RequestOwner", AdvancedDisplay="_StartTime,_Filter,_EndTime,_Order,_Limit,_Filters,RequestOwner", AutoCreateRefTerm="CustomHeaders"))
