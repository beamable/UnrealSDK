...
public:
	...
	UFUNCTION(BlueprintPure, BlueprintInternalUseOnly, Category="Beam|Backend|Beamo", DisplayName="Beam - Make GetUploadAPI",  meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer"))
	static UGetUploadAPIRequest* Make(UObject* Outer);
};
