...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|4 - Json", DisplayName="StatSubscriptionNotification To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Make StatSubscriptionNotification", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UStatSubscriptionNotification* Make(TMap<FString, FString> StatsBefore, TMap<FString, FString> StatsAfter, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Break StatSubscriptionNotification", meta=(NativeBreakFunc))
