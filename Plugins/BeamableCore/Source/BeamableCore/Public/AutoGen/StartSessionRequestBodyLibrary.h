...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|4 - Json", DisplayName="StartSessionRequestBody To JSON String")
	static FString StartSessionRequestBodyToJsonString(const UStartSessionRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Make StartSessionRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Source, Shard, Locale, Language, Time, Platform, Gamer, Device, CustomParams, DeviceParams, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Break StartSessionRequestBody", meta=(NativeBreakFunc))
