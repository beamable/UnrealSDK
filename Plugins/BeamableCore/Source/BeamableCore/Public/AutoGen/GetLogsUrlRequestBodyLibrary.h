...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="GetLogsUrlRequestBody To JSON String")
	static FString GetLogsUrlRequestBodyToJsonString(const UGetLogsUrlRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make GetLogsUrlRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="StartTime, NextToken, Filter, EndTime, Limit, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break GetLogsUrlRequestBody", meta=(NativeBreakFunc))
