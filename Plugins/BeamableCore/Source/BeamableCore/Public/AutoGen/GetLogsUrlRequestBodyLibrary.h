...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="GetLogsUrlRequestBody To JSON String")
	static FString GetLogsUrlRequestBodyToJsonString(const UGetLogsUrlRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make GetLogsUrlRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="StartTime, NextToken, Filter, EndTime, Limit, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break GetLogsUrlRequestBody", meta=(NativeBreakFunc))
