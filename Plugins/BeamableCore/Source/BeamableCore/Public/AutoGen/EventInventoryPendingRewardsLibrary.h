...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|4 - Json", DisplayName="EventInventoryPendingRewards To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Make EventInventoryPendingRewards", meta=(DefaultToSelf="Outer", AdvancedDisplay="Items, Currencies, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Break EventInventoryPendingRewards", meta=(NativeBreakFunc))
