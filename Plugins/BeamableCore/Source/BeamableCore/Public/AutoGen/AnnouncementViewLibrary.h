...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="AnnouncementView To JSON String")
	static FString AnnouncementViewToJsonString(const UAnnouncementView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make AnnouncementView", meta=(DefaultToSelf="Outer", AdvancedDisplay="EndDate, Gift, SecondsRemaining, StartDate, Tags, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break AnnouncementView", meta=(NativeBreakFunc))
