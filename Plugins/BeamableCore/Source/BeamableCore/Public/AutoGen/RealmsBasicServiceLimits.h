...
#include "RealmsBasicServiceLimits.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API URealmsBasicServiceLimits : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, DisplayName="Beamo", Category="Beam")
	FOptionalRealmsBasicBeamoLimits Beamo = {};
