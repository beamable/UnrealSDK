...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Json", DisplayName="Beam - EventPlayerStateView To JSON String")
	static FString EventPlayerStateViewToJsonString(const UEventPlayerStateView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make EventPlayerStateView", meta=(DefaultToSelf="Outer", AdvancedDisplay="CurrentPhase, GroupRewards, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break EventPlayerStateView", meta=(NativeBreakFunc))
