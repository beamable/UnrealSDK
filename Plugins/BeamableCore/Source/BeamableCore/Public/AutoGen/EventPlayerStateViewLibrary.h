...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|4 - Json", DisplayName="EventPlayerStateView To JSON String")
	static FString EventPlayerStateViewToJsonString(const UEventPlayerStateView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Make EventPlayerStateView", meta=(DefaultToSelf="Outer", AdvancedDisplay="CurrentPhase, GroupRewards, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Break EventPlayerStateView", meta=(NativeBreakFunc))
