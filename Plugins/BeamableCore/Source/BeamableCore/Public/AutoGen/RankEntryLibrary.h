...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="RankEntry To JSON String")
	static FString RankEntryToJsonString(const URankEntry* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make RankEntry", meta=(DefaultToSelf="Outer", AdvancedDisplay="Score, Stats, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break RankEntry", meta=(NativeBreakFunc))
