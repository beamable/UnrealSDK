...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Stats|4 - Json", DisplayName="BatchReadStatsRequestBody To JSON String")
	static FString BatchReadStatsRequestBodyToJsonString(const UBatchReadStatsRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Stats|3 - Backend", DisplayName="Make BatchReadStatsRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Stats, Format, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Stats|3 - Backend", DisplayName="Break BatchReadStatsRequestBody", meta=(NativeBreakFunc))
