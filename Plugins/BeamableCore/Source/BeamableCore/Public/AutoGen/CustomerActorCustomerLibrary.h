...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make CustomerActorCustomer", meta=(DefaultToSelf="Outer", AdvancedDisplay="Alias, PaymentStatus, ActivationStatus, Contact, Created, Updated, Realms, Accounts, Config, Outer", NativeMakeFunc))
	static UCustomerActorCustomer* Make(int64 CustomerId, FString Name, FOptionalString Alias, FOptionalPaymentStatus PaymentStatus, FOptionalActivationStatus ActivationStatus, FOptionalString Contact, FOptionalDateTime Created, FOptionalDateTime Updated, FOptionalArrayOfRealm Realms, FOptionalArrayOfCustomerActorAccount Accounts, FOptionalMapOfString Config, UObject* Outer);
