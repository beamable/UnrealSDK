...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|4 - Json", DisplayName="EventDateRanges To JSON String")
	static FString EventDateRangesToJsonString(const UEventDateRanges* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Make EventDateRanges", meta=(DefaultToSelf="Outer", AdvancedDisplay="CreatedAt, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Break EventDateRanges", meta=(NativeBreakFunc))
