...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make LeaderboardListRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Skip, Limit, Prefix, Outer", NativeMakeFunc))
	static ULeaderboardListRequestBody* Make(FOptionalInt32 Skip, FOptionalInt32 Limit, FOptionalString Prefix, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break LeaderboardListRequestBody", meta=(NativeBreakFunc))
	static void Break(const ULeaderboardListRequestBody* Serializable, FOptionalInt32& Skip, FOptionalInt32& Limit, FOptionalString& Prefix);
};