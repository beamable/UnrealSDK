...
#include "VerifyReceiptRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UVerifyReceiptRequestBody : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
