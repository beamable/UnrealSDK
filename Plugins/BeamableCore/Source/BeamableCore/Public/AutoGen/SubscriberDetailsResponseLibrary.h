...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Notification|4 - Json", DisplayName="SubscriberDetailsResponse To JSON String")
	static FString SubscriberDetailsResponseToJsonString(const USubscriberDetailsResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Notification|3 - Backend", DisplayName="Make SubscriberDetailsResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="GameGlobalNotificationChannel, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Notification|3 - Backend", DisplayName="Break SubscriberDetailsResponse", meta=(NativeBreakFunc))
