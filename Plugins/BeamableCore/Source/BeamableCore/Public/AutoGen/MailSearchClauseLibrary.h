...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="MailSearchClause To JSON String")
	static FString MailSearchClauseToJsonString(const UMailSearchClause* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make MailSearchClause", meta=(DefaultToSelf="Outer", AdvancedDisplay="ForSender, Start, Limit, Categories, States, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break MailSearchClause", meta=(NativeBreakFunc))
