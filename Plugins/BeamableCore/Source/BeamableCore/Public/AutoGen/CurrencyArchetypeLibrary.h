...
public:
	...
	static UCurrencyArchetype* Make(FString Symbol, FOptionalArchetypeProxy External, FOptionalClientPermission ClientPermission, FOptionalInt64 StartingAmount, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break CurrencyArchetype", meta=(NativeBreakFunc))
	static void Break(const UCurrencyArchetype* Serializable, FString& Symbol, FOptionalArchetypeProxy& External, FOptionalClientPermission& ClientPermission, FOptionalInt64& StartingAmount);
};