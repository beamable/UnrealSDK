...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Project To JSON String")
	static FString ProjectToJsonString(const UProject* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Project", meta=(DefaultToSelf="Outer", AdvancedDisplay="bSharded, bSigval, DisplayName, Parent, Status, Created, Children, Config, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Project", meta=(NativeBreakFunc))
