...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|4 - Json", DisplayName="GetGroupsRequestBody To JSON String")
	static FString GetGroupsRequestBodyToJsonString(const UGetGroupsRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Make GetGroupsRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Max, Focus, Cycle, From, ContentId, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Break GetGroupsRequestBody", meta=(NativeBreakFunc))
