...
public:
	...
	static UNewCustomerResponse* Make(FString Name, FString ProjectName, int64 Cid, FString Pid, UTokenResponse* Token, FOptionalString Alias, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break NewCustomerResponse", meta=(NativeBreakFunc))
	static void Break(const UNewCustomerResponse* Serializable, FString& Name, FString& ProjectName, int64& Cid, FString& Pid, UTokenResponse*& Token, FOptionalString& Alias);
};