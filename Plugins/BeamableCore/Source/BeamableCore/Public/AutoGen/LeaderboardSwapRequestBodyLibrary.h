...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="LeaderboardSwapRequestBody To JSON String")
	static FString LeaderboardSwapRequestBodyToJsonString(const ULeaderboardSwapRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make LeaderboardSwapRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="WinnerId, LoserId, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break LeaderboardSwapRequestBody", meta=(NativeBreakFunc))
