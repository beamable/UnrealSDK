...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="UpdatePlayerStatusRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make UpdatePlayerStatusRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UUpdatePlayerStatusRequestBody* Make(int64 PlayerId, FString TournamentId, UPlayerStatusUpdate* Update, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break UpdatePlayerStatusRequestBody", meta=(NativeBreakFunc))
