...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Customer To JSON String")
	static FString CustomerToJsonString(const UCustomer* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Customer", meta=(DefaultToSelf="Outer", AdvancedDisplay="ActivationStatus, PaymentStatus, Image, Contact, Alias, Updated, CrmLink, Created, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Customer", meta=(NativeBreakFunc))
