...
public:
	...
	static UCustomer* Make(FString Name, int64 Cid, TArray<UProject*> Projects, TArray<URealmsBasicAccount*> Accounts, FOptionalString PaymentStatus, FOptionalString Image, FOptionalString Contact, FOptionalString Alias, FOptionalInt64 Updated, FOptionalString CrmLink, FOptionalInt64 Created, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break Customer", meta=(NativeBreakFunc))
	static void Break(const UCustomer* Serializable, FString& Name, int64& Cid, TArray<UProject*>& Projects, TArray<URealmsBasicAccount*>& Accounts, FOptionalString& PaymentStatus, FOptionalString& Image, FOptionalString& Contact, FOptionalString& Alias, FOptionalInt64& Updated, FOptionalString& CrmLink, FOptionalInt64& Created);
};