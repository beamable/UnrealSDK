...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="CreateProjectRequestBody To JSON String")
	static FString CreateProjectRequestBodyToJsonString(const UCreateProjectRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make CreateProjectRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bSharded, Plan, Parent, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break CreateProjectRequestBody", meta=(NativeBreakFunc))
