...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Realms|4 - Json", DisplayName="CreateProjectRequestBody To JSON String")
	static FString CreateProjectRequestBodyToJsonString(const UCreateProjectRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Realms|3 - Backend", DisplayName="Make CreateProjectRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bSharded, Plan, Parent, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Realms|3 - Backend", DisplayName="Break CreateProjectRequestBody", meta=(NativeBreakFunc))
