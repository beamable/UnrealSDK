...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="GetStatusResponse To JSON String")
	static FString GetStatusResponseToJsonString(const UGetStatusResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make GetStatusResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="StorageStatuses, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break GetStatusResponse", meta=(NativeBreakFunc))
