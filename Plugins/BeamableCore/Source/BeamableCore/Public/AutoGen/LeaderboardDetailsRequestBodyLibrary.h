...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="LeaderboardDetailsRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make LeaderboardDetailsRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="From, Max, Outer", NativeMakeFunc))
	static ULeaderboardDetailsRequestBody* Make(FOptionalInt32 From, FOptionalInt32 Max, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break LeaderboardDetailsRequestBody", meta=(NativeBreakFunc))
