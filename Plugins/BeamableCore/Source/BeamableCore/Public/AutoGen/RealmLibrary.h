...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make Realm", meta=(DefaultToSelf="Outer", AdvancedDisplay="bHidden, bIsArchived, bSharded, Secret, DisplayName, Parent, Created, Children, Config, CustomCharts, Outer", NativeMakeFunc))
	static URealm* Make(FString Name, FString Plan, FOptionalBool bHidden, FOptionalBool bIsArchived, FOptionalBool bSharded, FOptionalString Secret, FOptionalString DisplayName, FOptionalString Parent, FOptionalDateTime Created, FOptionalArrayOfString Children, FOptionalMapOfString Config, FOptionalMapOfString CustomCharts, UObject* Outer);
