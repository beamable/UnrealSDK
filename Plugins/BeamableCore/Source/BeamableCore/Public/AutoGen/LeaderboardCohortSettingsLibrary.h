...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|4 - Json", DisplayName="LeaderboardCohortSettings To JSON String")
	static FString LeaderboardCohortSettingsToJsonString(const ULeaderboardCohortSettings* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Make LeaderboardCohortSettings", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static ULeaderboardCohortSettings* Make(TArray<ULeaderboardCohort*> Cohorts, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Break LeaderboardCohortSettings", meta=(NativeBreakFunc))
