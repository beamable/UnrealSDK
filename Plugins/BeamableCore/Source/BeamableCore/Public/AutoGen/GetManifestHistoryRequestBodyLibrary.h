...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Content|4 - Json", DisplayName="GetManifestHistoryRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Make GetManifestHistoryRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Id, Limit, Outer", NativeMakeFunc))
	static UGetManifestHistoryRequestBody* Make(FOptionalBeamContentManifestId Id, FOptionalInt32 Limit, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Content|3 - Backend", DisplayName="Break GetManifestHistoryRequestBody", meta=(NativeBreakFunc))
