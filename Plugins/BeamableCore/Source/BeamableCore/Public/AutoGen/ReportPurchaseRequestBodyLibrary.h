...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|4 - Json", DisplayName="ReportPurchaseRequestBody To JSON String")
	static FString ReportPurchaseRequestBodyToJsonString(const UReportPurchaseRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Make ReportPurchaseRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bFree, Outer", NativeMakeFunc))
	static UReportPurchaseRequestBody* Make(FString ListingId, FOptionalBool bFree, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Commerce|3 - Backend", DisplayName="Break ReportPurchaseRequestBody", meta=(NativeBreakFunc))
