...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Auth|4 - Json", DisplayName="PasswordAuthRequestBody To JSON String")
	static FString PasswordAuthRequestBodyToJsonString(const UPasswordAuthRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Auth|3 - Backend", DisplayName="Make PasswordAuthRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Email, Password, Scope, CustomerId, RealmId, Context, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Auth|3 - Backend", DisplayName="Break PasswordAuthRequestBody", meta=(NativeBreakFunc))
