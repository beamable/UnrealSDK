...
public:		
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "PresenceStatus To Serialization Name", CompactNodeTitle = "->"), Category="Beam|Shared|Enums")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Serialization Name To PresenceStatus", CompactNodeTitle = "->"), Category="Beam|Shared|Enums")
