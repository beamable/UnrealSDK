...
UENUM(BlueprintType, Category="Beam|Presence|Enums")
...
UCLASS(BlueprintType, Category="Beam|Presence|Enums")
class BEAMABLECORE_API UPresenceStatusLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:		
	
	UFUNCTION(BlueprintPure, meta = (DisplayName="PresenceStatus To Serialization Name", CompactNodeTitle = "->"), Category="Beam|Presence|Enums")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName="Serialization Name To PresenceStatus", CompactNodeTitle = "->"), Category="Beam|Presence|Enums")
