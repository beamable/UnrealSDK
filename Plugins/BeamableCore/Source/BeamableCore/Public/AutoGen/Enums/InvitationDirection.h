...
UCLASS(BlueprintType, Category="Beam|Friends|Utils|Enums")
class BEAMABLECORE_API UInvitationDirectionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:		
	
	UFUNCTION(BlueprintPure, meta = (DisplayName="InvitationDirection To Serialization Name", CompactNodeTitle = "->"), Category="Beam|Friends|Utils|Enums")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName="Serialization Name To InvitationDirection", CompactNodeTitle = "->"), Category="Beam|Friends|Utils|Enums")
