...
public:		
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "LobbyRestriction To Serialization Name", CompactNodeTitle = "->"), Category="Beam|Shared|Enums")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Serialization Name To LobbyRestriction", CompactNodeTitle = "->"), Category="Beam|Shared|Enums")
