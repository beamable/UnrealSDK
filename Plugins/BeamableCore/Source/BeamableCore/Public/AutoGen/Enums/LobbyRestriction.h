...
UENUM(BlueprintType, Category="Beam|Lobby|Enums")
...
UCLASS(BlueprintType, Category="Beam|Lobby|Enums")
class BEAMABLECORE_API ULobbyRestrictionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:		
	
	UFUNCTION(BlueprintPure, meta = (DisplayName="LobbyRestriction To Serialization Name", CompactNodeTitle = "->"), Category="Beam|Lobby|Enums")
	...
	UFUNCTION(BlueprintPure, meta = (DisplayName="Serialization Name To LobbyRestriction", CompactNodeTitle = "->"), Category="Beam|Lobby|Enums")
