...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make CreateRealmRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bIsHidden, bSharded, Plan, Parent, Outer", NativeMakeFunc))
	static UCreateRealmRequestBody* Make(FString Name, FOptionalBool bIsHidden, FOptionalBool bSharded, FOptionalString Plan, FOptionalString Parent, UObject* Outer);
	...
	static void Break(const UCreateRealmRequestBody* Serializable, FString& Name, FOptionalBool& bIsHidden, FOptionalBool& bSharded, FOptionalString& Plan, FOptionalString& Parent);
};