...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|4 - Json", DisplayName="ObjectsMetadataResponse To JSON String")
	static FString ObjectsMetadataResponseToJsonString(const UObjectsMetadataResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Make ObjectsMetadataResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UObjectsMetadataResponse* Make(TArray<UObjectMetadataResponse*> Response, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Break ObjectsMetadataResponse", meta=(NativeBreakFunc))
