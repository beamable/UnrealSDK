...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|4 - Json", DisplayName="EventsWithinDateRangeRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Make EventsWithinDateRangeRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="From, To, Query, Limit, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Break EventsWithinDateRangeRequestBody", meta=(NativeBreakFunc))
