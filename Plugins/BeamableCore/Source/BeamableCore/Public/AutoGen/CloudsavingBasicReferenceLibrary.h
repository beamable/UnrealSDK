...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|4 - Json", DisplayName="CloudsavingBasicReference To JSON String")
	static FString CloudsavingBasicReferenceToJsonString(const UCloudsavingBasicReference* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Make CloudsavingBasicReference", meta=(DefaultToSelf="Outer", AdvancedDisplay="ETag, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Break CloudsavingBasicReference", meta=(NativeBreakFunc))
