...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="GetSignedUrlResponse To JSON String")
	static FString GetSignedUrlResponseToJsonString(const UGetSignedUrlResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make GetSignedUrlResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UGetSignedUrlResponse* Make(FString Url, FString Body, FString Method, TArray<UGetLogsUrlHeader*> Headers, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break GetSignedUrlResponse", meta=(NativeBreakFunc))
