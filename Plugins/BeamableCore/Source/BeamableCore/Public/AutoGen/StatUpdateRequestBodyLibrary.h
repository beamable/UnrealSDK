...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Stats|4 - Json", DisplayName="StatUpdateRequestBody To JSON String")
	static FString StatUpdateRequestBodyToJsonString(const UStatUpdateRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Stats|3 - Backend", DisplayName="Make StatUpdateRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bEmitAnalytics, ObjectId, Set, Add, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Stats|3 - Backend", DisplayName="Break StatUpdateRequestBody", meta=(NativeBreakFunc))
