...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Json", DisplayName="Beam - CreateLaunchMessageRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make CreateLaunchMessageRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UCreateLaunchMessageRequestBody* Make(FString Name, FString Body, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break CreateLaunchMessageRequestBody", meta=(NativeBreakFunc))
