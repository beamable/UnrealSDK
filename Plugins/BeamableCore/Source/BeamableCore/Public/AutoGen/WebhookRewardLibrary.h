...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|4 - Json", DisplayName="WebhookReward To JSON String")
	static FString WebhookRewardToJsonString(const UWebhookReward* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Make WebhookReward", meta=(DefaultToSelf="Outer", AdvancedDisplay="WebhookSymbol, WebHookComet, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Break WebhookReward", meta=(NativeBreakFunc))
