...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="WebhookReward To JSON String")
	static FString WebhookRewardToJsonString(const UWebhookReward* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make WebhookReward", meta=(DefaultToSelf="Outer", AdvancedDisplay="WebhookSymbol, WebHookComet, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break WebhookReward", meta=(NativeBreakFunc))
