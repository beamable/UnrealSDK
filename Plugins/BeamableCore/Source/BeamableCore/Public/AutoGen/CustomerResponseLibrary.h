...
public:
	...
	static UCustomerResponse* Make(URealmsBasicCustomer* Customer, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Realms|Utils|Make/Break", DisplayName="Break CustomerResponse", meta=(NativeBreakFunc))
	static void Break(const UCustomerResponse* Serializable, URealmsBasicCustomer*& Customer);
};