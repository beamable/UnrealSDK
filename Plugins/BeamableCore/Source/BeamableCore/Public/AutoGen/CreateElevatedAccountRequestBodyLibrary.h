...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="CreateElevatedAccountRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make CreateElevatedAccountRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Role, InitProperties, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break CreateElevatedAccountRequestBody", meta=(NativeBreakFunc))
