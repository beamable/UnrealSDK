...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|Utils|Make/Break", DisplayName="Make BeamoV2LogContextRuleAuthor", meta=(DefaultToSelf="Outer", AdvancedDisplay="Email, Outer", NativeMakeFunc))
	static UBeamoV2LogContextRuleAuthor* Make(FString AccountId, FOptionalString Email, UObject* Outer);
	...
	static void Break(const UBeamoV2LogContextRuleAuthor* Serializable, FString& AccountId, FOptionalString& Email);
};