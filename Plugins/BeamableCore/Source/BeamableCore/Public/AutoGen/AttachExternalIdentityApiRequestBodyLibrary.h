...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|4 - Json", DisplayName="AttachExternalIdentityApiRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Make AttachExternalIdentityApiRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="ChallengeSolution, ProviderNamespace, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Break AttachExternalIdentityApiRequestBody", meta=(NativeBreakFunc))
