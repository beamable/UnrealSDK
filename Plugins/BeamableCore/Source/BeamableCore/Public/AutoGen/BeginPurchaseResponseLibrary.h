...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|4 - Json", DisplayName="BeginPurchaseResponse To JSON String")
	static FString BeginPurchaseResponseToJsonString(const UBeginPurchaseResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Make BeginPurchaseResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="AccessToken, Outer", NativeMakeFunc))
	static UBeginPurchaseResponse* Make(int64 Txid, FOptionalString AccessToken, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Break BeginPurchaseResponse", meta=(NativeBreakFunc))
