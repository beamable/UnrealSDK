...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Stats|4 - Json", DisplayName="NetworkSerializable To JSON String")
	static FString NetworkSerializableToJsonString(const UNetworkSerializable* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Stats|3 - Backend", DisplayName="Make NetworkSerializable", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
