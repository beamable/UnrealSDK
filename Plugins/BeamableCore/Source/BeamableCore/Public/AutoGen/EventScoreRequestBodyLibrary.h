...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="EventScoreRequestBody To JSON String")
	static FString EventScoreRequestBodyToJsonString(const UEventScoreRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make EventScoreRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bIncrement, Stats, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break EventScoreRequestBody", meta=(NativeBreakFunc))
