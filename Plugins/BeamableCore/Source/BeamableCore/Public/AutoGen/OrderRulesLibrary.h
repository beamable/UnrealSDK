...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="OrderRules To JSON String")
	static FString OrderRulesToJsonString(const UOrderRules* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make OrderRules", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UOrderRules* Make(TArray<UOrderRule*> Orules, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break OrderRules", meta=(NativeBreakFunc))
