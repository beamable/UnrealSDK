...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Mail|4 - Json", DisplayName="Message To JSON String")
	static FString MessageToJsonString(const UMessage* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Mail|3 - Backend", DisplayName="Make Message", meta=(DefaultToSelf="Outer", AdvancedDisplay="Body, Expires, PlayerRewards, Subject, Rewards, BodyRef, ClaimedTimeMs, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Mail|3 - Backend", DisplayName="Break Message", meta=(NativeBreakFunc))
