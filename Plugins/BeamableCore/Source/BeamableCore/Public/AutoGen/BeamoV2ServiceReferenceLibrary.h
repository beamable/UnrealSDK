...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|Utils|Make/Break", DisplayName="Make BeamoV2ServiceReference", meta=(DefaultToSelf="Outer", AdvancedDisplay="bArchived, bEnabled, ServiceName, ImageId, TemplateId, Comments, ContainerHealthCheckPort, ImageCpuArch, LogProvider, Checksum, Dependencies, Components, Outer", NativeMakeFunc))
