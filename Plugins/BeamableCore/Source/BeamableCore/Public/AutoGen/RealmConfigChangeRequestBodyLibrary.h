...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Json", DisplayName="RealmConfigChangeRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Make/Break", DisplayName="Make RealmConfigChangeRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Deletes, Upserts, Outer", NativeMakeFunc))
	static URealmConfigChangeRequestBody* Make(FOptionalArrayOfString Deletes, FOptionalMapOfString Upserts, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Customer|Utils|Make/Break", DisplayName="Break RealmConfigChangeRequestBody", meta=(NativeBreakFunc))
