...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="ProjectView To JSON String")
	static FString ProjectViewToJsonString(const UProjectView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make ProjectView", meta=(DefaultToSelf="Outer", AdvancedDisplay="bArchived, bSharded, Secret, Parent, Cid, Children, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break ProjectView", meta=(NativeBreakFunc))
