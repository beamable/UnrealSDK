...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Realms|4 - Json", DisplayName="NewCustomerRequestBody To JSON String")
	static FString NewCustomerRequestBodyToJsonString(const UNewCustomerRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Realms|3 - Backend", DisplayName="Make NewCustomerRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bHierarchy, CustomerName, Alias, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Realms|3 - Backend", DisplayName="Break NewCustomerRequestBody", meta=(NativeBreakFunc))
