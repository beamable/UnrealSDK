...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="AnnouncementContent To JSON String")
	static FString AnnouncementContentToJsonString(const UAnnouncementContent* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make AnnouncementContent", meta=(DefaultToSelf="Outer", AdvancedDisplay="StartDate, Gift, EndDate, Tags, StatRequirements, Attachments, ClientData, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break AnnouncementContent", meta=(NativeBreakFunc))
