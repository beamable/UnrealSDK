...
#include "SignedRequestBody.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API USignedRequestBody : public UObject, public IBeamJsonSerializableUObject, public IBeamBaseResponseBodyInterface
{
	GENERATED_BODY()
...
public:
	...
	FOptionalArrayOfStringStringKeyValuePair Headers = {};
