...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|4 - Json", DisplayName="GroupStatus To JSON String")
	static FString GroupStatusToJsonString(const UGroupStatus* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Make GroupStatus", meta=(DefaultToSelf="Outer", AdvancedDisplay="Completed, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Break GroupStatus", meta=(NativeBreakFunc))
