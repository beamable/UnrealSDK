...
class BEAMABLECORE_API UManifestChecksums : public UObject, public IBeamJsonSerializableUObject, public IBeamBaseResponseBodyInterface
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, DisplayName="Manifests", Category="Beam")
	TArray<UContentBasicManifestChecksum*> Manifests = {};
