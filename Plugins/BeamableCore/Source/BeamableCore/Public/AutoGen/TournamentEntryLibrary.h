...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make TournamentEntry", meta=(DefaultToSelf="Outer", AdvancedDisplay="PreviousStageChange, NextStageChange, Outer", NativeMakeFunc))
