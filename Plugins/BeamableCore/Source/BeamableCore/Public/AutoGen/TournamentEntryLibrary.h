...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="TournamentEntry To JSON String")
	static FString TournamentEntryToJsonString(const UTournamentEntry* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make TournamentEntry", meta=(DefaultToSelf="Outer", AdvancedDisplay="PreviousStageChange, NextStageChange, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break TournamentEntry", meta=(NativeBreakFunc))
