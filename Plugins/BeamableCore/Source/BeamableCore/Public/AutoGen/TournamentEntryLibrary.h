...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|4 - Json", DisplayName="TournamentEntry To JSON String")
	static FString TournamentEntryToJsonString(const UTournamentEntry* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Make TournamentEntry", meta=(DefaultToSelf="Outer", AdvancedDisplay="PreviousStageChange, NextStageChange, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Break TournamentEntry", meta=(NativeBreakFunc))
