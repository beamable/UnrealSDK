...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="LeaderBoardView To JSON String")
	static FString LeaderBoardViewToJsonString(const ULeaderBoardView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make LeaderBoardView", meta=(DefaultToSelf="Outer", AdvancedDisplay="Rankgt, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break LeaderBoardView", meta=(NativeBreakFunc))
