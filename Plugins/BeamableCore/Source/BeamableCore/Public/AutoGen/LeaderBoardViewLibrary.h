...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="LeaderBoardView To JSON String")
	static FString LeaderBoardViewToJsonString(const ULeaderBoardView* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make LeaderBoardView", meta=(DefaultToSelf="Outer", AdvancedDisplay="Rankgt, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break LeaderBoardView", meta=(NativeBreakFunc))
