...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|4 - Json", DisplayName="TournamentQueryRequestBody To JSON String")
	static FString TournamentQueryRequestBodyToJsonString(const UTournamentQueryRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Make TournamentQueryRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="bIsRunning, ContentId, Cycle, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|3 - Backend", DisplayName="Break TournamentQueryRequestBody", meta=(NativeBreakFunc))
