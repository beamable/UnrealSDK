...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Session|4 - Json", DisplayName="SessionLanguageContext To JSON String")
	static FString SessionLanguageContextToJsonString(const USessionLanguageContext* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Make SessionLanguageContext", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static USessionLanguageContext* Make(FString Code, FString Ctx, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Session|3 - Backend", DisplayName="Break SessionLanguageContext", meta=(NativeBreakFunc))
