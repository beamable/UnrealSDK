...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="SessionLanguageContext To JSON String")
	static FString SessionLanguageContextToJsonString(const USessionLanguageContext* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make SessionLanguageContext", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static USessionLanguageContext* Make(FString Code, FString Ctx, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break SessionLanguageContext", meta=(NativeBreakFunc))
