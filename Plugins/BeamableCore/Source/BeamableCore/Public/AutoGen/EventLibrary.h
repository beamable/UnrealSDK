...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|4 - Json", DisplayName="Event To JSON String")
	static FString EventToJsonString(const UEvent* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Make Event", meta=(DefaultToSelf="Outer", AdvancedDisplay="PartitionSize, GroupRewards, CohortSettings, Permissions, Schedule, Stores, ScoreRewards, RankRewards, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Events|3 - Backend", DisplayName="Break Event", meta=(NativeBreakFunc))
