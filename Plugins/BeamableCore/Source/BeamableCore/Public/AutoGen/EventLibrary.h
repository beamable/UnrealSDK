...
public:
	...
	static UEvent* Make(FString Name, FString StartDate, FString Symbol, TArray<UEventPhase*> Phases, FOptionalInt32 PartitionSize, FOptionalEventGroupRewards GroupRewards, FOptionalLeaderboardCohortSettings CohortSettings, FOptionalClientPermission Permissions, FOptionalSchedule Schedule, FOptionalArrayOfString Stores, FOptionalArrayOfEventRewardContent ScoreRewards, FOptionalArrayOfEventRewardContent RankRewards, UObject* Outer);
