...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Event To JSON String")
	static FString EventToJsonString(const UEvent* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Event", meta=(DefaultToSelf="Outer", AdvancedDisplay="PartitionSize, GroupRewards, CohortSettings, Permissions, Schedule, Stores, ScoreRewards, RankRewards, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Event", meta=(NativeBreakFunc))
