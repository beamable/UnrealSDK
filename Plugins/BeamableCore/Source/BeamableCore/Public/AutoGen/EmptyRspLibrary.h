...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Push|4 - Json", DisplayName="EmptyRsp To JSON String")
	static FString EmptyRspToJsonString(const UEmptyRsp* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Push|3 - Backend", DisplayName="Make EmptyRsp", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
