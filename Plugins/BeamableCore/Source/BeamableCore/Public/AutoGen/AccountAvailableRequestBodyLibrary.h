...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Accounts|4 - Json", DisplayName="AccountAvailableRequestBody To JSON String")
	static FString AccountAvailableRequestBodyToJsonString(const UAccountAvailableRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Make AccountAvailableRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UAccountAvailableRequestBody* Make(FString Email, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Accounts|3 - Backend", DisplayName="Break AccountAvailableRequestBody", meta=(NativeBreakFunc))
