...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|4 - Json", DisplayName="PlayerBasicCloudDataRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Make PlayerBasicCloudDataRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="PlayerId, Outer", NativeMakeFunc))
	static UPlayerBasicCloudDataRequestBody* Make(FOptionalInt64 PlayerId, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|3 - Backend", DisplayName="Break PlayerBasicCloudDataRequestBody", meta=(NativeBreakFunc))
