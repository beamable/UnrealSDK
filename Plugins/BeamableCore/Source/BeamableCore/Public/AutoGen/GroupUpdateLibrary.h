...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="GroupUpdate To JSON String")
	static FString GroupUpdateToJsonString(const UGroupUpdate* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make GroupUpdate", meta=(DefaultToSelf="Outer", AdvancedDisplay="Name, EnrollmentType, Tag, Slogan, Requirement, Motd, ClientData, SubGroup, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break GroupUpdate", meta=(NativeBreakFunc))
