...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="PlayerReward To JSON String")
	static FString PlayerRewardToJsonString(const UPlayerReward* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make PlayerReward", meta=(DefaultToSelf="Outer", AdvancedDisplay="bApplyVipBonus, Description, ChangeCurrencies, CallWebhooks, AddItems, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break PlayerReward", meta=(NativeBreakFunc))
