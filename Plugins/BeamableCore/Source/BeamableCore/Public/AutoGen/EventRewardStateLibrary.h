...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|4 - Json", DisplayName="EventRewardState To JSON String")
	static FString EventRewardStateToJsonString(const UEventRewardState* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Make EventRewardState", meta=(DefaultToSelf="Outer", AdvancedDisplay="Max, Currencies, PendingItemRewards, Items, Obtain, PendingCurrencyRewards, PendingEntitlementRewards, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|3 - Backend", DisplayName="Break EventRewardState", meta=(NativeBreakFunc))
