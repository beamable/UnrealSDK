...
#include "AccountsObjectInFlightMessage.generated.h"

UCLASS(BlueprintType, Category="Beam", DefaultToInstanced, EditInlineNew)
class BEAMABLECORE_API UAccountsObjectInFlightMessage : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
