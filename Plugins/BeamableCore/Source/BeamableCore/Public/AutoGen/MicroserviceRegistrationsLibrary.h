...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="MicroserviceRegistrations To JSON String")
	static FString MicroserviceRegistrationsToJsonString(const UMicroserviceRegistrations* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make MicroserviceRegistrations", meta=(DefaultToSelf="Outer", AdvancedDisplay="bTrafficFilterEnabled, RoutingKey, StartedById, BeamoName, Federation, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break MicroserviceRegistrations", meta=(NativeBreakFunc))
