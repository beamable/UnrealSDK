...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalSendNotificationLibrary.MakeOptionalSendNotification"))
struct FOptionalSendNotification : public FBeamOptional
{
	GENERATED_BODY()
