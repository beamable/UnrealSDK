...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Make Optional TArray<UItemUpdateRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta = (DisplayName="TArray<UItemUpdateRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UItemUpdateRequestBody*> Value"))
