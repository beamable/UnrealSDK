...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfDonationRequestBodyLibrary.MakeOptional", BeamOptionalType="TArray<UDonationRequestBody*>"))
