...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalMailObjectMessageLibrary.MakeOptional"))
struct BEAMABLECORE_API FOptionalMailObjectMessage : public FBeamOptional
{
	GENERATED_BODY()
