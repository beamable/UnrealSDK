...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Make Optional BeamTag", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta = (DisplayName="BeamTag To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Get Optional's BeamTag Value"))
