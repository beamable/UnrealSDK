...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Make Optional Schedule", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta = (DisplayName="Schedule To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Get Optional's Schedule Value"))
