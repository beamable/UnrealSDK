...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta=(DisplayName="Make Optional TArray<UServiceDependencyReference*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta = (DisplayName="TArray<UServiceDependencyReference*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UServiceDependencyReference*> Value"))
