...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta=(DisplayName="Make Optional TArray<UPartyInvitation*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta = (DisplayName="TArray<UPartyInvitation*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Party|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UPartyInvitation*> Value"))
