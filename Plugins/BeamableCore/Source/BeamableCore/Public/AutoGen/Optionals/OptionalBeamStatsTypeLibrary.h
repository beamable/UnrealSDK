...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta=(DisplayName="Make Optional BeamStatsType", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta = (DisplayName="BeamStatsType To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta=(DisplayName="Get Optional's BeamStatsType Value"))
