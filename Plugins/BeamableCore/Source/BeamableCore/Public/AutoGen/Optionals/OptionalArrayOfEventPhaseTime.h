...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventPhaseTimeLibrary.MakeOptionalArrayOfEventPhaseTime"))
struct FOptionalArrayOfEventPhaseTime : public FBeamOptional
{
	GENERATED_BODY()
