...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Make Optional TMap<FString, FArrayOfCurrencyProperty>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta = (DisplayName="TMap<FString, FArrayOfCurrencyProperty> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Get Optional's TMap<FString, FArrayOfCurrencyProperty> Value"))
