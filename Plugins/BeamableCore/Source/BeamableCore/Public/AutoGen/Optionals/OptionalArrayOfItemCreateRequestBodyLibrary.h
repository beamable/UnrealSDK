...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Make Optional TArray<UItemCreateRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta = (DisplayName="TArray<UItemCreateRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UItemCreateRequestBody*> Value"))
