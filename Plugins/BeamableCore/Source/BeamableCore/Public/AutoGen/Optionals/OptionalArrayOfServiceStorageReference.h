...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfServiceStorageReferenceLibrary.MakeOptional", BeamOptionalType="TArray<UServiceStorageReference*>"))
