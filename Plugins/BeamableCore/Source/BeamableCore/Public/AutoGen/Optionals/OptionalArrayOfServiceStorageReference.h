...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfServiceStorageReferenceLibrary.MakeOptionalArrayOfServiceStorageReference"))
struct FOptionalArrayOfServiceStorageReference : public FBeamOptional
{
	GENERATED_BODY()
