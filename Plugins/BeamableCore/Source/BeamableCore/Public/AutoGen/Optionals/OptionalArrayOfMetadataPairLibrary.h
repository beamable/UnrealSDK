...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta=(DisplayName="Make Optional TArray<UMetadataPair*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta = (DisplayName="TArray<UMetadataPair*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UMetadataPair*> Value"))
