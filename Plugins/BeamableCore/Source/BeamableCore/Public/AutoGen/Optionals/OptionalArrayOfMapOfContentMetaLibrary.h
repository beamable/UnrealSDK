...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta=(DisplayName="Make Optional TArray<FMapOfContentMeta>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta = (DisplayName="TArray<FMapOfContentMeta> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Content|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta=(DisplayName="Get Optional's TArray<FMapOfContentMeta> Value"))
