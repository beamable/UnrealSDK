...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfAnnouncementAttachmentLibrary.MakeOptional", BeamOptionalType="TArray<UAnnouncementAttachment*>"))
