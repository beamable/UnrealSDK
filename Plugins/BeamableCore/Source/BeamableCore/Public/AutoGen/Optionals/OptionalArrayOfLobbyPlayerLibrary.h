...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Make Optional TArray<ULobbyPlayer*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta = (DisplayName="TArray<ULobbyPlayer*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Get Optional's TArray<ULobbyPlayer*> Value"))
