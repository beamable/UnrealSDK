...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Notification|5 - Optionals", meta=(DisplayName="Make Optional TArray<int64>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Notification|5 - Optionals", meta = (DisplayName="TArray<int64> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Notification|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Notification|5 - Optionals", meta=(DisplayName="Get Optional's TArray<int64> Value"))
