...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Make Optional CommerceLootRoll", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta = (DisplayName="CommerceLootRoll To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Get Optional's CommerceLootRoll Value"))
