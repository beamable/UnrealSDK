...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Make Optional TArray<UCurrencyProperty*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta = (DisplayName="TArray<UCurrencyProperty*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UCurrencyProperty*> Value"))
