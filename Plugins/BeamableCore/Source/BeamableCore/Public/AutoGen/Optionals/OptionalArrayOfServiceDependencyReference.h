...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfServiceDependencyReferenceLibrary.MakeOptionalArrayOfServiceDependencyReference"))
struct FOptionalArrayOfServiceDependencyReference : public FBeamOptional
{
	GENERATED_BODY()
