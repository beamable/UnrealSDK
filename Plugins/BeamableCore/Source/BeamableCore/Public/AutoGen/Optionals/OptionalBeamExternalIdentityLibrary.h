...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Make Optional BeamExternalIdentity", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta = (DisplayName="BeamExternalIdentity To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Get Optional's BeamExternalIdentity Value"))
