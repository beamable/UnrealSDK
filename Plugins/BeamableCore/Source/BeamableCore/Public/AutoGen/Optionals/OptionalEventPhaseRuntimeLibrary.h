...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Make Optional EventPhaseRuntime", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta = (DisplayName="EventPhaseRuntime To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Get Optional's EventPhaseRuntime Value"))
