...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalClientPermissionLibrary.MakeOptionalClientPermission"))
struct FOptionalClientPermission : public FBeamOptional
{
	GENERATED_BODY()
