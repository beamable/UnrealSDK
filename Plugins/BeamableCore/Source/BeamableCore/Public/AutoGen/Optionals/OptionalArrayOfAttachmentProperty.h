...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfAttachmentPropertyLibrary.MakeOptional", BeamOptionalType="TArray<UAttachmentProperty*>"))
