...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfAttachmentPropertyLibrary.MakeOptionalArrayOfAttachmentProperty"))
struct FOptionalArrayOfAttachmentProperty : public FBeamOptional
{
	GENERATED_BODY()
