...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta=(DisplayName="Make Optional BeamoBasicManifestChecksum", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta = (DisplayName="BeamoBasicManifestChecksum To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|5 - Optionals", meta=(DisplayName="Get Optional's BeamoBasicManifestChecksum Value"))
