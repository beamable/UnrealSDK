...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Make Optional EventPlayerGroupState", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta = (DisplayName="EventPlayerGroupState To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Get Optional's EventPlayerGroupState Value"))
