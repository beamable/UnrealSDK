...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Make Optional TMap<FString, int64>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta = (DisplayName="TMap<FString, int64> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Inventory|5 - Optionals", meta=(DisplayName="Get Optional's TMap<FString, int64> Value"))
