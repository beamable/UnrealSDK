...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfWebhookRewardLibrary.MakeOptionalArrayOfWebhookReward"))
struct FOptionalArrayOfWebhookReward : public FBeamOptional
{
	GENERATED_BODY()
