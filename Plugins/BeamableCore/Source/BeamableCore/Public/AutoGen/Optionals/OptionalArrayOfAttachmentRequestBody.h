...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfAttachmentRequestBodyLibrary.MakeOptional", BeamOptionalType="TArray<UAttachmentRequestBody*>"))
