...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Push|5 - Optionals", meta=(DisplayName="Make Optional SendNotification", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Push|5 - Optionals", meta = (DisplayName="SendNotification To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Push|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Push|5 - Optionals", meta=(DisplayName="Get Optional's SendNotification Value"))
