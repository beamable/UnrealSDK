...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalMapOfArrayOfCurrencyPropertyLibrary.MakeOptional", BeamOptionalType="TMap<FString, FArrayOfCurrencyProperty>"))
