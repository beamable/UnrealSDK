...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Make Optional Catalog", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta = (DisplayName="Catalog To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Get Optional's Catalog Value"))
