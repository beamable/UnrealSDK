...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfItemUpdateRequestBodyLibrary.MakeOptional", BeamOptionalType="TArray<UItemUpdateRequestBody*>"))
