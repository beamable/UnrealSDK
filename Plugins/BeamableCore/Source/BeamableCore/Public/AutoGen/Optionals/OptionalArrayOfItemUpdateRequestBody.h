...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfItemUpdateRequestBodyLibrary.MakeOptionalArrayOfItemUpdateRequestBody"))
struct FOptionalArrayOfItemUpdateRequestBody : public FBeamOptional
{
	GENERATED_BODY()
