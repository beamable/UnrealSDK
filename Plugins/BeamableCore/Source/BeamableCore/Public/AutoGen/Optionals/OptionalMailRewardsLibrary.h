...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Mail|Utils|Optionals", meta=(DisplayName="Make Optional MailRewards", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|Utils|Optionals", meta = (DisplayName="MailRewards To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|Utils|Optionals", meta=(DisplayName="Get Optional's MailRewards Value"))
