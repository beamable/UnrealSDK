...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Make Optional MailRewards", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta = (DisplayName="MailRewards To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Get Optional's MailRewards Value"))
