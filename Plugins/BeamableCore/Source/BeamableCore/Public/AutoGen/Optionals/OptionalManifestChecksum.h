...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalManifestChecksumLibrary.MakeOptionalManifestChecksum"))
struct FOptionalManifestChecksum : public FBeamOptional
{
	GENERATED_BODY()
