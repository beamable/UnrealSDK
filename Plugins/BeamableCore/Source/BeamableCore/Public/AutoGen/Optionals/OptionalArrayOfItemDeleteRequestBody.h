...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfItemDeleteRequestBodyLibrary.MakeOptional", BeamOptionalType="TArray<UItemDeleteRequestBody*>"))
