...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfItemDeleteRequestBodyLibrary.MakeOptionalArrayOfItemDeleteRequestBody"))
struct FOptionalArrayOfItemDeleteRequestBody : public FBeamOptional
{
	GENERATED_BODY()
