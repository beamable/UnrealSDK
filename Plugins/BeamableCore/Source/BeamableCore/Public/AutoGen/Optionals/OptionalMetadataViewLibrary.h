...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|5 - Optionals", meta=(DisplayName="Make Optional MetadataView", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|5 - Optionals", meta = (DisplayName="MetadataView To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|5 - Optionals", meta=(DisplayName="Get Optional's MetadataView Value"))
