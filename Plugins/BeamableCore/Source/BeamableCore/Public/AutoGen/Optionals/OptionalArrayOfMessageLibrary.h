...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Make Optional TArray<UMessage*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta = (DisplayName="TArray<UMessage*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UMessage*> Value"))
