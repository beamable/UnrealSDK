...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta=(DisplayName="Make Optional TArray<UTeam*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta = (DisplayName="TArray<UTeam*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UTeam*> Value"))
