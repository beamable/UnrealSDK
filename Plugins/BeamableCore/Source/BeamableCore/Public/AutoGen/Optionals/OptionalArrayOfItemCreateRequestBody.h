...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfItemCreateRequestBodyLibrary.MakeOptional", BeamOptionalType="TArray<UItemCreateRequestBody*>"))
