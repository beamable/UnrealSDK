...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Make Optional TArray<UScheduleDefinition*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta = (DisplayName="TArray<UScheduleDefinition*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UScheduleDefinition*> Value"))
