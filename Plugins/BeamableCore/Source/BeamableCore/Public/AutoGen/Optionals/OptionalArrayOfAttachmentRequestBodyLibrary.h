...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Make Optional TArray<UAttachmentRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta = (DisplayName="TArray<UAttachmentRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Mail|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UAttachmentRequestBody*> Value"))
