...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventRewardContentLibrary.MakeOptionalArrayOfEventRewardContent"))
struct FOptionalArrayOfEventRewardContent : public FBeamOptional
{
	GENERATED_BODY()
