...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventRewardContentLibrary.MakeOptional", BeamOptionalType="TArray<UEventRewardContent*>"))
