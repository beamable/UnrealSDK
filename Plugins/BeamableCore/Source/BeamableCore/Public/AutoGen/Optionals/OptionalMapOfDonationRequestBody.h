...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalMapOfDonationRequestBodyLibrary.MakeOptionalMapOfDonationRequestBody"))
struct FOptionalMapOfDonationRequestBody : public FBeamOptional
{
	GENERATED_BODY()
