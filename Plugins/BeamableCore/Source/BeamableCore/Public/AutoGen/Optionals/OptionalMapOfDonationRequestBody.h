...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalMapOfDonationRequestBodyLibrary.MakeOptional", BeamOptionalType="TMap<FString, UDonationRequestBody*>"))
