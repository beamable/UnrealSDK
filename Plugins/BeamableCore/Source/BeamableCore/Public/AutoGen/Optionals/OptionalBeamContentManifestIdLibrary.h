...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta=(DisplayName="Make Optional BeamContentManifestId", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta = (DisplayName="BeamContentManifestId To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Content|5 - Optionals", meta=(DisplayName="Get Optional's BeamContentManifestId Value"))
