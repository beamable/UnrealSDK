...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Make Optional TArray<UNewItemReward*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta = (DisplayName="TArray<UNewItemReward*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UNewItemReward*> Value"))
