...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta=(DisplayName="Make Optional TArray<FBeamContentId>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta = (DisplayName="TArray<FBeamContentId> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Matchmaking|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Matchmaking|5 - Optionals", meta=(DisplayName="Get Optional's TArray<FBeamContentId> Value"))
