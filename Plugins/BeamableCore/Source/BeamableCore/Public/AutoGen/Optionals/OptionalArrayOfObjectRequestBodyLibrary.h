...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta=(DisplayName="Make Optional TArray<UObjectRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta = (DisplayName="TArray<UObjectRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Cloudsaving|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Cloudsaving|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UObjectRequestBody*> Value"))
