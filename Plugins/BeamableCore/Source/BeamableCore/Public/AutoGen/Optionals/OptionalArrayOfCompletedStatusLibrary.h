...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|5 - Optionals", meta=(DisplayName="Make Optional TArray<UCompletedStatus*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|5 - Optionals", meta = (DisplayName="TArray<UCompletedStatus*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Tournaments|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Tournaments|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UCompletedStatus*> Value"))
