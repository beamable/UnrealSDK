...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Make Optional TArray<int32>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta = (DisplayName="TArray<int32> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Commerce|5 - Optionals", meta=(DisplayName="Get Optional's TArray<int32> Value"))
