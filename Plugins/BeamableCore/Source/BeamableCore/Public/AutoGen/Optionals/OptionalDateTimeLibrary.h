...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Make Optional DateTime", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta = (DisplayName="DateTime To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Get Optional's DateTime Value"))
