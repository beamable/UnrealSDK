...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|5 - Optionals", meta=(DisplayName="Make Optional TMap<FString, double>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|5 - Optionals", meta = (DisplayName="TMap<FString, double> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|PlayerTicket|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|5 - Optionals", meta=(DisplayName="Get Optional's TMap<FString, double> Value"))
