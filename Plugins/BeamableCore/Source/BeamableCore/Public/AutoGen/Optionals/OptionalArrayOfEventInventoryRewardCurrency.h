...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventInventoryRewardCurrencyLibrary.MakeOptional", BeamOptionalType="TArray<UEventInventoryRewardCurrency*>"))
