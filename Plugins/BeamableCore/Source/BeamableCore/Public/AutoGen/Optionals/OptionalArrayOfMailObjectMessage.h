...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfMailObjectMessageLibrary.MakeOptionalArrayOfMailObjectMessage"))
struct FOptionalArrayOfMailObjectMessage : public FBeamOptional
{
	GENERATED_BODY()
