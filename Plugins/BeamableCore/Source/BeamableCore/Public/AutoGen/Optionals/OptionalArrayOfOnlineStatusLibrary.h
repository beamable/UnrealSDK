...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Presence|5 - Optionals", meta=(DisplayName="Make Optional TArray<UOnlineStatus*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Presence|5 - Optionals", meta = (DisplayName="TArray<UOnlineStatus*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Presence|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Presence|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UOnlineStatus*> Value"))
