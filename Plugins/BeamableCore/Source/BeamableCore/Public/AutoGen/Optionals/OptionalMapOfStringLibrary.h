...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Make Optional TMap<FString, FString>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta = (DisplayName="TMap<FString, FString> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Get Optional's TMap<FString, FString> Value"))
