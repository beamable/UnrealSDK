...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Make Optional EventGroupRewards", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta = (DisplayName="EventGroupRewards To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Get Optional's EventGroupRewards Value"))
