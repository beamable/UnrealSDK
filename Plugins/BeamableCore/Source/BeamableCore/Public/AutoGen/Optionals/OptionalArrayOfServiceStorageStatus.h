...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfServiceStorageStatusLibrary.MakeOptional", BeamOptionalType="TArray<UServiceStorageStatus*>"))
