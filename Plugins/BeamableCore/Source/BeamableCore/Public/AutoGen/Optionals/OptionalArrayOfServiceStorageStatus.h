...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfServiceStorageStatusLibrary.MakeOptionalArrayOfServiceStorageStatus"))
struct FOptionalArrayOfServiceStorageStatus : public FBeamOptional
{
	GENERATED_BODY()
