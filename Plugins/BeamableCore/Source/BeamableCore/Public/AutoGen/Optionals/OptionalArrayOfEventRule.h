...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventRuleLibrary.MakeOptionalArrayOfEventRule"))
struct FOptionalArrayOfEventRule : public FBeamOptional
{
	GENERATED_BODY()
