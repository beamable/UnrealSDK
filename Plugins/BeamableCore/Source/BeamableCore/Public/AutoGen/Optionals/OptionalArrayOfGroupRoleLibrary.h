...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Make Optional TArray<UGroupRole*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta = (DisplayName="TArray<UGroupRole*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UGroupRole*> Value"))
