...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta=(DisplayName="Make Optional TArray<FBeamGamerTag>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta = (DisplayName="TArray<FBeamGamerTag> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Party|5 - Optionals", meta=(DisplayName="Get Optional's TArray<FBeamGamerTag> Value"))
