...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Session|5 - Optionals", meta=(DisplayName="Make Optional SessionLanguageContext", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Session|5 - Optionals", meta = (DisplayName="SessionLanguageContext To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Session|5 - Optionals", meta=(DisplayName="Get Optional's SessionLanguageContext Value"))
