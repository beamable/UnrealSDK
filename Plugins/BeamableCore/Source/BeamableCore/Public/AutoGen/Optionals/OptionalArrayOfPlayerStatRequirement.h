...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfPlayerStatRequirementLibrary.MakeOptional", BeamOptionalType="TArray<UPlayerStatRequirement*>"))
