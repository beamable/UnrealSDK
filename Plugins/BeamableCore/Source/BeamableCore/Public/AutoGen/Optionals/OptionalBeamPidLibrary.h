...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Make Optional BeamPid", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta = (DisplayName="BeamPid To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Get Optional's BeamPid Value"))
