...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Make Optional TArray<UPlayerStatRequirement*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta = (DisplayName="TArray<UPlayerStatRequirement*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UPlayerStatRequirement*> Value"))
