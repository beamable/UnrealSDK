...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Realms|5 - Optionals", meta=(DisplayName="Make Optional TArray<FBeamPid>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Realms|5 - Optionals", meta = (DisplayName="TArray<FBeamPid> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Realms|5 - Optionals", meta=(DisplayName="Get Optional's TArray<FBeamPid> Value"))
