...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Make Optional TMap<FString, UDonationRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta = (DisplayName="TMap<FString, UDonationRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Get Optional's TMap<FString, UDonationRequestBody*> Value"))
