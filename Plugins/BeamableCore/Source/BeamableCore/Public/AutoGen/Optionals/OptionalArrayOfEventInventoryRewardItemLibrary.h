...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Make Optional TArray<UEventInventoryRewardItem*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta = (DisplayName="TArray<UEventInventoryRewardItem*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|EventPlayers|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UEventInventoryRewardItem*> Value"))
