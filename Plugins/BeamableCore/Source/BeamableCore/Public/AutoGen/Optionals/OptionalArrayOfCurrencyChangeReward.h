...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfCurrencyChangeRewardLibrary.MakeOptional", BeamOptionalType="TArray<UCurrencyChangeReward*>"))
