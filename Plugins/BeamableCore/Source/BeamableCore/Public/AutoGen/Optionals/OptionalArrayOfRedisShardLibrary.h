...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|ServicePlan|Utils|Optionals", meta=(DisplayName="Make Optional TArray<URedisShard*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|ServicePlan|Utils|Optionals", meta = (DisplayName="TArray<URedisShard*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|ServicePlan|Utils|Optionals", meta=(DisplayName="Get Optional's TArray<URedisShard*> Value"))
