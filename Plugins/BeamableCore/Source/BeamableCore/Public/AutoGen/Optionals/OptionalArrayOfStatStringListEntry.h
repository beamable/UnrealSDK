...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfStatStringListEntryLibrary.MakeOptional", BeamOptionalType="TArray<UStatStringListEntry*>"))
