...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalLeaderboardCohortSettingsLibrary.MakeOptional", BeamOptionalType="ULeaderboardCohortSettings*"))
