...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalLeaderboardCohortSettingsLibrary.MakeOptionalLeaderboardCohortSettings"))
struct FOptionalLeaderboardCohortSettings : public FBeamOptional
{
	GENERATED_BODY()
