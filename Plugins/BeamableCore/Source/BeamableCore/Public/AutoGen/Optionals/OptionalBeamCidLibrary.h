...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Make Optional BeamCid", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta = (DisplayName="BeamCid To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Auth|5 - Optionals", meta=(DisplayName="Get Optional's BeamCid Value"))
