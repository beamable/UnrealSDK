...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfScheduleDefinitionLibrary.MakeOptionalArrayOfScheduleDefinition"))
struct FOptionalArrayOfScheduleDefinition : public FBeamOptional
{
	GENERATED_BODY()
