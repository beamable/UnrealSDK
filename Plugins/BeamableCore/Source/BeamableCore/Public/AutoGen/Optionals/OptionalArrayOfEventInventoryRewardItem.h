...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventInventoryRewardItemLibrary.MakeOptional", BeamOptionalType="TArray<UEventInventoryRewardItem*>"))
