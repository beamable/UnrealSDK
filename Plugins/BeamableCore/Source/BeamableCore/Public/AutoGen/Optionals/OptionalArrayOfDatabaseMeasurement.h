...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfDatabaseMeasurementLibrary.MakeOptional", BeamOptionalType="TArray<UDatabaseMeasurement*>"))
