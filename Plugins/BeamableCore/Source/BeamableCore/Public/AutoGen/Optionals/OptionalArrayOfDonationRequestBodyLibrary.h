...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Make Optional TArray<UDonationRequestBody*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta = (DisplayName="TArray<UDonationRequestBody*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|GroupUsers|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UDonationRequestBody*> Value"))
