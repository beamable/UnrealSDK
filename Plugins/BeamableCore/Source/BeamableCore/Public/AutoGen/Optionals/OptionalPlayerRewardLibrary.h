...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Make Optional PlayerReward", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta = (DisplayName="PlayerReward To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|5 - Optionals", meta=(DisplayName="Get Optional's PlayerReward Value"))
