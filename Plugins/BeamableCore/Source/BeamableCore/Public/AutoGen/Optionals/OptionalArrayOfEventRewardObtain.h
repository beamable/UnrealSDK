...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfEventRewardObtainLibrary.MakeOptionalArrayOfEventRewardObtain"))
struct FOptionalArrayOfEventRewardObtain : public FBeamOptional
{
	GENERATED_BODY()
