...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Make Optional Bool", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta = (DisplayName="Bool To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|5 - Optionals", meta=(DisplayName="Get Optional's Bool Value"))
