...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfRankEntryStatLibrary.MakeOptionalArrayOfRankEntryStat"))
struct FOptionalArrayOfRankEntryStat : public FBeamOptional
{
	GENERATED_BODY()
