...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Make Optional BeamRemoteContentManifestEntry", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta = (DisplayName="BeamRemoteContentManifestEntry To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Shared|5 - Optionals", meta=(DisplayName="Get Optional's BeamRemoteContentManifestEntry Value"))
