...
USTRUCT(BlueprintType, meta=(HasNativeMake="BeamableCore.OptionalArrayOfRedisShardLibrary.MakeOptionalArrayOfRedisShard"))
struct FOptionalArrayOfRedisShard : public FBeamOptional
{
	GENERATED_BODY()
