...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Make Optional TArray<UInFlightMessage*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta = (DisplayName="TArray<UInFlightMessage*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Events|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UInFlightMessage*> Value"))
