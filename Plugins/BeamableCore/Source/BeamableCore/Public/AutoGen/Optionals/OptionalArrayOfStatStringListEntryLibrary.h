...
public:	
	...
	*/
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta=(DisplayName="Make Optional TArray<UStatStringListEntry*>", NativeMakeFunc))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta = (DisplayName="TArray<UStatStringListEntry*> To Optional", CompactNodeTitle = "->", BlueprintAutocast))
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category="Beam|Stats|5 - Optionals", meta=(DisplayName="Optional Has Value", ExpandBoolAsExecs="ReturnValue"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category="Beam|Stats|5 - Optionals", meta=(DisplayName="Get Optional's TArray<UStatStringListEntry*> Value"))
