...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="AnnouncementAttachment To JSON String")
	static FString AnnouncementAttachmentToJsonString(const UAnnouncementAttachment* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make AnnouncementAttachment", meta=(DefaultToSelf="Outer", AdvancedDisplay="Type, Properties, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break AnnouncementAttachment", meta=(NativeBreakFunc))
