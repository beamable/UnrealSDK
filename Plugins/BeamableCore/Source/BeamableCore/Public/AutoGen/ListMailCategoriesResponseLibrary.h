...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="ListMailCategoriesResponse To JSON String")
	static FString ListMailCategoriesResponseToJsonString(const UListMailCategoriesResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make ListMailCategoriesResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UListMailCategoriesResponse* Make(TArray<FString> Result, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break ListMailCategoriesResponse", meta=(NativeBreakFunc))
