...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Mail|4 - Json", DisplayName="ListMailCategoriesResponse To JSON String")
	static FString ListMailCategoriesResponseToJsonString(const UListMailCategoriesResponse* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Mail|3 - Backend", DisplayName="Make ListMailCategoriesResponse", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UListMailCategoriesResponse* Make(TArray<FString> Result, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Mail|3 - Backend", DisplayName="Break ListMailCategoriesResponse", meta=(NativeBreakFunc))
