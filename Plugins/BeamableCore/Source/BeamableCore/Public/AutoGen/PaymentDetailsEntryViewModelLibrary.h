...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="PaymentDetailsEntryViewModel To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make PaymentDetailsEntryViewModel", meta=(DefaultToSelf="Outer", AdvancedDisplay="Subcategory, LocalPrice, Category, LocalCurrency, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break PaymentDetailsEntryViewModel", meta=(NativeBreakFunc))
