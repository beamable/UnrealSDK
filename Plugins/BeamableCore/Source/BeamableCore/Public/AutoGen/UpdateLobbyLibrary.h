...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|4 - Json", DisplayName="UpdateLobby To JSON String")
	static FString UpdateLobbyToJsonString(const UUpdateLobby* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Make UpdateLobby", meta=(DefaultToSelf="Outer", AdvancedDisplay="Name, Description, Restriction, MatchType, MaxPlayers, NewHost, Data, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Lobby|3 - Backend", DisplayName="Break UpdateLobby", meta=(NativeBreakFunc))
