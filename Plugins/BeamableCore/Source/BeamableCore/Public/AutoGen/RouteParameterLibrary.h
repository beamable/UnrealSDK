...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="RouteParameter To JSON String")
	static FString RouteParameterToJsonString(const URouteParameter* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make RouteParameter", meta=(DefaultToSelf="Outer", AdvancedDisplay="VariableRef, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break RouteParameter", meta=(NativeBreakFunc))
