...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|4 - Json", DisplayName="RouteParameter To JSON String")
	static FString RouteParameterToJsonString(const URouteParameter* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Make RouteParameter", meta=(DefaultToSelf="Outer", AdvancedDisplay="VariableRef, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Announcements|3 - Backend", DisplayName="Break RouteParameter", meta=(NativeBreakFunc))
