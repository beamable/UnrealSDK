...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|4 - Json", DisplayName="MatchMakingRanking To JSON String")
	static FString MatchMakingRankingToJsonString(const UMatchMakingRanking* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Make MatchMakingRanking", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	static UMatchMakingRanking* Make(bool bIsUnranked, int64 Gt, int32 Rank, TMap<FString, FString> Variables, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Leaderboards|3 - Backend", DisplayName="Break MatchMakingRanking", meta=(NativeBreakFunc))
