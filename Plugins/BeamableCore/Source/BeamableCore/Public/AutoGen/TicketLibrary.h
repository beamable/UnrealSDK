...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make Ticket", meta=(DefaultToSelf="Outer", AdvancedDisplay="bWatchOnlineStatus, TicketId, Status, Created, Expires, MatchType, MatchId, Team, Priority, PartyId, Players, Tags, StringProperties, NumberProperties, Outer", NativeMakeFunc))
