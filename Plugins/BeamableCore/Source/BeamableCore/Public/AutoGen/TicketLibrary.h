...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|4 - Json", DisplayName="Ticket To JSON String")
	static FString TicketToJsonString(const UTicket* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|3 - Backend", DisplayName="Make Ticket", meta=(DefaultToSelf="Outer", AdvancedDisplay="bWatchOnlineStatus, TicketId, Status, Created, Expires, MatchType, MatchId, Team, Priority, PartyId, LobbyId, Players, Tags, StringProperties, NumberProperties, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|PlayerTicket|3 - Backend", DisplayName="Break Ticket", meta=(NativeBreakFunc))
