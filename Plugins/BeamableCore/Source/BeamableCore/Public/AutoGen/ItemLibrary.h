...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Item To JSON String")
	static FString ItemToJsonString(const UItem* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Item", meta=(DefaultToSelf="Outer", AdvancedDisplay="UpdatedAt, ProxyId, Proxy, CreatedAt, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Item", meta=(NativeBreakFunc))
