...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Auth|4 - Json", DisplayName="GuestAuthRequestBody To JSON String")
	static FString GuestAuthRequestBodyToJsonString(const UGuestAuthRequestBody* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Auth|3 - Backend", DisplayName="Make GuestAuthRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Scope, CustomerId, RealmId, Context, InitProperties, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Auth|3 - Backend", DisplayName="Break GuestAuthRequestBody", meta=(NativeBreakFunc))
