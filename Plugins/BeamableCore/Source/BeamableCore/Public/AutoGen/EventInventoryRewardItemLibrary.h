...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="EventInventoryRewardItem To JSON String")
	static FString EventInventoryRewardItemToJsonString(const UEventInventoryRewardItem* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make EventInventoryRewardItem", meta=(DefaultToSelf="Outer", AdvancedDisplay="Properties, Outer", NativeMakeFunc))
	static UEventInventoryRewardItem* Make(FString Id, FOptionalMapOfString Properties, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break EventInventoryRewardItem", meta=(NativeBreakFunc))
