...
public:
	...
	static ULobby* Make(FOptionalString LobbyId, FOptionalMatchType MatchType, FOptionalString Created, FOptionalString Name, FOptionalString Description, FOptionalString Host, FOptionalString Passcode, FOptionalString Restriction, FOptionalInt32 MaxPlayers, FOptionalArrayOfLobbyPlayer Players, UObject* Outer);

	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Break Lobby", meta=(NativeBreakFunc))
	static void Break(const ULobby* Serializable, FOptionalString& LobbyId, FOptionalMatchType& MatchType, FOptionalString& Created, FOptionalString& Name, FOptionalString& Description, FOptionalString& Host, FOptionalString& Passcode, FOptionalString& Restriction, FOptionalInt32& MaxPlayers, FOptionalArrayOfLobbyPlayer& Players);
};