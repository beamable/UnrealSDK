...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Presence|4 - Json", DisplayName="OnlineStatus To JSON String")
	static FString OnlineStatusToJsonString(const UOnlineStatus* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Presence|3 - Backend", DisplayName="Make OnlineStatus", meta=(DefaultToSelf="Outer", AdvancedDisplay="LastOnline, bOnline, PlayerId, Status, Description, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Presence|3 - Backend", DisplayName="Break OnlineStatus", meta=(NativeBreakFunc))
