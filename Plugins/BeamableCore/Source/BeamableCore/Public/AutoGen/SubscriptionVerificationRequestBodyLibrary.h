...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|4 - Json", DisplayName="SubscriptionVerificationRequestBody To JSON String")
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Make SubscriptionVerificationRequestBody", meta=(DefaultToSelf="Outer", AdvancedDisplay="Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Payments|3 - Backend", DisplayName="Break SubscriptionVerificationRequestBody", meta=(NativeBreakFunc))
