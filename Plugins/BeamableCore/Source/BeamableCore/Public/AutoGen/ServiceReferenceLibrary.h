...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Backend", DisplayName="Beam - Make ServiceReference", meta=(DefaultToSelf="Outer", AdvancedDisplay="ContainerHealthCheckPort, ImageCpuArch, Comments, Dependencies, Outer", NativeMakeFunc))
