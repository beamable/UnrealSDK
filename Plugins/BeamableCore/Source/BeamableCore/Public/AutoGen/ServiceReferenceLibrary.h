...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|4 - Json", DisplayName="ServiceReference To JSON String")
	static FString ServiceReferenceToJsonString(const UServiceReference* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Make ServiceReference", meta=(DefaultToSelf="Outer", AdvancedDisplay="ContainerHealthCheckPort, ImageCpuArch, Comments, Components, Dependencies, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Beamo|3 - Backend", DisplayName="Break ServiceReference", meta=(NativeBreakFunc))
