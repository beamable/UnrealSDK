...
public:
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Json", DisplayName="Match To JSON String")
	static FString MatchToJsonString(const UMatch* Serializable, const bool Pretty);

	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Make Match", meta=(DefaultToSelf="Outer", AdvancedDisplay="MatchId, Status, Created, MatchType, Teams, Tickets, Outer", NativeMakeFunc))
	...
	UFUNCTION(BlueprintPure, Category="Beam|Shared|Backend", DisplayName="Break Match", meta=(NativeBreakFunc))
