...
void USessionBasicStartSessionRequestBody::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void USessionBasicStartSessionRequestBody::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("source"), &Source, Serializer);
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("shard"), &Shard, Serializer);
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("locale"), &Locale, Serializer);
...
void USessionBasicStartSessionRequestBody::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
