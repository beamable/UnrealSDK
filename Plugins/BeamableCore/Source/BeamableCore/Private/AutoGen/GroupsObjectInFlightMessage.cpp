...
void UGroupsObjectInFlightMessage::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UGroupsObjectInFlightMessage::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("method"), Method, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("body"), Body, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("path"), Path, Serializer);
...
void UGroupsObjectInFlightMessage::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
