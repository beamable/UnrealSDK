...
void UBeamoActorServiceReference::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UBeamoActorServiceReference::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeOptional<bool>(TEXT("archived"), &bArchived, Serializer);
	UBeamJsonUtils::SerializeOptional<bool>(TEXT("enabled"), &bEnabled, Serializer);
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("serviceName"), &ServiceName, Serializer);
...
void UBeamoActorServiceReference::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
