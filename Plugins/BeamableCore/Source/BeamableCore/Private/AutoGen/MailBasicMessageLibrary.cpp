...
#include "BeamableCore/Public/AutoGen/MailBasicMessageLibrary.h"

#include "CoreMinimal.h"


FString UMailBasicMessageLibrary::MailBasicMessageToJsonString(const UMailBasicMessage* Serializable, const bool Pretty)
{
...
UMailBasicMessage* UMailBasicMessageLibrary::Make(int64 ReceiverGamerTag, FString State, int64 Id, int64 SenderGamerTag, int64 Sent, FString Category, TArray<UAttachment*> Attachments, FOptionalString Body, FOptionalInt32 Expires, FOptionalPlayerReward PlayerRewards, FOptionalString Subject, FOptionalMailRewards Rewards, FOptionalInt64 BodyRef, FOptionalInt64 ClaimedTimeMs, UObject* Outer)
{
	auto Serializable = NewObject<UMailBasicMessage>(Outer);
