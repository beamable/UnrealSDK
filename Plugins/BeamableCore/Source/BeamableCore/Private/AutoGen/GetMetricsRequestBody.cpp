...
void UGetMetricsRequestBody::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UGetMetricsRequestBody::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("metricName"), &MetricName, Serializer);
	UBeamJsonUtils::SerializeOptional<FDateTime>(TEXT("startTime"), &StartTime, Serializer);
	UBeamJsonUtils::SerializeOptional<FDateTime>(TEXT("endTime"), &EndTime, Serializer);
...
void UGetMetricsRequestBody::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
