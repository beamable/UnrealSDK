...
void URealmsBasicDataDomain::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void URealmsBasicDataDomain::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("mongoSSLEnabled"), bMongoSSLEnabled, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("mongoSharded"), bMongoSharded, Serializer);
	UBeamJsonUtils::SerializeArray<FString>(TEXT("memcachedHosts"), MemcachedHosts, Serializer);
...
void URealmsBasicDataDomain::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
