...
void UParty::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
	...
	UBeamJsonUtils::SerializeOptional<TArray<FString>, FString>(TEXT("members"), &Members, Serializer);
...
void UParty::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
	...
	UBeamJsonUtils::DeserializeOptional<TArray<FString>, FString>("members", Bag, Members, OuterOwner);
