...
void UAuthV2RefreshToken::DeserializeRequestResponse(UObject* RequestData, FString ResponseContent)
{
	OuterOwner = RequestData;
	BeamDeserialize(ResponseContent);	
}

void UAuthV2RefreshToken::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UAuthV2RefreshToken::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeOptional<bool>(TEXT("revoked"), &bRevoked, Serializer);
	UBeamJsonUtils::SerializeOptional<FDateTime>(TEXT("ttl"), &Ttl, Serializer);
	UBeamJsonUtils::SerializeOptional<int64>(TEXT("accountIdRaw"), &AccountIdRaw, Serializer);
...
void UAuthV2RefreshToken::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
