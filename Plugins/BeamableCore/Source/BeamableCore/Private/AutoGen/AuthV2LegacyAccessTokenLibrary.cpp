...
#include "BeamableCore/Public/AutoGen/AuthV2LegacyAccessTokenLibrary.h"

#include "CoreMinimal.h"
#include "BeamCoreSettings.h"


FString UAuthV2LegacyAccessTokenLibrary::AuthV2LegacyAccessTokenToJsonString(const UAuthV2LegacyAccessToken* Serializable, const bool Pretty)
{
...
UAuthV2LegacyAccessToken* UAuthV2LegacyAccessTokenLibrary::Make(FOptionalBool bRevoked, FOptionalDateTime Ttl, FOptionalInt64 AccountIdRaw, FOptionalInt64 Cid, FOptionalInt64 GamerTag, FOptionalDateTime Created, FOptionalString Type, FOptionalInt64 ExpiresMs, FOptionalString DeviceId, FOptionalString Platform, FOptionalString Token, FOptionalString CustomerId, FOptionalString GameId, FOptionalString RealmId, FOptionalString AccountId, FOptionalString PlayerId, UObject* Outer)
{
	auto Serializable = NewObject<UAuthV2LegacyAccessToken>(Outer);
