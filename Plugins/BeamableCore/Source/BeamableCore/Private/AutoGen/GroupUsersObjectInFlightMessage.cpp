...
void UGroupUsersObjectInFlightMessage::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UGroupUsersObjectInFlightMessage::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("method"), Method, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("body"), Body, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("path"), Path, Serializer);
...
void UGroupUsersObjectInFlightMessage::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
