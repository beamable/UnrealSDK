...
void UAccountsBasicInFlightMessage::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UAccountsBasicInFlightMessage::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("method"), Method, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("body"), Body, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("path"), Path, Serializer);
...
void UAccountsBasicInFlightMessage::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
