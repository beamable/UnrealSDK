...
#include "BeamableCore/Public/AutoGen/SubSystems/BeamTicketApi.h"
#include "BeamCoreSettings.h"


void UBeamTicketApi::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UBeamTicketApi::Deinitialize()
{
	Super::Deinitialize();
}
...
void UBeamTicketApi::BP_PostTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::CPP_PostTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::BP_GetTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::CPP_GetTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::BP_DeleteTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::CPP_DeleteTicketsImpl(const FBeamRealmHandle& TargetRealm, const FBeamRetryConfig& RetryConfig, const FBeamAuthToken& AuthToken, FBeamConnectivity& ConnectivityStatus,
...
void UBeamTicketApi::CPP_PostTickets(const FUserSlot& UserSlot, UPostTicketsRequest* Request, const FOnPostTicketsFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext) const
{
	// AUTO-GENERATED...
...
void UBeamTicketApi::CPP_GetTickets(const FUserSlot& UserSlot, UGetTicketsRequest* Request, const FOnGetTicketsFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext) const
{
	// AUTO-GENERATED...
	FBeamRealmUser AuthenticatedUser;
	Backend->BeamUserSlots->GetUserDataAtSlot(UserSlot, AuthenticatedUser, CallingContext);
...
void UBeamTicketApi::CPP_DeleteTickets(const FUserSlot& UserSlot, UDeleteTicketsRequest* Request, const FOnDeleteTicketsFullResponse& Handler, FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext) const
{
	// AUTO-GENERATED...
	FBeamRealmUser AuthenticatedUser;
	Backend->BeamUserSlots->GetUserDataAtSlot(UserSlot, AuthenticatedUser, CallingContext);
...
void UBeamTicketApi::PostTickets(FUserSlot UserSlot, UPostTicketsRequest* Request, const FOnPostTicketsSuccess& OnSuccess, const FOnPostTicketsError& OnError, const FOnPostTicketsComplete& OnComplete,  FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext)
{
	// AUTO-GENERATED...
	FBeamRealmUser AuthenticatedUser;
	Backend->BeamUserSlots->GetUserDataAtSlot(UserSlot, AuthenticatedUser, CallingContext);
...
void UBeamTicketApi::GetTickets(FUserSlot UserSlot, UGetTicketsRequest* Request, const FOnGetTicketsSuccess& OnSuccess, const FOnGetTicketsError& OnError, const FOnGetTicketsComplete& OnComplete,  FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext)
{
	// AUTO-GENERATED...
	FBeamRealmUser AuthenticatedUser;
	Backend->BeamUserSlots->GetUserDataAtSlot(UserSlot, AuthenticatedUser, CallingContext);
...
void UBeamTicketApi::DeleteTickets(FUserSlot UserSlot, UDeleteTicketsRequest* Request, const FOnDeleteTicketsSuccess& OnSuccess, const FOnDeleteTicketsError& OnError, const FOnDeleteTicketsComplete& OnComplete,  FBeamRequestContext& OutRequestContext, FBeamOperationHandle OpHandle, const UObject* CallingContext)
{
	// AUTO-GENERATED...
	FBeamRealmUser AuthenticatedUser;
	Backend->BeamUserSlots->GetUserDataAtSlot(UserSlot, AuthenticatedUser, CallingContext);
