...
UGetOffersAdminRequest* UGetOffersAdminRequest::Make(int64 _ObjectId, FOptionalString _Language, FOptionalString _Time, FOptionalString _Stores, UObject* Outer)
{
