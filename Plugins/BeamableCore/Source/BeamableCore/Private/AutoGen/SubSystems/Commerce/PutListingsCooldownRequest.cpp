...
UPutListingsCooldownRequest* UPutListingsCooldownRequest::Make(int64 _ObjectId, int64 _GamerTag, TArray<UUpdateListingCooldownRequestBody*> _UpdateListingCooldownRequests, UObject* Outer)
{
