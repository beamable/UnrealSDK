...
UPostDataUploadURLFromPortalRequest* UPostDataUploadURLFromPortalRequest::Make(TArray<UUploadRequestFromPortal*> _Request, FOptionalInt64 _PlayerId, UObject* Outer)
{
