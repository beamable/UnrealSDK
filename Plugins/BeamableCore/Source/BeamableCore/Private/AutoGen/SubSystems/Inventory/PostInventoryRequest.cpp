...
UPostInventoryRequest* UPostInventoryRequest::Make(FBeamGamerTag _ObjectId, FOptionalInventoryFiltersDTO _ItemFilters, FOptionalArrayOfString _Scopes, UObject* RequestOwner, TMap<FString, FString> CustomHeaders)
{
	...
	Req->Body->ItemFilters = _ItemFilters;
