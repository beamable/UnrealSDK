...
void UAuthV2ServerTokenAuthRequestBody::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UAuthV2ServerTokenAuthRequestBody::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("clientId"), &ClientId, Serializer);
	UBeamJsonUtils::SerializeOptional<FString>(TEXT("clientSecret"), &ClientSecret, Serializer);
	UBeamJsonUtils::SerializeOptional<FBeamCid, FString>(TEXT("customerId"), &CustomerId, Serializer);
...
void UAuthV2ServerTokenAuthRequestBody::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
