...
void UAccountsObjectInFlightMessage::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UAccountsObjectInFlightMessage::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("method"), Method, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("body"), Body, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("path"), Path, Serializer);
...
void UAccountsObjectInFlightMessage::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
