...
{
	UBeamJsonUtils::SerializeOptional<EBeamBeamoV2PlayerRuleOperationType>(TEXT("playerIdOperationType"), &PlayerIdOperationType, Serializer);
	UBeamJsonUtils::SerializeOptional<EBeamBeamoV2PathRuleOperationType>(TEXT("pathsOperationType"), &PathsOperationType, Serializer);
...
{
	UBeamJsonUtils::DeserializeOptional<EBeamBeamoV2PlayerRuleOperationType>("playerIdOperationType", Bag, PlayerIdOperationType, OuterOwner);
	UBeamJsonUtils::DeserializeOptional<EBeamBeamoV2PathRuleOperationType>("pathsOperationType", Bag, PathsOperationType, OuterOwner);
