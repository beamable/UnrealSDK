...
void URealmsBasicInFlightMessage::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void URealmsBasicInFlightMessage::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("method"), Method, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("body"), Body, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("path"), Path, Serializer);
...
void URealmsBasicInFlightMessage::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
