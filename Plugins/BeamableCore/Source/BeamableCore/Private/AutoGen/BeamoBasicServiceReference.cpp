...
void UBeamoBasicServiceReference::BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const
{
...
void UBeamoBasicServiceReference::BeamSerializeProperties(TUnrealPrettyJsonSerializer& Serializer) const
{
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("archived"), bArchived, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("arm"), bArm, Serializer);
	UBeamJsonUtils::SerializeRawPrimitive(TEXT("enabled"), bEnabled, Serializer);
...
void UBeamoBasicServiceReference::BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag)
{
