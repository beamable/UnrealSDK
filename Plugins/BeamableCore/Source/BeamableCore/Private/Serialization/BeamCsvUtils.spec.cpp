...
2,102,c,102,guild)");
		...
		It("should parse the data correctly from the CSV (with header & turn key column into RowNames)", [this, WithoutHeaderCsv, WithHeaderCsv]()
		{
			...
			TestEqual<EGroupType>("Row 0 - Field5 parsed correctly", Row0.Field5, EGroupType::guild);
			...
			TestEqual<EGroupType>("Row 1 - Field5 parsed correctly", Row1.Field5, EGroupType::subgroup);
			...
			TestEqual<EGroupType>("Row 2 - Field5 parsed correctly", Row2.Field5, EGroupType::guild);
		});
