...
public:	
	...
	{
		UBeamJsonUtils::DeserializeArray<UServiceDependenciesPairStreamData*>(TEXT("Services"), Bag, Services, OuterOwner);	
	}
};
...
public:
	...
	TFunction<void (TArray<UBeamCliProjectDepsListStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
