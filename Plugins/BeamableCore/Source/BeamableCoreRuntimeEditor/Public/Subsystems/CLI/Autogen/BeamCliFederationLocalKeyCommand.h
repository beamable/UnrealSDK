...
public:
	...
	TFunction<void (const TArray<UBeamCliFederationLocalKeyStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
