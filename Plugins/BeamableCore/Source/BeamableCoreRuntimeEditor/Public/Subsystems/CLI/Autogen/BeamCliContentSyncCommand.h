...
class UBeamCliContentSyncStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools content sync [options]
 ...
 */
UCLASS()
class UBeamCliContentSyncCommand : public UBeamCliCommand
{
	GENERATED_BODY()
