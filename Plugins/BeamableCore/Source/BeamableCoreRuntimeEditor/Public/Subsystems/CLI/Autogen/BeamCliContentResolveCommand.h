...
#include "BeamCliContentResolveCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentResolveStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	{
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("ResolvedContentIds"), Bag, ResolvedContentIds, OuterOwner);	
	}
};
...
Options:
  ...
  --use <use>                                                              Whether to use the 'local' or 'realm' version of the conflicted content.
 ...
 */
UCLASS()
class UBeamCliContentResolveCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliContentResolveStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliContentResolveStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
