...
public:	
	...
	{
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("providerNamespace"), Bag, ProviderNamespace);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("providerService"), Bag, ProviderService);
