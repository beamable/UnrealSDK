...
#include "Subsystems/CLI/Autogen/StreamData/OptionalDateTimeStreamData.h"
#include "BeamCliTelemetryGetCredsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliTelemetryGetCredsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	FString Endpoint = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	UOptionalDateTimeStreamData* ExpiresAt = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FString Password = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FString Username = {};
	...
	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		...
		UBeamJsonUtils::SerializeUObject<UOptionalDateTimeStreamData*>("expiresAt", ExpiresAt, Serializer);
	...
	virtual void BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag) override
	{
		...
		UBeamJsonUtils::DeserializeUObject<UOptionalDateTimeStreamData*>("expiresAt", Bag, ExpiresAt, OuterOwner);
...
/**
 Description:
  [INTERNAL] Get credentials to read telemetry data from Beamable

Usage:
  Beamable.Tools telemetry get-creds [options]
 ...
 */
UCLASS()
class UBeamCliTelemetryGetCredsCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliTelemetryGetCredsStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliTelemetryGetCredsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
