...
#include "BeamCliContentPullCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentPullStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  Pulls currently deployed content

Usage:
  Beamable.Tools content pull [options]
...
Options:
  ...
  --content-ids <content-ids>            Inform a subset of ','-separated content ids for which to return data. By default, will return all content []
 ...
 */
UCLASS()
class UBeamCliContentPullCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliContentPullStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (const TArray<UBeamCliContentPullStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
