...
#include "BeamCliOtelCollectorCommand.generated.h"
...
Usage:
  Beamable.Tools otel collector [command] [options]
...
Commands:
  ...
  status  Starts a stream of messages containing the status of the collector
  stop    Stops the collector running process


 */
UCLASS()
class UBeamCliOtelCollectorCommand : public UBeamCliCommand
{
	GENERATED_BODY()
