...
public:
	...
	TFunction<void (const TArray<UBeamCliProjectWriteSettingStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
