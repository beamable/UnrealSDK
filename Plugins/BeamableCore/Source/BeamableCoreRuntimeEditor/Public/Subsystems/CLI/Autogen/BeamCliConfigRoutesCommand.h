...
#include "Subsystems/CLI/Autogen/StreamData/ConfigRoutesCommandWebsocketResultStreamData.h"
#include "BeamCliConfigRoutesCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliConfigRoutesStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	UConfigRoutesCommandWebsocketResultStreamData* SocketConfig = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("env"), Env, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("microserviceUri"), MicroserviceUri, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("registryUri"), RegistryUri, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("apiUri"), ApiUri, Serializer);
		...
		UBeamJsonUtils::SerializeUObject<UConfigRoutesCommandWebsocketResultStreamData*>("socketConfig", SocketConfig, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("env"), Bag, Env);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("microserviceUri"), Bag, MicroserviceUri);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("registryUri"), Bag, RegistryUri);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("apiUri"), Bag, ApiUri);
		...
		UBeamJsonUtils::DeserializeUObject<UConfigRoutesCommandWebsocketResultStreamData*>("socketConfig", Bag, SocketConfig, OuterOwner);	
	}
};
...
/**
 Description:
  List the various service routes for your Beamable host

Usage:
  Beamable.Tools config routes [options]
 ...
 */
UCLASS()
class UBeamCliConfigRoutesCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliConfigRoutesStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliConfigRoutesStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
