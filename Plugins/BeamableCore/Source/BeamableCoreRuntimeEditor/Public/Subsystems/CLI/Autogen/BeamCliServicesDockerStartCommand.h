...
#include "BeamCliServicesDockerStartCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliServicesDockerStartStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Options:
  -l, --links-only                           Only return the links to download docker, but do not start
 ...
 */
UCLASS()
class UBeamCliServicesDockerStartCommand : public UBeamCliCommand
{
	GENERATED_BODY()
