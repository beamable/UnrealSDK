...
#include "BeamCliMkdocsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliMkdocsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  [INTERNAL] Generate the mkdoc command suite documentation

Usage:
  Beamable.Tools mkdocs [options]

Options:
  -o, --output <output>                      A folder where the output docs will be written [default: cli-command-docs]
 ...
 */
UCLASS()
class UBeamCliMkdocsCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliMkdocsStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliMkdocsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
