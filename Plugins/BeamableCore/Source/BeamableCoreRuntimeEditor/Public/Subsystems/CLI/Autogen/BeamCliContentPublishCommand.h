...
Options:
  ...
  --auto-snapshot-type <Both|LocalOnly|None|SharedOnly>  Defines if after publish the Content System should take snapshots of the content.
                                                         ...
                                                         Both => Will save two snapshots, under local and shared folders [default: None]
  --max-local-snapshots <max-local-snapshots>            Defines the max stored local snapshots taken by the auto snapshot generation by this command. When the number hits, the older one will be deletd and replaced by the new snapshot [default: 20]
 ...
 */
UCLASS()
class UBeamCliContentPublishCommand : public UBeamCliCommand
{
	GENERATED_BODY()
