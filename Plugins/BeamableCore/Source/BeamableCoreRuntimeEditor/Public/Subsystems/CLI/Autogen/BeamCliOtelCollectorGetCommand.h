...
#include "BeamCliOtelCollectorGetCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliOtelCollectorGetStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools otel collector get [options]
 ...
 */
UCLASS()
class UBeamCliOtelCollectorGetCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliOtelCollectorGetStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliOtelCollectorGetStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
