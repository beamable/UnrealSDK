...
#include "BeamCliFederationEnableCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliFederationEnableStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools federation enable <service> [options]

Arguments:
  <service>  The service to disable federation
 ...
 */
UCLASS()
class UBeamCliFederationEnableCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliFederationEnableStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliFederationEnableStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
