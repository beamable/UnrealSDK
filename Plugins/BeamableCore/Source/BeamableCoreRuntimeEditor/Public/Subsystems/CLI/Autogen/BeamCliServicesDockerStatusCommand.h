...
#include "BeamCliServicesDockerStatusCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliServicesDockerStatusStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	{
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("isDaemonRunning"), Bag, IsDaemonRunning);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("isCliAccessible"), Bag, IsCliAccessible);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("cliLocation"), Bag, CliLocation);	
	}
};
...
Usage:
  Beamable.Tools services docker status [options]

Options:
  -w, --watch                                Emit a stream of updates as docker changes
 ...
 */
UCLASS()
class UBeamCliServicesDockerStatusCommand : public UBeamCliCommand
{
	GENERATED_BODY()
