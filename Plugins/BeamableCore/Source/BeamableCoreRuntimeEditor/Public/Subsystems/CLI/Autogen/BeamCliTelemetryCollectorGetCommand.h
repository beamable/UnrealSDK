...
#include "BeamCliTelemetryCollectorGetCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliTelemetryCollectorGetStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools telemetry collector get [options]
 ...
 */
UCLASS()
class UBeamCliTelemetryCollectorGetCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliTelemetryCollectorGetStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliTelemetryCollectorGetStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
