...
#include "ProjectErrorResultStreamData.generated.h"


UCLASS(BlueprintType)
class UProjectErrorResultStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	virtual void BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag) override
	{
		...
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("formattedMessage"), Bag, FormattedMessage);
