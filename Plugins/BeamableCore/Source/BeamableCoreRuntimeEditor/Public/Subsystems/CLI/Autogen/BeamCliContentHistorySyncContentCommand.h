...
#include "BeamCliContentHistorySyncContentCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentHistorySyncContentStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UContentHistoryChangelistEntryStreamData*> ContentEntries = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UContentHistoryChangelistEntryStreamData*>(TEXT("ContentEntries"), ContentEntries, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<UContentHistoryChangelistEntryStreamData*>(TEXT("ContentEntries"), Bag, ContentEntries, OuterOwner);	
	}
};
...
/**
 Description:
  [INTERNAL] Syncs content files for a given manifest UID. If content IDs are not provided, syncs all content in the manifest

Usage:
  Beamable.Tools content history sync-content [options]
...
Options:
  ...
  --manifest-uid <manifest-uid>              The manifest UID for the content to sync
  --content-ids <content-ids>                The content IDs to sync. If not provided, syncs all content in the manifest
 ...
 */
UCLASS()
class UBeamCliContentHistorySyncContentCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliContentHistorySyncContentStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliContentHistorySyncContentStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
