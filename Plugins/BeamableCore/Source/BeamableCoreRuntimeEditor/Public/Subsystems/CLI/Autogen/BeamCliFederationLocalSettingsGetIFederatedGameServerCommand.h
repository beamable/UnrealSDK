...
#include "BeamCliFederationLocalSettingsGetIFederatedGameServerCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliFederationLocalSettingsGetIFederatedGameServerStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools federation local-settings get IFederatedGameServer [options]
 ...
 */
UCLASS()
class UBeamCliFederationLocalSettingsGetIFederatedGameServerCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliFederationLocalSettingsGetIFederatedGameServerStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliFederationLocalSettingsGetIFederatedGameServerStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
