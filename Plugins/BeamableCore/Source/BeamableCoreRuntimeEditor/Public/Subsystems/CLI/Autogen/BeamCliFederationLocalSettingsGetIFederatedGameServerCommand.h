...
public:
	...
	TFunction<void (const TArray<UBeamCliFederationLocalSettingsGetIFederatedGameServerStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
