...
#include "BeamCliProjectRemoveReplacementTypeCommand.generated.h"



/**
 Description:
  Remove a replacement type for all Unreal linked projects

Usage:
  Beamable.Tools project remove-replacement-type [options]
 ...
 */
UCLASS()
class UBeamCliProjectRemoveReplacementTypeCommand : public UBeamCliCommand
{
	GENERATED_BODY()
