...
/**
 Description:
  Disable an active federation without stopping a service

Usage:
  Beamable.Tools federation disable <service> [options]
 ...
 */
UCLASS()
class UBeamCliFederationDisableCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliFederationDisableStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliFederationDisableStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
