...
/**
 Description:
  [REMOVED] Outputs manifests json to console
...
public:
	...
	TFunction<void (TArray<UBeamCliServicesManifestsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
