...
#include "BeamCliServerClearCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliServerClearStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UServerDescriptorStreamData*> StoppedServers = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UServerDescriptorStreamData*>(TEXT("stoppedServers"), StoppedServers, Serializer);	
	}
...
Usage:
  Beamable.Tools server clear [options]
 ...
 */
UCLASS()
class UBeamCliServerClearCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliServerClearStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliServerClearStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
