...
#include "BeamCliContentListManifestsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentListManifestsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<FString> LocalManifests = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FString> RemoteManifests = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<FString> ArchivedManifests = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<FString>(TEXT("localManifests"), LocalManifests, Serializer);
		UBeamJsonUtils::SerializeArray<FString>(TEXT("remoteManifests"), RemoteManifests, Serializer);
		UBeamJsonUtils::SerializeArray<FString>(TEXT("archivedManifests"), ArchivedManifests, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("localManifests"), Bag, LocalManifests, OuterOwner);
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("remoteManifests"), Bag, RemoteManifests, OuterOwner);
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("archivedManifests"), Bag, ArchivedManifests, OuterOwner);	
	}
};
...
/**
 Description:
  List all local and remote content manifest ids

Usage:
  Beamable.Tools content list-manifests [options]

Options:
  -a, --include-archived                     Include content manifest ids that have been archive
 ...
 */
UCLASS()
class UBeamCliContentListManifestsCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliContentListManifestsStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliContentListManifestsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
