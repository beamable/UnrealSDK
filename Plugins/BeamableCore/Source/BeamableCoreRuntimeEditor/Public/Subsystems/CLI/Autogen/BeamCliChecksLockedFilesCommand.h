...
#include "Subsystems/CLI/Autogen/StreamData/ProcessInfoStreamData.h"
#include "BeamCliChecksLockedFilesCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliChecksLockedFilesStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UProcessInfoStreamData*> ProcessLockedFiles = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UProcessInfoStreamData*>(TEXT("ProcessLockedFiles"), ProcessLockedFiles, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<UProcessInfoStreamData*>(TEXT("ProcessLockedFiles"), Bag, ProcessLockedFiles, OuterOwner);	
	}
};
...
/**
 Description:
  Check if there are any locked file inside a folder

Usage:
  Beamable.Tools checks locked-files [options]

Options:
  --folder-path <folder-path>                The folder path to check for locked files
  --pattern <pattern>                        The file pattern to check for [default: *]
 ...
 */
UCLASS()
class UBeamCliChecksLockedFilesCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliChecksLockedFilesStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliChecksLockedFilesStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
