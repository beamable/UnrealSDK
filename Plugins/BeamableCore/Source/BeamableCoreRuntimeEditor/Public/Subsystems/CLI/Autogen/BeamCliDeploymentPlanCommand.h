...
#include "BeamCliDeploymentPlanCommand.generated.h"


UCLASS()
class UBeamCliDeploymentPlanStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
UCLASS()
class UBeamCliDeploymentPlanBuildErrorsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
UCLASS()
class UBeamCliDeploymentPlanProgressStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools deployment plan [options]
 ...
 */
UCLASS()
class UBeamCliDeploymentPlanCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliDeploymentPlanStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (const TArray<UBeamCliDeploymentPlanStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;

	inline static FString StreamTypeBuildErrors = FString(TEXT("buildErrors"));
	UPROPERTY() TArray<UBeamCliDeploymentPlanBuildErrorsStreamData*> BuildErrorsStream;
	UPROPERTY() TArray<int64> BuildErrorsTimestamps;
	TFunction<void (const TArray<UBeamCliDeploymentPlanBuildErrorsStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnBuildErrorsStreamOutput;

	inline static FString StreamTypeProgress = FString(TEXT("progress"));
	UPROPERTY() TArray<UBeamCliDeploymentPlanProgressStreamData*> ProgressStream;
	UPROPERTY() TArray<int64> ProgressTimestamps;
	TFunction<void (const TArray<UBeamCliDeploymentPlanProgressStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnProgressStreamOutput;	
