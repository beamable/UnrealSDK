...
Options:
  ...
  --use-remote-deps                                When enabled, prevents any connection strings from being added to the environment [default: False]
...
public:
	...
	TFunction<void (TArray<UBeamCliProjectGenerateEnvStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
