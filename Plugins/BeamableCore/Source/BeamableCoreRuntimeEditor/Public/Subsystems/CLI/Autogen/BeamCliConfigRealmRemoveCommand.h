...
public:	
	...
	{
		UBeamJsonUtils::DeserializeMap<FString>(TEXT("Config"), Bag, Config, OuterOwner);	
	}
};
...
public:
	...
	TFunction<void (TArray<UBeamCliConfigRealmRemoveStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
