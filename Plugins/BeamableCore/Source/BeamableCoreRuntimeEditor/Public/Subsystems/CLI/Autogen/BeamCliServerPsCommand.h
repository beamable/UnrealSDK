...
public:	
	...
	{
		UBeamJsonUtils::DeserializeArray<UServerDescriptorStreamData*>(Bag->GetArrayField(TEXT("servers")), Servers, OuterOwner);	
	}
};
...
public:
	...
	TFunction<void (const TArray<UBeamCliServerPsStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
