...
#include "BeamCliProjectBuildSlnCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectBuildSlnStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  [INTERNAL] Builds all local projects with a temp solution file

Usage:
  Beamable.Tools project build-sln [options]
 ...
 */
UCLASS()
class UBeamCliProjectBuildSlnCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectBuildSlnStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectBuildSlnStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
