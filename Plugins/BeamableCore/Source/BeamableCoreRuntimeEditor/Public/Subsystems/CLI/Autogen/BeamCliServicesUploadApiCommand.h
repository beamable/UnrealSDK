...
public:	
	...
	{
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("uploadUrl"), UploadUrl, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("uploadUrl"), Bag, UploadUrl);	
	}
};
...
public:
	...
	TFunction<void (TArray<UBeamCliServicesUploadApiStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
