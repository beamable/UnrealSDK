...
#include "BeamCliProjectDisableCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectDisableStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  Disables a project. This modifies the BeamEnabled setting in the given project files

Usage:
  Beamable.Tools project disable [options]
 ...
 */
UCLASS()
class UBeamCliProjectDisableCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectDisableStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectDisableStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
