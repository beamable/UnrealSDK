...
#include "Subsystems/CLI/Autogen/StreamData/ProjectSettingsOutputStreamData.h"
#include "Subsystems/CLI/Autogen/StreamData/SettingOutputStreamData.h"
#include "BeamCliProjectReadSettingsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectReadSettingsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UProjectSettingsOutputStreamData*> Settings = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UProjectSettingsOutputStreamData*>(TEXT("settings"), Settings, Serializer);	
	}
...
/**
 Description:
  [INTERNAL] Get the localDev settings for the beamable workspace
 ...
 */
UCLASS()
class UBeamCliProjectReadSettingsCommand : public UBeamCliCommand
{
	GENERATED_BODY()
