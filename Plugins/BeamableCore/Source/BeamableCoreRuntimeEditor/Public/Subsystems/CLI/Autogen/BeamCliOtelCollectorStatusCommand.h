...
#include "BeamCliOtelCollectorStatusCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliOtelCollectorStatusStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools otel collector status [options]
 ...
 */
UCLASS()
class UBeamCliOtelCollectorStatusCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliOtelCollectorStatusStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliOtelCollectorStatusStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
