...
#include "BeamCliServicesUpdateDockerfileCommand.generated.h"
...
Usage:
  Beamable.Tools services update-dockerfile <ServiceName> [options]

Arguments:
  <ServiceName>  The name of the microservice to udpate the Dockerfile
 ...
 */
UCLASS()
class UBeamCliServicesUpdateDockerfileCommand : public UBeamCliCommand
{
	GENERATED_BODY()
