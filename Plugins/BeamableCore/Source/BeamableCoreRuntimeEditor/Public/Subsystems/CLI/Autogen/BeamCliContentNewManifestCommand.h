...
#include "BeamCliContentNewManifestCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentNewManifestStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools content new-manifest <manifest-id> [options]

Arguments:
  <manifest-id>  The manifest id to create locally
 ...
 */
UCLASS()
class UBeamCliContentNewManifestCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliContentNewManifestStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliContentNewManifestStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
