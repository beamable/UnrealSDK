...
#include "BeamCliUnityUpdateReferencesCommand.generated.h"
...
Usage:
  Beamable.Tools unity update-references <service> [options]

Arguments:
  <service>  The name of the service to update the references
...
Options:
  ...
  --paths <paths>                            The path of the project that will be referenced
  --names <names>                            The name of the Assembly Definition
 ...
 */
UCLASS()
class UBeamCliUnityUpdateReferencesCommand : public UBeamCliCommand
{
	GENERATED_BODY()
