...
#include "BeamCliProjectOpenCommand.generated.h"
...
Usage:
  Beamable.Tools project open [options]
...
Options:
  ...
  --only-generate                            Only generate the sln but do not open it
  --from-unity                               Use a solution filter that hides projects that aren't writable in a Unity project
 ...
 */
UCLASS()
class UBeamCliProjectOpenCommand : public UBeamCliCommand
{
	GENERATED_BODY()
