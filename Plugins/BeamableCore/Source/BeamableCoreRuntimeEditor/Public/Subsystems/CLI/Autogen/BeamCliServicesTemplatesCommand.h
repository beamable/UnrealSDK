...
/**
 Description:
  [REMOVED] Gets all the template types available in this realm
...
public:
	...
	TFunction<void (TArray<UBeamCliServicesTemplatesStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
