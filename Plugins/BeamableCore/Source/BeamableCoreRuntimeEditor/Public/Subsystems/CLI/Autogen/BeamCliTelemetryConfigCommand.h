...
#include "BeamCliTelemetryConfigCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliTelemetryConfigStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	FString BeamCliTelemetryLogLevel = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int64 BeamCliTelemetryMaxSize = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	bool BeamCliAllowTelemetry = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("BeamCliTelemetryLogLevel"), BeamCliTelemetryLogLevel, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("BeamCliTelemetryMaxSize"), BeamCliTelemetryMaxSize, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("BeamCliAllowTelemetry"), BeamCliAllowTelemetry, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("BeamCliTelemetryLogLevel"), Bag, BeamCliTelemetryLogLevel);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("BeamCliTelemetryMaxSize"), Bag, BeamCliTelemetryMaxSize);
		UBeamJsonUtils::DeserializeRawPrimitive(TEXT("BeamCliAllowTelemetry"), Bag, BeamCliAllowTelemetry);	
	}
};
...
/**
 Description:
  Retrieves Beam Open Telemetry configuration

Usage:
  Beamable.Tools telemetry config [options]
 ...
 */
UCLASS()
class UBeamCliTelemetryConfigCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliTelemetryConfigStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliTelemetryConfigStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
