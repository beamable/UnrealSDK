...
#include "BeamCliProjectAddPathsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectAddPathsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  Add extra paths and ignore paths for services

Usage:
  Beamable.Tools project add-paths [options]
 ...
 */
UCLASS()
class UBeamCliProjectAddPathsCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectAddPathsStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectAddPathsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
