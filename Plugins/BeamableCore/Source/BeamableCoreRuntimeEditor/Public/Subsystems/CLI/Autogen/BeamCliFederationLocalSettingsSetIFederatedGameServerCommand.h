...
public:
	...
	TFunction<void (const TArray<UBeamCliFederationLocalSettingsSetIFederatedGameServerStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
