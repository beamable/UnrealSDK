...
#include "BeamCliFederationLocalSettingsSetIFederatedGameServerCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliFederationLocalSettingsSetIFederatedGameServerStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	{
		UBeamJsonUtils::SerializeArray<FString>(TEXT("contentIds"), ContentIds, Serializer);	
	}
...
Usage:
  Beamable.Tools federation local-settings set IFederatedGameServer [options]

Options:
  --beamo-id <beamo-id>                      The Beamo ID for the microservice whose federation you want to configure []
  --fed-id <fed-id>                          The Federation ID for the federation instance you want to configure []
  --content-ids <content-ids>                The ids for the services you wish to deploy. Ignoring this option deploys all services
 ...
 */
UCLASS()
class UBeamCliFederationLocalSettingsSetIFederatedGameServerCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliFederationLocalSettingsSetIFederatedGameServerStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliFederationLocalSettingsSetIFederatedGameServerStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
