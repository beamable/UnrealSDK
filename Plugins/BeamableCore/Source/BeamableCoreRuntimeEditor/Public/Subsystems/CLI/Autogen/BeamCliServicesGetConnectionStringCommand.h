...
public:
	...
	TFunction<void (const TArray<UBeamCliServicesGetConnectionStringStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
