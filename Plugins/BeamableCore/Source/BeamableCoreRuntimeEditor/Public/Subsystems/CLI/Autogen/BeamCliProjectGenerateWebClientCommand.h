...
#include "BeamCliProjectGenerateWebClientCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectGenerateWebClientStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	{
		UBeamJsonUtils::SerializeArray<FString>(TEXT("Clients"), Clients, Serializer);
		UBeamJsonUtils::SerializeArray<FString>(TEXT("Types"), Types, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("Clients"), Bag, Clients, OuterOwner);
		UBeamJsonUtils::DeserializeArray<FString>(TEXT("Types"), Bag, Types, OuterOwner);	
	}
};
...
Usage:
  Beamable.Tools project generate web-client [options]
 ...
 */
UCLASS()
class UBeamCliProjectGenerateWebClientCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectGenerateWebClientStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectGenerateWebClientStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
