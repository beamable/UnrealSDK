...
#include "Subsystems/CLI/Autogen/StreamData/ReplacementTypeInfoStreamData.h"
#include "BeamCliProjectListReplacementTypeCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectListReplacementTypeStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UReplacementTypeInfoStreamData*> ReplacementsTypes = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UReplacementTypeInfoStreamData*>(TEXT("ReplacementsTypes"), ReplacementsTypes, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<UReplacementTypeInfoStreamData*>(TEXT("ReplacementsTypes"), Bag, ReplacementsTypes, OuterOwner);	
	}
};
...
/**
 Description:
  List all replacement types for linked Unreal project

Usage:
  Beamable.Tools project list-replacement-type [options]

Options:
  --project-name <project-name>              The Unreal project name
 ...
 */
UCLASS()
class UBeamCliProjectListReplacementTypeCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectListReplacementTypeStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectListReplacementTypeStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
