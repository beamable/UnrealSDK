...
#include "BeamCliContentPsCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliContentPsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	int32 EventType = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<ULocalContentManifestStreamData*> RelevantManifestsAgainstLatest = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<ULocalContentManifestStreamData*> ToRemoveLocalEntries = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 EVT_TYPE_FullRebuild = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 EVT_TYPE_RemotePublished = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	int32 EVT_TYPE_ChangedContent = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("EventType"), EventType, Serializer);
		UBeamJsonUtils::SerializeArray<ULocalContentManifestStreamData*>(TEXT("RelevantManifestsAgainstLatest"), RelevantManifestsAgainstLatest, Serializer);
		UBeamJsonUtils::SerializeArray<ULocalContentManifestStreamData*>(TEXT("ToRemoveLocalEntries"), ToRemoveLocalEntries, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("EVT_TYPE_FullRebuild"), EVT_TYPE_FullRebuild, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("EVT_TYPE_RemotePublished"), EVT_TYPE_RemotePublished, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("EVT_TYPE_ChangedContent"), EVT_TYPE_ChangedContent, Serializer);	
	}
	...
	virtual void BeamDeserializeProperties(const TSharedPtr<FJsonObject>& Bag) override
	{
		...
		UBeamJsonUtils::DeserializeRawPrimitive(Bag->GetStringField(TEXT("EVT_TYPE_FullRebuild")), EVT_TYPE_FullRebuild);
		UBeamJsonUtils::DeserializeRawPrimitive(Bag->GetStringField(TEXT("EVT_TYPE_RemotePublished")), EVT_TYPE_RemotePublished);
		UBeamJsonUtils::DeserializeRawPrimitive(Bag->GetStringField(TEXT("EVT_TYPE_ChangedContent")), EVT_TYPE_ChangedContent);	
	}
};
...
Usage:
  Beamable.Tools content ps [options]
 ...
 */
UCLASS()
class UBeamCliContentPsCommand : public UBeamCliCommand
{
	GENERATED_BODY()
...
public:
	...
	TFunction<void (const TArray<UBeamCliContentPsStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
