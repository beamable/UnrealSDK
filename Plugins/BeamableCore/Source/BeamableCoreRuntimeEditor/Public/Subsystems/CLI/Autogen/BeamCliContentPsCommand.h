...
public:	
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FString PublisherEmail = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FString PublisherAccountId = {};
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	TArray<UContentSyncReportStreamData*> SyncReports = {};
	...
	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		...
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("PublisherEmail"), PublisherEmail, Serializer);
		UBeamJsonUtils::SerializeRawPrimitive(TEXT("PublisherAccountId"), PublisherAccountId, Serializer);
		UBeamJsonUtils::SerializeArray<UContentSyncReportStreamData*>(TEXT("SyncReports"), SyncReports, Serializer);	
	}
...
/**
 Description:
  Lists the current state of local contents relative to the published content. Can be run in watch mode for continuous updates regarding file modifications and published content made by other developers in the same realm
