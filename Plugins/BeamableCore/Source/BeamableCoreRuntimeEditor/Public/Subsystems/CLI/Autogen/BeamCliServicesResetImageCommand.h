...
/**
 Description:
  [REMOVED] Delete any images associated with the given Beamable services
...
public:
	...
	TFunction<void (TArray<UBeamCliServicesResetImageStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
