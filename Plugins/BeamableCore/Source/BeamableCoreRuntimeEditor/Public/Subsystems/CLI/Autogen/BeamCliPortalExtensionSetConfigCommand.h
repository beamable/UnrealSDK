...
#include "BeamCliPortalExtensionSetConfigCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliPortalExtensionSetConfigStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  [INTERNAL] Sets configuration for Portal Extensions

Usage:
  Beamable.Tools portal extension set-config [options]

Options:
  --file-extensions-to-observe <file-extensions-to-observe>  Extra file extensions to include in the watch process (e.g., '.md,.json'). These run alongside default extensions
 ...
 */
UCLASS()
class UBeamCliPortalExtensionSetConfigCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliPortalExtensionSetConfigStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliPortalExtensionSetConfigStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
