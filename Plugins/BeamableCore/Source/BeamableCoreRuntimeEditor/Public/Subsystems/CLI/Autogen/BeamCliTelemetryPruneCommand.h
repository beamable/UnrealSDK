...
#include "BeamCliTelemetryPruneCommand.generated.h"



/**
 Description:
  Clears telemetry data that was exported to files by normal usage of the CLI

Usage:
  Beamable.Tools telemetry prune [options]

Options:
  --delete-all                               If set, will delete all telemetry files [default: False]
  --retaining-days <retaining-days>          Can be passed to define a custom amount of days in which data should be preserved [default: 10]
 ...
 */
UCLASS()
class UBeamCliTelemetryPruneCommand : public UBeamCliCommand
{
	GENERATED_BODY()
