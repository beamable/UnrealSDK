...
#include "BeamCliDeveloperUserManagerCreateUserBatchCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliDeveloperUserManagerCreateUserBatchStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
/**
 Description:
  Create multiple users from multiples templates doing the request in parallel

Usage:
  Beamable.Tools developer-user-manager create-user-batch [options]
 ...
 */
UCLASS()
class UBeamCliDeveloperUserManagerCreateUserBatchCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliDeveloperUserManagerCreateUserBatchStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliDeveloperUserManagerCreateUserBatchStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
