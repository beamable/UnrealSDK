...
#include "BeamCliProjectDepsAddCommand.generated.h"
...
Usage:
  Beamable.Tools project deps add <microservice> <dependency> [options]

Arguments:
  <microservice>  The microservice name that the dependency will be added to
  <dependency>    The storage that will be a dependency of the given microservice
 ...
 */
UCLASS()
class UBeamCliProjectDepsAddCommand : public UBeamCliCommand
{
	GENERATED_BODY()
