...
#include "BeamCliGrafanaOpenCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliGrafanaOpenStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools grafana open [options]
 ...
 */
UCLASS()
class UBeamCliGrafanaOpenCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliGrafanaOpenStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliGrafanaOpenStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
