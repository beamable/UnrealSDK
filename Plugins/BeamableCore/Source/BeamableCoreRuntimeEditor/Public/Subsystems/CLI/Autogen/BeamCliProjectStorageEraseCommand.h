...
#include "BeamCliProjectStorageEraseCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliProjectStorageEraseStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class UBeamCliProjectStorageEraseMongoLogsStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
Usage:
  Beamable.Tools project storage erase <beamoId> [options]
 ...
 */
UCLASS()
class UBeamCliProjectStorageEraseCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliProjectStorageEraseStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliProjectStorageEraseStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;

	inline static FString StreamTypeMongoLogs = FString(TEXT("mongoLogs"));
	UPROPERTY() TArray<UBeamCliProjectStorageEraseMongoLogsStreamData*> MongoLogsStream;
	UPROPERTY() TArray<int64> MongoLogsTimestamps;
	TFunction<void (TArray<UBeamCliProjectStorageEraseMongoLogsStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnMongoLogsStreamOutput;	
