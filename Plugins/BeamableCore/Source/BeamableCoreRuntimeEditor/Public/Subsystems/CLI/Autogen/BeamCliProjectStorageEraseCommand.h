...
public:
	...
	TFunction<void (const TArray<UBeamCliProjectStorageEraseStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;
	...
	TFunction<void (const TArray<UBeamCliProjectStorageEraseMongoLogsStreamData*>& StreamData, const TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnMongoLogsStreamOutput;	
