...
#include "BeamCliUnityUpdateDllsCommand.generated.h"
...
Usage:
  Beamable.Tools unity update-dlls <service> [options]

Arguments:
  <service>  The name of the service to update the dlls

Options:
  --paths <paths>                            The path of the dll that will be referenced
  --names <names>                            The name of the dll that will be referenced
 ...
 */
UCLASS()
class UBeamCliUnityUpdateDllsCommand : public UBeamCliCommand
{
	GENERATED_BODY()
