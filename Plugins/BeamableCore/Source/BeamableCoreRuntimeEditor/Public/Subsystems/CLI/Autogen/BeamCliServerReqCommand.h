...
Options:
  --port <port>                              The port where the CLI server is running [default: 8342]
...
public:
	...
	TFunction<void (TArray<UBeamCliServerReqStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
