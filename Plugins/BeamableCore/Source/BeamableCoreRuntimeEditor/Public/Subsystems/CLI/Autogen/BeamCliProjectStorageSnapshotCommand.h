...
Usage:
  Beamable.Tools project storage snapshot <beamoId> [options]

Arguments:
  <beamoId>  The beamoId for the storage object

Options:
  -o, --output <output>                      The output for the snapshot [default: snapshot]
 ...
 */
UCLASS()
class UBeamCliProjectStorageSnapshotCommand : public UBeamCliCommand
{
	GENERATED_BODY()
