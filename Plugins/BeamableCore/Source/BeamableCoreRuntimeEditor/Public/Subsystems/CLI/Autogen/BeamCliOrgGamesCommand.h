...
#include "BeamCliOrgGamesCommand.generated.h"


UCLASS(BlueprintType)
class UBeamCliOrgGamesStreamData : public UObject, public IBeamJsonSerializableUObject
{
	GENERATED_BODY()
...
public:	
	...
	TArray<UOrgRealmDataStreamData*> VisibleGames = {};

	virtual void BeamSerializeProperties(TUnrealJsonSerializer& Serializer) const override
	{
		UBeamJsonUtils::SerializeArray<UOrgRealmDataStreamData*>(TEXT("VisibleGames"), VisibleGames, Serializer);	
	}
	...
	{
		UBeamJsonUtils::DeserializeArray<UOrgRealmDataStreamData*>(TEXT("VisibleGames"), Bag, VisibleGames, OuterOwner);	
	}
};
...
Usage:
  Beamable.Tools org games [options]
 ...
 */
UCLASS()
class UBeamCliOrgGamesCommand : public UBeamCliCommand
{
	GENERATED_BODY()

public:
	inline static FString StreamType = FString(TEXT("stream"));
	UPROPERTY() TArray<UBeamCliOrgGamesStreamData*> Stream;
	UPROPERTY() TArray<int64> Timestamps;
	TFunction<void (TArray<UBeamCliOrgGamesStreamData*>& StreamData, TArray<int64>& Timestamps, const FBeamOperationHandle& Op)> OnStreamOutput;	
