...
#include "BeamCliTelemetryPushCommand.generated.h"



/**
 Description:
  Pushes local telemetry data saved through the BeamableExporter to a running collector. This uses the Open Telemetry OTLP exporter to push telemetry from files to a running collector using Http protocol

Usage:
  Beamable.Tools telemetry push [options]

Options:
  --endpoint <endpoint>                      The endpoint to which the telemetry data should be exported
  --process-id <process-id>                  Defines the process Id that called this method. If is not passed a new process ID will be generated []
 ...
 */
UCLASS()
class UBeamCliTelemetryPushCommand : public UBeamCliCommand
{
	GENERATED_BODY()
