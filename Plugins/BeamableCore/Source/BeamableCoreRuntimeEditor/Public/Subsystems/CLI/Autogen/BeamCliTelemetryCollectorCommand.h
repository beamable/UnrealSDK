...
#include "BeamCliTelemetryCollectorCommand.generated.h"



/**
 Description:
  Allows access to Open Telemetry collector related commands

Usage:
  Beamable.Tools telemetry collector [command] [options]
 ...
 */
UCLASS()
class UBeamCliTelemetryCollectorCommand : public UBeamCliCommand
{
	GENERATED_BODY()
