...
#include "BeamCliProjectAddReplacementTypeCommand.generated.h"



/**
 Description:
  Add a replacement type for Unreal linked projects

Usage:
  Beamable.Tools project add-replacement-type [options]

Options:
  --reference-id <reference-id>                            The reference Id (C# class/struct name) for the replacement
  --replacement-type <replacement-type>                    The name of the Type to replaced with in Unreal auto-gen
  --optional-replacement-type <optional-replacement-type>  The name of the Optional Type to replaced with in Unreal auto-gen
  --engine-import <engine-import>                          The full import for the replacement type to be used in Unreal auto-gen
 ...
 */
UCLASS()
class UBeamCliProjectAddReplacementTypeCommand : public UBeamCliCommand
{
	GENERATED_BODY()
