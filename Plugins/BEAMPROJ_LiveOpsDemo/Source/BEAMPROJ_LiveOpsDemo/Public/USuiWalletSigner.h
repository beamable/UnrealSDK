...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Sui Wallet")
	bool VerifySignature(const FString& Message, const FString& SignatureBase64) const
	{
		...
		FString SignatureHex;
		FBase64::Decode(SignatureBase64, SignatureHex);
		...
		// Using a ed25519 lib to verify if the signature is correct 
